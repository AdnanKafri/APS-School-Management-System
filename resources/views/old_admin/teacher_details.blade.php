...
<div class="row">
    ...
    <div class="col-xl-4 order-xl-2">
        ...
        <div class="modal fade resetteacherPassword">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form id="form_update" action="{{ route('admin.reset_teacher_password',$teacher->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
        ...
        <div class="card-header">
            <div class="row align-items-center">
              ...
              <div class="col-4 text-right">
                ...
                <a  class=" btn btn-outline-danger" href=".resetteacherPassword" data-toggle="modal">
          ...
          <div class="card-body">
            <form method="post" action="{{ route('admin.teacher_update',$teacher->id) }}" enctype="multipart/form-data">
                @csrf
                @method('put')
              ...
              <div class="col-lg-6">
                <div class="form-group">
                    ...
                    <input type="email" id="input-email" name="email" class="form-control email" value="{{ $teacher->email }}">
                ...
                <span class="text-danger error validate_email">
                  ...
                  <div class="col-lg-6">
                    <div class="form-group">
                      ...
                      <input type="text" id="input-first-name" name="first_name" class="form-control" value="{{ $teacher->first_name }}">
                    </div>
                  </div>
                  ...
                  <div class="col-lg-6">
                    <div class="form-group">
                      ...
                      <input type="text" id="input-last-name" name="last_name" class="form-control" value="{{ $teacher->last_name }}">
                    </div>
                  </div>
                  ...
                  <div class="col-lg-6">
                    <div class="form-group">
                      ...
                      <input type="date" id="input-last-name" name="date_birth" required class="form-control"  value="{{ $teacher->date_birth }}">
                    </div>
                  </div>
    ...
    {{-- ------------------------------------- --}}
                ...
                <div class="row">
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <input id="input-address" class="form-control" name="address" placeholder="Home Address" value="{{ $teacher->address }}" type="text">
                    </div>
                  </div>
                ...
                <div class="row">
                  <div class="col-lg-4">
                    <div class="form-group">
                      ...
                      <input type="text" id="input-phone" name="phone" class="form-control" value="{{ $teacher->phone }}">
                    </div>
                  </div>
                </div>
              ...
              <div class="pl-lg-4 col-md-12">
                ...
                <img src="{{ asset('storage/'.$teacher->image) }}" class="rounded-circle" width="40%" alt="">
                @endif
