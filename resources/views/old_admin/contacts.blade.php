              ...
              <table class="table align-items-center table-flush">
                <thead class="thead-light">
                  <tr>
                    ...
                    <th scope="col" class="sort" data-sort="completion">الموضوع</th>

                    <th scope="col" class="sort" data-sort="completion">الرسالة</th>

                    <th scope="col" class="sort" data-sort="completion">الإجابة</th>
                    <th scope="col" class="sort" data-sort="completion">تاريخ الارسال </th>
    ...
    <div class="modal fade AnswerModal">
        <div class="modal-dialog">
            <div class="modal-content">
                <form id="form_update" action="{{ route('admin.contact.answer') }}" method="POST" enctype="multipart/form-data">
                    @csrf
