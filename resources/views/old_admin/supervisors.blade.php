...
<form class="navbar-search navbar-search-light form-inline mr-sm-3" id="navbar-search-main">
    <div class="form-group mb-0">
      {{-- <div class="input-group input-group-alternative input-group-merge">
        ...
        <input class="form-control" name="search_supervisor" id="search_supervisor" placeholder="Search" type="text">
      </div> --}}
    </div>
    ...
    <div class="card">
        ...
        @endif
            ...
            <div class="card-header border-0" >
              <h3 class="mb-0">جدول الموجهين</h3>
...
@if($item->image != null)
                    ...
                    <td>
                        ...
                        {{-- @can('edit_teacher') --}}
                        <a href="{{ route('admin.supervisor_details',$item->id) }}" target="_blank">
                    ...
                    {{-- @can('set_task') --}}
                    <a href="{{ route('admin.supervisor.set_supervisor_task',$item->id) }} " target="_blank" class="btn btn-success btn-sm">تحديد مهام</a>

                    {{-- @endcan --}}

{{-- @can('edit_task') --}}
<a href="{{ route('admin.supervisor.edit_supervisor_task',$item->id) }}" target="_blank" class="btn btn-warning btn-sm">تعديل المهام</a>
...
{{-- @endcan --}}
            ...
            <div class="modal fade createSupervisorModal">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <form id="form_update" action="{{ route('admin.supervisor_store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
