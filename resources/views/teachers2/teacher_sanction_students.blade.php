...
@section('content')
    ...
    <div class="main-panel" style="background: #f8f9fb;">
        ...
        padding-top: 11px;">
          ...
          <li class="li"><a href="#"> المكافئات </a></li>
                        ...
                        <div class="modal-dialog animated zoomInLeft modal-dialog-centered" role="document">
                            <div class="modal-content" style="padding-top: 50px !important;">
                                <div class="container-fluid">
                                    ...
                                    <h4 style="color: #05579e;text-align: center; ">اضافة   عقوبة</h4>
                                    <form action="{{ route('teacher_rewads_students_store') }}" method="post" autocomplete="off"
                                        ...
                                        <input type="hidden" name="type" id="class_id" value="2">
...
<h5 class="modal-title" id="exampleModalLabel">حذف  عقوبة</h5>
<button type="button" class="close" data-dismiss="modal" aria-label="Close">
<span aria-hidden="true">&times;</span>
</button>
