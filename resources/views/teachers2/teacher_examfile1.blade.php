...
<div class="main-panel" style="background: #f8f9fb;">
    ...
    @if($exam->type=="2")
    <li class="li">
        <a href="{{route('dashboard.StudentsRoomLesson_quize',[$room->id,$teacher->id,$lesson->id]) }}">عودة</a>
    </li>
    @else
    <li class="li">
        <a href="{{ route('dashboard.StudentsRoomLesson_exam',[$room->id,$teacher->id,$lesson->id]) }}">عودة</a>
    </li>
    @endif
