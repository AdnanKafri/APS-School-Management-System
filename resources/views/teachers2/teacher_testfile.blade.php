...
<div class="main-panel" style="background: #f8f9fb;">
    ...
    <li class="li"><a href="{{ route('dashboard.student.lessons.book_details',[$lesson->id,$teacher->id,$room->id ,$exam->lecture_id]) }}">عودة</a></li>
    <li class="li"><a href="#">{{ $exam->name_quize1 }}</a></li>
    </ul>
  @php
    ...
    <div class="content-wrapper pb-0">
        <div class="container" style="padding-bottom: 150px;">
            <form class="form_main" action="">
                ...
                <h2 class="sub_title">{{ $exam->name_quize1 }}</h2>
                </div>
