                                                        ...
                                                        @if ($item2->exam_result->count() > 0)
                                                            @foreach ($item2->exam_result as $item3)
                                                                ...
                                                                @if ($item3->exam_id == $exam_id)
                                                                    ...
                                                                    <input inputmode="decimal" hidden style="height: 50px; width:80px"
                                                                        name="mark"
                                                                ...
                                                                @endif
                                                            @endforeach
                                                            <input inputmode="decimal" style="height: 50px; width:80px" name="mark"
            ...
            <tr>
                ...
                <td>
                    ...
                    <input style="height: 50px; width:60px"  hidden name="exam_result_id"  value="{{ $item3->id }}" type="text">
                       ...
                       <input inputmode="decimal"  hidden style="height: 50px; width:80px" name="mark" value="{{ $item3->result!=null ?$item3->result : '' }}" onfocus="this.placeholder = ''" onblur="this.placeholder = ''" class="common-input mb-20 form-control input1"  type="text">

                       @endif


                    @endforeach
                    <input inputmode="decimal" style="height: 50px; width:80px" name="mark" value="" onfocus="this.placeholder = ''" onblur="this.placeholder = ''" class="common-input mb-20 form-control input2"  type="text">
                    @else
                    <input inputmode="decimal" style="height: 50px; width:80px" name="mark" onfocus="this.placeholder = ''" onblur="this.placeholder = ''" class="common-input mb-20 form-control" required="" type="text">
                    @endif
        ...
        $(document).on('change', '.choice', function() {
            ...
            $.ajax({
                                ...
                                $.each(value.exam_result, function(key1, value1) {
                                    if (value1.exam_id == home) {
                                        d = `   <input style="height: 50px; width:60px"  hidden name="exam_result_id"  value="${value1.id}" type="text">
                                                <input inputmode="decimal"   style="height: 50px; width:80px;    margin: auto;" name="mark" value="${value1.result}"  class="common-input mb-20 form-control input1"  type="text">`
                                        if (value1.medal == "1") {
                ...
                <img src="{{ asset('teachers/medal3.png') }}" style="height: 86px;width:86px">
                        ...
                        $.each(data, function(key, value) {
                            ...
                            d = `<input style="height: 50px; width:60px"  hidden name="exam_result_id"  value="" type="text">
                                <input inputmode="decimal"   style="height: 50px; width:80px" name="mark" value=""  class="common-input mb-20 form-control input1"  type="text">`
                ...
                <img src="{{ asset('teachers/medal3.png') }}" style="height: 86px;width:86px">
                                            ...
                                            d = `<input style="height: 50px; width:60px"  hidden name="exam_result_id"  value="" type="text">
    <input inputmode="decimal"   style="height: 50px; width:80px;    margin: auto;" name="mark" value=""  class="common-input mb-20 form-control input1"  type="text"> `
