...
@endif
                        ...
                        <div class="tab-pane active" id="profile" role="tabpanel">
                         <div class="container animated bounceInLeft">
                          ...
                          @endif
                              ...
                              <td data-label="عرض العلامات"><a href="{{ route('teacher_quize_students',[$room_id ,$teacher->id,$lesson_id,$item->id]) }}" class="showstate"><span>عرض العلامات</span></a></td>
                                            ...
                                            <table class="table table-striped">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>{{ $item->period }} </td>
                                                        <td>{{ $item->mark }}</td>
                                                        <td><a href="{{ route('teacher_quize_students',[$room_id ,$teacher->id,$lesson_id,$item->id]) }}"
    ...
    <div class="modal fade" id="basicModal" tabindex="-1" role="dialog" aria-labelledby="basicModal" aria-hidden="true">
      <div class="modal-dialog">
          <form action="{{ route('dashboard.exam.update123') }}" method="post"    enctype="multipart/form-data">
      ...
      <div class="modal-dialog">
        ...
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <button type="button" class="addquestion" data-dismiss="modal"  style="width: 80px;
            height: 38px;">اغلاق</button>
            <button type="submit" id="save_student" class="addquestion"  style="width: 80px;
            height: 38px;">حفظ</button>
          </div>
        </div>
      </div>
