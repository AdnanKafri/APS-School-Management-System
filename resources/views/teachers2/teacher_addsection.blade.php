...
@section('content')
    ...
    padding-top: 11px;">
            ...
            <li class="li"><a
                    href="{{ route('dashboard.teacher.questions', [$class->id, $room_id, $Lecture->id, $Lecture->lesson->id]) }}">الاسئلة</a>
            </li>
 ...
 <div class="modal-dialog animated zoomInDown modal-dialog-centered" role="document">
   <div class="modal-content" style="padding-top: 50px !important;">
       <div class="container-fluid">
        <form action="{{ route('dashboard.section.store') }}" method="post" autocomplete="off"
               ...
               <div class="col-md-12">
                 ...
                 <div class="video-wrapper">
                  ...
                  <input type="hidden" name="teacher_id" id="teacher_id" value="{{ auth()->user()->teacher_id }}">
                       ...
                       <input style="text-align: right;" type="text" class="form-control"  name="title" required id="name" placeholder="ادخل عنوان المحتوى ">
                       <br>
                       <br>
                       <label  style="color: #094e89; float: right;">نوع الفقرة </label>
                       <select id="myselection" name="type" aria-invalid="false" class="form-control form-control-lg">
                       ...
                       <div id="show3" class="myDiv" style="display: none;">
                        <div class="form">
                           ...
                           <input type="file" accept="image/*" required="" name="content2"  id="file-input">
                         </label>
                        </div>
                    ...
                    <div id="show2" class="myDiv" style="display: none;">
                        <div class="form">
                        <label for="file-input" class="drop-container">
                        <span class="drop-title">
                        <br>
                        ...
                        <input type="file" accept="image/*" required="" name="content"   id="file-input">
                        </label>
                        </div>
                    </div>
           ...
           <br>
                            ...
                            <div class="button_outer">
                              <div class="btn_upload">
                                <input type="file" id="upload_file" name="content2" accept="Image/*">
                                 تحميل ملف
                                </div>
                          ...
                          <div class="uploaded_file_view" id="uploaded_view">
                            ...
                            <div class="button_outer">
                              <div class="btn_upload">
                                <input type="file" id="upload_file" name="content" accept="Image/*">
                                 تحميل ملف
                                </div>
                              <div class="processing_bar"></div>
                              <div class="success_box"></div>
    ...
    <div class="modal fade auto-off" id="demoModal2" tabindex="-1" role="dialog" aria-labelledby="demoModal" aria-hidden="true">
        <div class="modal-dialog animated zoomInDown modal-dialog-centered" role="document">
            <div class="modal-content" style="padding-top: 50px !important;">
                <div class="container-fluid">
                    <form action="{{ route('dashboard.section.update') }}" method="post" autocomplete="off" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row" style="direction: rtl;">
                            <div class="col-md-12">
                                ...
                                <div class="video-wrapper">
                                    <label style="color: #094e89; float: right;"> عنوان المحتوى </label>
                                    <input style="text-align: right;" type="text" class="form-control" name="title" id="title_edit" required placeholder="ادخل عنوان المحتوى">
                                    <br><br>
                                    ...
                                    <div class="row" style="text-align: center;">
                                        <div class="col-md-12">
                                            <div id="content_edit">
                                                <!-- Additional content to be dynamically filled if needed -->
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<script>
 $(document).on('click', '.section_edit', function() {
    ...
    if (type == '0') { // Text
        $('#text').append('<option value="hide" class="form-control form-control-lg">----------- نص -----------</option>');
        $('#content_edit').append(`
            <textarea name="content" class="form-control" style="direction:ltr" cols="30" rows="10">${content}</textarea>
        `);
    } else if (type == '3') { // Image
        $('#text').append('<option value="hide">-------------- صورة --------------</option>');
        $('#content_edit').append(`
            <img src="{{ asset('storage/${content}') }}" width="50px" height="50px">
            <br><br>
            <input type="file" name="content" class="form-control">
        `);
    } else { // Audio
        $('#text').append('<option value="hide">-------------- صوت --------------</option>');
        $('#content_edit').append(`
