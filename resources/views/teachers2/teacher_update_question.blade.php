...
<div class="main-panel" style="background: #f8f9fb;">
    ...
    <li class="li"><a href="{{ route('dashboard.teacher.questions',[$questions->class_id,$room_id,$questions->Lecture->id,$questions->lesson_id ]) }}">الاسئلة</a></li>
        ...
        <div class="container2" style="padding-bottom: 150px;">
            <div class="heading">تعديل سؤال</div>
                  ...
                  <h3 style="color: #094e89;">تفاصيل السؤال </h3> --}}
                        <form action="{{ route('dashboard.question.update',$id) }}" method="post"
