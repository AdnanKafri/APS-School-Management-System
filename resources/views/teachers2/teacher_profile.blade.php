           ...
           <div class="col-md-12">
            <div class="main" style="text-align: right;direction: rtl;">  	
              <input type="checkbox" id="chk" aria-hidden="true">
                ...
                <div class="login">
                    <form action="{{ route('dashboard.teacher.update_profile',$teacher->id) }}"
                    class="form1" method="POST" enctype="multipart/form-data" >
                        @csrf
                        @method('put')
                        <input type="hidden" name="student_id" value="{{ $teacher->id }}">
                    ...
                    <label for="chk" aria-hidden="true">تعديل الصورة</label>
                     <div class="container">
                       <div class="row" style="text-align: center; justify-content: center;">
                         <div class="col-md-5">
                           <img src="{{ asset('storage/'.$teacher->image) }}" alt="" style="height: 150px; width: 150px;">
                                  ...
                                  <div class="panel">
                                    <div class="button_outer" style="left: 23px;">
                                        <div class="btn_upload">
                                            <input type="file" id="upload_file" name="image" accept="file_extension/*">
                                            تحميل ملف 
                                          </div>
