    ...
    <div class="main-panel" style="background: #f8f9fb;">
        ...
        padding-top: 11px;">
            ...
            <li class="li"><a
                    ...
                    جميع المذاكرات</a></li>
            <li class="li"><a href="#">{{ $quize->name }} </a></li>
        </ul>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        text-align: right;">وقت البداية : {{ $quize->start_date }}</p>
                                        <p style="color: #9ea7af;
                                        text-align: right;">وقت النهاية : {{ $quize->end_date }}</p>
                                        <p style="color: #9ea7af;
                                        text-align: right;">العلامة  : {{ $quize->mark }}</p>
                                        <input type="hidden" id="success_mark" value="{{$quize->mark}}">
                                ...
                                <div class="container">
                                    <div class="row">
                                        ...
                                        <div class="col-sm">
                                            <input class="homeid" hidden value="{{ $quize->id }}">
                                         ...
                                         {{-- <div class="col-md-4" style="position: relative;z-index: 9;">
                                           <a href="{{ route('export_exam',[$quize->id,$room_id,$lesson_id]) }}"  class="cssbuttons-io-button">
                                               تصدير العلامات  &nbsp;
                                               </a>
                                              </div> --}}
    ...
    <form class="bulk-mark-form" action="{{ route('dashboard.teacher.student_save_mark_bulk') }}" method="post" style="display:none;">
        ...
        <input type="hidden" name="rows" class="bulk-mark-rows" value="">
                                    ...
                                    <table class="table1">
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th>اسم الطالب </th>
                                               <th>تاريخ ترفيع ملف المذاكرة</th>
                                                <th>العلامة</th>
                                                <th>تحميل الملف </th>
                                                <!--<th> الاوسمة </th>-->
                                                <th>حفظ العلامة  </th>
                                                    ...
                                                    <tr>
                                                        <form action="{{ route('dashboard.teacher.student_save_mark_quize') }}" method="post" enctype="multipart/form-data">
                                                            ...
                                                            <td data-label="اسم الطالب" class="">
                                                             ...
                                                             <td data-label="تاريخ ترفيع الملف">
                    ...
                    <input style="height: 50px; width:80px;margin: auto;"  hidden name="exam_result_id"  value="{{ $item->id }}" type="text">
                     ...
                     <input style="height: 50px; width:80px"  hidden name="class_id"  value="{{ $room_id }}" type="text">
