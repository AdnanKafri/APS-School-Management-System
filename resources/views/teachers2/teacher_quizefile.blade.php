...
<div class="main-panel" style="background: #f8f9fb;">
   ...
   @endif
    @if($exam->type == "1")
    <li class="li">
         <a href="{{ route('teacher_exam',[$room->id ,$teacher->id,$lesson->id,$exam_id]) }}">عودة</a>
    </li>
    @endif
    ...
    <div class="content-wrapper pb-0">
        <div class="container" style="padding-bottom: 150px;">
            ...
            <div class="col-md-4" style="text-align: end;">
                <input  class="input" step="0.001"  name="traditional_result[{{ $question->id }}]" placeholder=""  type="number"
