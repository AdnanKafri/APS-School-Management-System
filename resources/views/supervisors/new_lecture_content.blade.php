...
<div class="main-panel" style="background: #f8f9fb;">
        <ul class="breadcrumbs" style="padding-bottom: 7px;
            ...
            <li class="li"><a href="{{ route('dashboard.supervisor') }}">المواد</a></li>

            <li class="li"><a
                    href="{{ route('dashboard.edu_supervisor.subjects',['room_id' => $room->id])}}">{{ $room->name }}</a>
            </li>
            <li class="li"><a
                    href="{{ route('dashboard.edu_supervisor.subjects.lectures',['lesson_id' =>$lecture->lesson->id ,'room_id'=>$room_id]) }}">{{ $lecture->lesson->name }}
                </a></li>
