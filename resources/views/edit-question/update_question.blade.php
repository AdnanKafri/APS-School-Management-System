...
<body style=" background-color: #add0ec;
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 form-group mb-3">
                                    ...
                                    <input type="hidden" class="form-control" name="ques_type" id="ques_type" value="{{ $questions->ques_type }}">
												<input type="text" class="form-control" name="ques_typee"  value="{{ $questions->ques_type == 2 ? 'Traditional' : 'Multi Choices' }}" disabled>
                                    ...
                                    <div id="show2" class="myDiv" style="display: block">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 form-group mb-3">
                                                ...
                                                <textarea class="form-control"  id="question_form22"  name="answer" cols="10" rows="3">{{ $questions->answer }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    @endif
                    ...
                    <input type="hidden"  class="myselection" value="1">
                            ...
                            <div class="row">
                                <div class="col-md-12 form-group mb-3">
                                    ...
                                    <input type="text" class="form-control" value="{{ $questions->mark }}" name="mark" id="mark"
