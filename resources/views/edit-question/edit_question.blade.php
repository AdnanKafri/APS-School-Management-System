            ...
            <div class="row align-items-stretch no-gutters contact-wrap" style="border-radius: 15px;">
              <div class="col-md-12">
                <div class="form h-100" style="border-radius: 15px;">
                  <a href="{{ route('dashboard.teacher.questions',[$class->id,$room_id,$Lecture->id,$lesson_id ]) }}">  <button
                    class="btn btn-primary rounded-0 py-2 px-4" style="float: left;">عودة</button></a>
                  <h3 style="color: #094e89;">تفاصيل السؤال </h3>

                        <form action="{{ route('tofel_exam.question.store') }}" method="post"
                            class="mb-5" >
                            @csrf
                            ...
                            <div class="row">
                                <div class="col-md-12 form-group mb-3">
                                    <label for="budget" class="col-form-label">المادة </label>
                                ...
                                <div id="add">
                                    ...
                                    <script>
                                        $(document).on('click', '#btn', function () {
                                            $('#add').append(
                                                '<div class="row register" ><div class="col-md-12 form-group mb-3"><label for="" class="col-form-label"> </label> <input type="text" class="form-control input input12" name="option[]" placeholder="ادخل الخيار التالي "></div></div>'
                                            );
