...
@section('content')
                                ...
                                <div class="card-body p-4 text-white">
                                    ...
                                    <table class="table text-white mb-0">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="fw-normal">
                                                <th>
                                                     @if($item->recv_task_admin)
                                                    <!--<img src="https://mdbcdn.b-cdn.net/img/Photos/new-templates/bootstrap-chat/ava1-bg.webp"-->
                                                    <!--    alt="avatar 1" style="width: 45px; height: auto;">-->
                                                    <span class="ms-2">{{$item->admin_recv->first_name . ' ' . $item->admin_recv->last_name }}</span>
   ...
   <div class="modal-header">
                ...
                <div class="modal-body">
                   ...
                   <form method="post" action="{{route('dashboard.store_admin_task')}}">
                ...
                <div class="form-group">
                <label>المدير</label>
                <select name="recv_id" class="form-control">
   ...
   <div class="modal-header">
                ...
                <div class="modal-body">
                   ...
                   <form method="post" action="{{route('dashboard.store_employee_task')}}">
