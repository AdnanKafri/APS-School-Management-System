...
<nav class="navbar navbar-expand-lg navbar-light bg-light navbar-custom">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
           ...
           <li class="nav-item">
                    <a class="nav-link {{ Route::is('dashboard.administrator') ? 'active' : '' }}"
                    ...
                    <li class="nav-item">
                    <a class="nav-link {{ Route::is('dashboard.administrator_pending_tasks') ? 'active' : '' }}"
                        href="{{ route('dashboard.administrator_pending_tasks') }}">
                        التاسكات المعلقة 
                     </a>
                </li>
                             ...
                             <li class="nav-item">
                    <a class="nav-link {{ Route::is('dashboard.administrator_sent_tasks') ? 'active' : '' }}"
                        href="{{ route('dashboard.administrator_sent_tasks') }}">
                        التاسكات المرسلة 
                     </a>
                </li>
