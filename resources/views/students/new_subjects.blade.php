      ...
      <div class="col-md-3 coll" style="padding-bottom: 20px;"><!--start col-->
        <div class="card" style="text-align:center;"><!--start card-->
          <div class="card-body p-0">
            <img class="img-fluid w-100" src="{{ asset('student/sub1.jpg') }}" alt="" />
          </div>
          <div class="card-body px-3 text-dark">
            <h5 class="font-weight-semibold">{{ $lesson->name }} </h5>
            <div class="row" style="justify-content: center;">
              <div class="col-md-12">
                <!--p class="mb-0">$5,267/night</p-->
                <div class="buttons">
                  <a href="{{route('dashboard.student.lesson.lectures',['lesson_id' => $lesson->id,'room_id' => $room->id,'student_id' => $student->id]) }}"   class="blob-btn">
                    الدروس
