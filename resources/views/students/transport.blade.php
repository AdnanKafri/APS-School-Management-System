...
<div class="main-panel" >
  <ul class="breadcrumbs" style="padding-bottom: 7px;
	padding-top: 11px;">
     ...
     <li class="li"><a href="#">    المواصلات  </a></li>
              ...
              <table class=""  >
                  <thead>
                    <tr>
                      ...
                      <th scope="col">  مشرف الباص</th>
                      <!--<th scope="col">القسط الكامل </th>-->
            ...
            <?php $i = 1 ;
             ...
             @if($student->bus)
                ...
                ">
                    ...
                    @foreach($student->bus->bus_driver as $item)
                {{$item->name}} : 
                {{$item->phone}}
                ...
                ">
                    ...
                    @foreach($student->bus->bus_supervisor as $item)
                {{$item->name}} : 
                {{$item->phone}}
