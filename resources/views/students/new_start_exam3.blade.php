                ...
                <div class="col-md-12">
                    <div class="form h-100 row" style="border-radius: 15px;">
                            ...
                            <div class="col-md-4">
                                    ...
                                    <h4 style="color: #f38639;"> العلامة الكلية  <button class="btn btn-primary" >{{ $exam->success_mark }} </button> </h4>
                            ...
                            <div class="col-md-3" >
                                ...
                                <p style="margin-bottom:0"> دقيقة {{ $exam->period }} </p>
                                {{-- <div class="">
                        ...
                        <div class="form-questions col-md-12" style="margin-top:25px ">
                            @if()
                                <form class="mb-5"  action="{{ route('dashboard.student.save_exam') }}" method="post" id="this_exam">
                            @elseif ()
                                <form class="mb-5"  action="{{ route('dashboard.student.save_exam') }}" method="post" id="this_exam">
                            @endif
                                @csrf
                                ...
                                <div class="group"
                                    ...
                                    <input type="checkbox"  id="rb{{ $item }}"  name="answer[{{ $question->id }}][]" value="{{ $item }}">
