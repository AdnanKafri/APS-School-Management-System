...
<div class="main-panel" >
  <ul class="breadcrumbs" style="padding-bottom: 7px;
    ...
    <li class="li"><a href="#"> المذاكرات</a></li>
           ...
           <div class="col-md-12">
              ...
              <table class=""  >
                  <thead>
                    <tr>
                      <th scope="col">#</th>
                      <th scope="col">اسم المذاكرة</th>
                      <th scope="col">اليوم</th>
                      <th scope="col">التاريخ</th>
                      <th scope="col">الوقت</th>
                      <th scope="col">مدة المذاكرة</th>
                      <th scope="col">النوع</th>
                      <th scope="col">المطلوب </th>
                      <th scope="col">حالة المذاكرة</th>
            ...
            @endphp
                    <tr  style="background: {{ $background }};">
                        ...
                        <td data-label=" اسم المذاكرة"  >{{ $item->name . ' / ' .$item->lesson->name}}</td>
                      ...
                      <td data-label=" مدة المذاكرة" >{{ $item->period }}  </td>
                      <td data-label=" النوع ">
                      @if($item->is_file == 0 )
                      مؤتمت
                  ...
                  @endif
                      ...
                      <td data-label=" حالة المذاكرة">
                        ...
                        @else
                           <a class=" butt aaa btn btn-info circle" href=""
