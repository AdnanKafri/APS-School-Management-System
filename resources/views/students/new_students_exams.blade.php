...
@endif
    <br><br><br>
    <div class="row"  >
        <h1  class="title text-center w-100 m-5" style="text-align: center">  برنامج الامتحانات  </h1>
        <br><br><br><br>

       <table class="table table-bordered table-responsive"
        style="direction: rtl !important;text-align: center !important;display:inline-table">
        <thead>
            <tr style="background:#1C4D76;color:#fff">
              <th scope="col">#</th>
          ...
          @endphp
            <tr style="background: {{ $background }};color:#fff">
              <th scope="row">{{ $i++ }}</th>
              <td>{{ $item->exam_title . ' / ' .$item->lesson->name}}</td>
              <td scope="row">
                  @if( $item->day == 0)
                  السبت
                  @elseif($item->day == 1)
              ...
              <td> <a class="modal-effect btn btn-light btn-sm edit_exam text-primary"
                  style="color:#ff2953 !important"
                  data-effect="effect-scale"
                  data-toggle="modal" data-target="#edit_exam"  data-required="{{ $item->exam_title }}"
                   title="تعديل" >المطلوب</a>
                  </td>
              <td>
                  ...
                  @endif
                  class="btn btn-dark circle" target="_blank">
