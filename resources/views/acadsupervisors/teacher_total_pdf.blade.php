        ...
        <div class="row no-gutters slider-text align-items-end justify-content-center">
            <div class="col-md-9 ftco-animate pb-5 text-center">
                <p class="breadcrumbs"><span class="mr-2">
                        ...
                        <h1 class="mb-0 bread">تنزيل دفتر العلامات
            </div>
        </div>
    </div>
</section>
        ...
        <table style="width:75%" >
          ...
          <tbody style="text-align: center;"  >
           ...
           <tr>
                ...
                <td>{{arabic_w2e($lesson->max_mark)	}} </td>
                 @foreach ($item->student_mark as $item2)
                 <td >{{ arabic_w2e(json_decode($item2->mark2,true)[$lesson_id]['oral'])}}</td>
                <td>{{arabic_w2e( json_decode($item2->mark2,true)[$lesson_id]['homework']) }}</td>
                <td>{{arabic_w2e(json_decode($item2->mark2,true)[$lesson_id]['activities'])}}</td>
                <td>{{arabic_w2e(json_decode($item2->mark2,true)[$lesson_id]['quize'])}}</td>
                <td>{{arabic_w2e( json_decode($item2->mark2,true)[$lesson_id]['exam']) }}</td>
