            ...
            <div class="row align-items-stretch no-gutters contact-wrap"style="border-radius: 10px;">
                <div class="col-md-12">
                    <div class="form h-100" style="border-radius: 15px;">
                               @if($exam->type=="2")
                            <a href="{{ route('acadsupervisor_teacher_quize_mark',[$room->id,$class1->id,$teacher->id,$lesson->id,$exam->id]) }}">  <button
                        class="btn btn-primary rounded-0 py-2 px-4" style="float: left;">عودة</button></a>
                        @else
                         <a href="{{ route('acadsupervisor_teacher_exam_mark',[$room->id,$class1->id ,$teacher->id,$lesson->id,$exam->id]) }}">  <button
                        class="btn btn-primary rounded-0 py-2 px-4" style="float: left;">عودة</button></a>
                        @endif
