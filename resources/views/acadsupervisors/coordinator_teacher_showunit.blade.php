...
<div class="col-md-12 " style="margin: auto; direction: rtl; text-align:center">
    ...
    <div class="row">
        ...
        <input hidden type="text" id="teacher_id" value="{{ $teacher->id }}" name="class_id">
            <input hidden type="text" id="class_id" value="{{ $classes->id }}">


            <input hidden type="text" id="lesson_id" value="{{ $lesson ->id }}" name="lesson_id">
            ...
            var year=$('#year').val();
             var teacher_id=$('#teacher_id').val();
                    ...
                    var data={
                        ...
                        $('.table1 tbody').empty();
                          $('#unit_name').empty();
                    var url = "{{ URL::to('SMARMANger/dashboard/acadsupervisor/searchunitteacher') }}";
                $.ajax({
                    url: url,
                    data : data,
                    type: "get",
