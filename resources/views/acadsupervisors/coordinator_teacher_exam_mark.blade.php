...
<section class="hero-wrap hero-wrap-2" style="background-image: url( {{  asset('teachers/ppp.jpg') }});">
  ...
  <nav class="breadcrumbs">
    <a  class="breadcrumbs__item is-active">   العلامات  </a>
     <a  href="{{ route('acadsupervisor_show_exam_room',[$classes->id,$lesson->id,$room->id,$teacher->id]) }}" class="breadcrumbs__item ">   الامتحانات    </a>
...
<!-- marks of homework -->
      <table class="table1" >
        <thead>
            <tr>
                  <input style="height: 50px; width:60px"  hidden name="room_id"      id="room_id"  value="{{ $room_id }}"  type="text">
                     <input style="height: 50px; width:60px"  hidden name="exam_id"  id="exam_id"  value="{{ $exam_id }}" type="text">
                     <input style="height: 50px; width:60px"  hidden name="lesson_id" id="lesson_id"  value="{{ $lesson_id }}" type="text">
            ...
            <tr>
                ...
                <td >
                    ...
                    <input style="height: 50px; width:60px"  hidden name="exam_result_id"  value="{{ $item->id }}" type="text">
                     ...
                     <input style="height: 50px; width:60px"  hidden name="exam_id"  id="exam_id"  value="{{ $exam_id }}" type="text">
                     <input style="height: 50px; width:60px"  hidden name="lesson_id" id="lesson_id"  value="{{ $lesson_id }}" type="text">
                     <input style="height: 50px; width:60px"  hidden name="user_id"   id="user_id"    value="{{ $item->student->id }}" type="text">
...
var lect=$(this).val();
var home =$('.homeid').val();
var url = "{{ URL::to('SMARMANger/dashboard/acadsupervisor/quizestudent') }}/" + lect+"/"+home+"/"+ room_id;
$.ajax({
url: url,
type: "get",
...
if(lect==1){
    ...
    $.each(data, function (key, value) {
         ...
         c=`<input style="height: 50px; width:60px"  hidden name="exam_result_id" id="exam_result_id"  value="" type="text">`
             d=`<input style="height: 50px; width:60px" name="mark"  value=""   data-id="${ value.id }"  class="common-input mb-20 form-control input1"  type="text"> `
  ...
  d=`<input style="height: 50px; width:60px"  hidden name="exam_result_id" id="exam_result_id"  value="${value1.id}" type="text">
    <input   style="height: 50px; width:60px" name="mark" value="${value1.result}"  data-id="${ value.id }"   class="common-input mb-20 form-control input1"  type="text">`
        if(value1.medal=="1"){
     ...
     d=`   <input style="height: 50px; width:60px"  hidden name="exam_result_id" id="exam_result_id" value="${value1.id}" type="text">
     <input style="height: 50px; width:60px" name="mark" value="" data-id="${ value.id }"  class="common-input mb-20 form-control input1"  type="text"> `
}
...
console.log(value2);
      ...
      b.push(`<a  href= "{{url('https://albayan-virtualschool.com/storage/') }}/${value2.file}"   target="_blank">


<img src="{{  asset('teachers/icons8-downloads-2.png') }}" style="height: 30px;width:30px"></a>`);
