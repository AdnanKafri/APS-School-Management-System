    ...
    <div class="container-login100">
        ...
        @endphp
            ...
            <div class="table_data " >
                ...
                $i2=$i2+1;
            @endphp
        <input class="i2" hidden data-id="{{ $i2 }}" value="{{ $i2 }}">
                <div id="load" class="divIdToPrint">
                    ...
                    <div class="" style="margin: 0 auto;">
                        <div class="text pl-3">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <h4 style="color: #094e89;">الدرجة النهائية <span> : {{ $item->final_grade }}</span>
                                    </h4>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <h5 style="color: #094e89;">الاسم <span> : {{ $teacher->first_name }}
                                            {{ $teacher->last_name }} :</span></h5>
                                </div>
                        ...
                        <div class="text pl-3">
                            <table>
                                <thead>
                                    ...
                                    <tr>
                                        <th rowspan="1" colspan="1" style="text-align: center;">المعيار 1 &#8758; اللغة
                                        </th>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        @if($item->Standard1==1)
                                        <td style="text-align: center;"> <input type="radio" id="tod22" value="1"
                                                checked name="Standard1{{ $i2 }}[]"> </td>
                                        @else
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard1{{ $i2 }}[]" value="1"> </td>
                                        @endif

                                        @if($item->Standard1==2)
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard1{{ $i2 }}[]" value="2" checked> </td>
                                        @else
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard1{{ $i2 }}[]" value="2"> </td>
                                        @endif

                                        @if($item->Standard1==3)
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard1{{ $i2 }}[]" value="3" checked> </td>
                                        @else
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard1{{ $i2 }}[]" value="3"> </td>
                                        @endif
                                        @if($item->Standard1==4)
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard1{{ $i2 }}[]" value="4" checked> </td>
                                        @else
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard1{{ $i2 }}[]" value="4"> </td>
                                        @endif
                                    ...
                                    <tr>
                                        <th rowspan="1" colspan="1" style="text-align: center;">المعيار 2 &#8758;
                                            التمهيد </th>
                                        <th rowspan="1" colspan="1">غير مقبول </th>
                                        <th rowspan="1" colspan="1">مقبول </th>
                                        <th rowspan="1" colspan="1">جيد </th>
                                    ...
                                    <tr>
                                        ...
                                        @if($item->Standard2==1)
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard2{{ $i2 }}[]" value="1" checked> </td>
                                        @else
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard2{{ $i2 }}[]" value="1"> </td>
                                        @endif

                                        @if($item->Standard2==2)
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard2{{ $i2 }}[]" value="2" checked> </td>
                                        @else
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard2{{ $i2 }}[]" value="2"> </td>
                                        @endif

                                        @if($item->Standard2==3)
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard2{{ $i2 }}[]" value="3" checked> </td>
                                        @else
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard2{{ $i2 }}[]" value="3"> </td>
                                        @endif
                                        @if($item->Standard2==4)
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard2{{ $i2 }}[]" value="4" checked> </td>
                                        @else
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard2{{ $i2 }}[]" value="4"> </td>
                                        @endif
                                    ...
                                    <tr>
                                        <th rowspan="1" colspan="1" style="text-align: center;">المعيار 3 &#8758;
                                            الادارة الصفية
                                        </th>
                                        <th rowspan="1" colspan="1">غير مقبول </th>
                                        <th rowspan="1" colspan="1">مقبول </th>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard31{{ $i2 }}[]" value="1" checked> </td>
                                        @else
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard31{{ $i2 }}[]" value="1"> </td>
                                        @endif

                                        @if($item->Standard31==2)
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard31{{ $i2 }}[]" value="2" checked> </td>
                                        @else
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard31{{ $i2 }}[]" value="2"> </td>
                                        @endif

                                        @if($item->Standard31==3)
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard31{{ $i2 }}[]" value="3" checked> </td>
                                        @else
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard31{{ $i2 }}[]" value="3"> </td>
                                        @endif
                                        @if($item->Standard31==4)
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard31{{ $i2 }}[]" value="4" checked> </td>
                                        @else
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard31{{ $i2 }}[]" value="4"> </td>
                                        @endif
                                        <td style="text-align: center;">
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard32{{ $i2 }}[]" value="1" checked> </td>
                                        @else
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard32{{ $i2 }}[]" value="1"> </td>
                                        @endif

                                        @if($item->Standard32==2)
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard32{{ $i2 }}[]" value="2" checked> </td>
                                        @else
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard32{{ $i2 }}[]" value="2"> </td>
                                        @endif

                                        @if($item->Standard32==3)
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard32{{ $i2 }}[]" value="3" checked> </td>
                                        @else
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard32{{ $i2 }}[]" value="3"> </td>
                                        @endif
                                        @if($item->Standard32==4)
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard32{{ $i2 }}[]" value="4" checked> </td>
                                        @else
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard32{{ $i2 }}[]" value="4"> </td>
                                        @endif
                                        <td style="text-align: center;">
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard33{{ $i2 }}[]" value="1" checked> </td>
                                        @else
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard33{{ $i2 }}[]" value="1"> </td>
                                        @endif

                                        @if($item->Standard33==2)
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard33{{ $i2 }}[]" value="2" checked> </td>
                                        @else
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard33{{ $i2 }}[]" value="2"> </td>
                                        @endif

                                        @if($item->Standard33==3)
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard33{{ $i2 }}[]" value="3" checked> </td>
                                        @else
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard33{{ $i2 }}[]" value="3"> </td>
                                        @endif
                                        @if($item->Standard33==4)
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard33{{ $i2 }}[]" value="4" checked> </td>
                                        @else
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard33{{ $i2 }}[]" value="4"> </td>
                                        @endif
                                        <td style="text-align: center;">
                                    ...
                                    <tr>
                                        <th rowspan="1" colspan="1" style="text-align: center;">المعيار 4 &#8758; كفايات
                                            التخصص
                                        </th>
                                        <th rowspan="1" colspan="1">غير مقبول </th>
                                        <th rowspan="1" colspan="1">مقبول </th>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard41{{ $i2 }}[]" value="1" checked> </td>
                                        @else
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard41{{ $i2 }}[]" value="1"> </td>
                                        @endif

                                        @if($item->Standard41==2)
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard41{{ $i2 }}[]" value="2" checked> </td>
                                        @else
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard41{{ $i2 }}[]" value="2"> </td>
                                        @endif

                                        @if($item->Standard41==3)
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard41{{ $i2 }}[]" value="3" checked> </td>
                                        @else
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard41{{ $i2 }}[]" value="3"> </td>
                                        @endif
                                        @if($item->Standard41==4)
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard41{{ $i2 }}[]" value="4" checked> </td>
                                        @else
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard41{{ $i2 }}[]" value="4"> </td>
                                        @endif
                                        <td style="text-align: center;">
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard42{{ $i2 }}[]" value="1" checked> </td>
                                        @else
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard42{{ $i2 }}[]" value="1"> </td>
                                        @endif

                                        @if($item->Standard42==2)
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard42{{ $i2 }}[]" value="2" checked> </td>
                                        @else
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard42{{ $i2 }}[]" value="2"> </td>
                                        @endif

                                        @if($item->Standard42==3)
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard42{{ $i2 }}[]" value="3" checked> </td>
                                        @else
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard42{{ $i2 }}[]" value="3"> </td>
                                        @endif
                                        @if($item->Standard42==4)
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard42{{ $i2 }}[]" value="4" checked> </td>
                                        @else
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard42{{ $i2 }}[]" value="4"> </td>
                                        @endif
                                        <td style="text-align: center;">
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard43{{ $i2 }}[]" value="1" checked> </td>
                                        @else
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard43{{ $i2 }}[]" value="1"> </td>
                                        @endif

                                        @if($item->Standard43==2)
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard43{{ $i2 }}[]" value="2" checked> </td>
                                        @else
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard43{{ $i2 }}[]" value="2"> </td>
                                        @endif

                                        @if($item->Standard43==3)
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard43{{ $i2 }}[]" value="3" checked> </td>
                                        @else
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard43{{ $i2 }}[]" value="3"> </td>
                                        @endif
                                        @if($item->Standard43==4)
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard43{{ $i2 }}[]" value="4" checked> </td>
                                        @else
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard43{{ $i2 }}[]" value="4"> </td>
                                        @endif
                                        <td style="text-align: center;">
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard44{{ $i2 }}[]" value="1" checked> </td>
                                        @else
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard44{{ $i2 }}[]" value="1"> </td>
                                        @endif

                                        @if($item->Standard44==2)
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard44{{ $i2 }}[]" value="2" checked> </td>
                                        @else
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard44{{ $i2 }}[]" value="2"> </td>
                                        @endif

                                        @if($item->Standard44==3)
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard44{{ $i2 }}[]" value="3" checked> </td>
                                        @else
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard44{{ $i2 }}[]" value="3"> </td>
                                        @endif
                                        @if($item->Standard44==4)
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard44{{ $i2 }}[]" value="4" checked> </td>
                                        @else
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard44{{ $i2 }}[]" value="4"> </td>
                                        @endif
                                        <td style="text-align: center;">
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard45{{ $i2 }}[]" value="1" checked> </td>
                                        @else
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard45{{ $i2 }}[]" value="1"> </td>
                                        @endif

                                        @if($item->Standard45==2)
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard45{{ $i2 }}[]" value="2" checked> </td>
                                        @else
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard45{{ $i2 }}[]" value="2"> </td>
                                        @endif

                                        @if($item->Standard45==3)
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard45{{ $i2 }}[]" value="3" checked> </td>
                                        @else
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard45{{ $i2 }}[]" value="3"> </td>
                                        @endif
                                        @if($item->Standard45==4)
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard45{{ $i2 }}[]" value="4" checked> </td>
                                        @else
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard45{{ $i2 }}[]" value="4"> </td>
                                        @endif
                                        <td style="text-align: center;">
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard46{{ $i2 }}[]" value="1" checked> </td>
                                        @else
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard46{{ $i2 }}[]" value="1"> </td>
                                        @endif

                                        @if($item->Standard46==2)
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard46{{ $i2 }}[]" value="2" checked> </td>
                                        @else
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard46{{ $i2 }}[]" value="2"> </td>
                                        @endif

                                        @if($item->Standard46==3)
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard46{{ $i2 }}[]" value="3" checked> </td>
                                        @else
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard46{{ $i2 }}[]" value="3"> </td>
                                        @endif
                                        @if($item->Standard46==4)
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard46{{ $i2 }}[]" value="4" checked> </td>
                                        @else
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard46{{ $i2 }}[]" value="4"> </td>
                                        @endif
                                        <td style="text-align: center;">
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard47{{ $i2 }}[]" value="1" checked> </td>
                                        @else
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard47{{ $i2 }}[]" value="1"> </td>
                                        @endif

                                        @if($item->Standard47==2)
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard47{{ $i2 }}[]" value="2" checked> </td>
                                        @else
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard47{{ $i2 }}[]" value="2"> </td>
                                        @endif

                                        @if($item->Standard47==3)
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard47{{ $i2 }}[]" value="3" checked> </td>
                                        @else
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard47{{ $i2 }}[]" value="3"> </td>
                                        @endif
                                        @if($item->Standard47==4)
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard47{{ $i2 }}[]" value="4" checked> </td>
                                        @else
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard47{{ $i2 }}[]" value="4"> </td>
                                        @endif
                                        <td style="text-align: center;">
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard48{{ $i2 }}[]" value="1" checked> </td>
                                        @else
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard48{{ $i2 }}[]" value="1"> </td>
                                        @endif

                                        @if($item->Standard48==2)
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard48{{ $i2 }}[]" value="2" checked> </td>
                                        @else
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard48{{ $i2 }}[]" value="2"> </td>
                                        @endif

                                        @if($item->Standard48==3)
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard48{{ $i2 }}[]" value="3" checked> </td>
                                        @else
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard48{{ $i2 }}[]" value="3"> </td>
                                        @endif
                                        @if($item->Standard48==4)
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard48{{ $i2 }}[]" value="4" checked> </td>
                                        @else
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard48{{ $i2 }}[]" value="4"> </td>
                                        @endif
                                        <td style="text-align: center;">
                                    ...
                                    <tr>
                                        <th rowspan="1" colspan="1" style="text-align: center;">المعيار 5 &#8758; تعزيز
                                            السلوكيات
                                        </th>
                                        <th rowspan="1" colspan="1">غير مقبول </th>
                                        <th rowspan="1" colspan="1">مقبول </th>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard51{{ $i2 }}[]" value="1" checked> </td>
                                        @else
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard51{{ $i2 }}[]" value="1"> </td>
                                        @endif

                                        @if($item->Standard51==2)
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard51{{ $i2 }}[]" value="2" checked> </td>
                                        @else
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard51{{ $i2 }}[]" value="2"> </td>
                                        @endif

                                        @if($item->Standard51==3)
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard51{{ $i2 }}[]" value="3" checked> </td>
                                        @else
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard51{{ $i2 }}[]" value="3"> </td>
                                        @endif
                                        @if($item->Standard51==4)
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard51{{ $i2 }}[]" value="4" checked> </td>
                                        @else
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard51{{ $i2 }}[]" value="4"> </td>
                                        @endif
                                        <td style="text-align: center;">
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard52{{ $i2 }}[]" value="1" checked> </td>
                                        @else
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard52{{ $i2 }}[]" value="1"> </td>
                                        @endif

                                        @if($item->Standard52==2)
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard52{{ $i2 }}[]" value="2" checked> </td>
                                        @else
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard52{{ $i2 }}[]" value="2"> </td>
                                        @endif

                                        @if($item->Standard52==3)
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard52{{ $i2 }}[]" value="3" checked> </td>
                                        @else
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard52{{ $i2 }}[]" value="3"> </td>
                                        @endif
                                        @if($item->Standard52==4)
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard52{{ $i2 }}[]" value="4" checked> </td>
                                        @else
                                        <td style="text-align: center;"> <input type="radio" id="tod22"
                                                name="Standard52{{ $i2 }}[]" value="4"> </td>
                                        @endif
                                        <td style="text-align: center;">
