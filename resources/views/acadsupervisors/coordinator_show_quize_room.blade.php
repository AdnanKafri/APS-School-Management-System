...
<section class="hero-wrap hero-wrap-2" style="background-image: url( {{  asset('teachers/ppp.jpg') }});">
 ...
 <nav class="breadcrumbs">
    <a  class="breadcrumbs__item is-active">  المذاكرات </a>
     <a  href="{{ route('coordinator_tacher_room',[$class_id->id,$lesson_id->id,$teacher->id]) }}" class="breadcrumbs__item ">{{ $room->name }}   </a>
...
@endif
 ...
 <td>
    ...
    <a href="{{ route('coordinator_teacher_quize_mark',[$room->id ,$class_id->id,$teacher->id,$lesson_id,$item->id]) }}" type="button"   class="btn" style="background-color: white; color: rgb(117, 115, 115);"> مشاهدة </a></td>
            ...
            <table class="" style="">
                ...
                <tbody>
                    ...
                    @endif
                     ...
                     <td><a href="{{ route('coordinator_teacher_quize_mark',[$room->id,$class_id->id ,$teacher->id,$lesson_id,$item->id]) }}" type="button" class="btn" style="background-color: white; color: rgb(117, 115, 115);"> مشاهدة </a></td></td>
