...
<section class="hero-wrap hero-wrap-2" style="background-image: url( {{  asset('teachers/ppp.jpg') }});">
 ...
 <nav class="breadcrumbs">
    <a  class="breadcrumbs__item is-active">   العلامات  </a>
     <a  href="{{ route('acadsupervisor_show_quize_room',[$classes->id,$lesson->id,$room->id,$teacher->id]) }}" class="breadcrumbs__item ">  المذاكرات   </a>
      ...
      <table class="table1" >
        ...
        <tbody>
            ...
            <tr>
                ...
                <a href="{{ route('acadsupervisor.correct_exam1',[$exam1->id,$item->student->id,$teacher->id]) }}" class="btn"  style="background-color: white; color: rgb(117, 115, 115);" >تصحيح الامتحان  </a>&nbsp;&nbsp;&nbsp;
...
var url = "{{ URL::to('SMARMANger/dashboard/acadsupervisor/examstudent1') }}/" + lect+"/"+home+"/"+room_id ;
$.ajax({
url: url,
data : data,
type: "get",
...
if(lect==1){
    ...
    <input   style="height: 50px; width:60px; margin: auto;" name="mark" value="0"  class="common-input mb-20 form-control input1"  type="text">`
...
<td> <a href="{{url('SMARMANger/dashboard/acadsupervisor/correct_exam1') }}/${home}/${value.id}/${teacher_id}" class="btn"  style="background-color: white; color: rgb(117, 115, 115);" >تصحيح الامتحان  </a>
   </td>
${medal}
...
<td> <a href="{{url('SMARMANger/dashboard/acadsupervisor/correct_exam1') }}/${home}/${value2.id}/${teacher_id}" class="btn"  style="background-color: white; color: rgb(117, 115, 115);" >تصحيح الامتحان  </a>
