...
@endif
 <nav class="breadcrumbs">
    <a  class="breadcrumbs__item is-active">  امتحانات </a>
...
<td>  <a   href="{{ route('acadsupervisor_teacher_exam_mark',[$room->id,$classes->id,$teacher->id,$lesson->id,$item->id]) }}" class="btn edit" class="btn" style="background-color: white; color: rgb(117, 115, 115);">   عرض العلامات   </a></td>
 <td>{{ $item->period }}</td>
  <td>{{ $item->mark }}</td>
...
@endforeach
 ...
 <td>
  ...
  <a href="{{ route('acadsupervisor_teacher_exam_mark',[$room->id,$classes->id,$teacher->id,$lesson->id,$item->id]) }}" type="button"    class="btn" style="background-color: white; color: rgb(117, 115, 115);">  عرض العلامات </a></td>
                 <td>{{ $item->period }}</td>
                  <td>{{ $item->mark }}</td>
                    </tr>
