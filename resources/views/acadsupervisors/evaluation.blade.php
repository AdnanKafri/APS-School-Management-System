...
<div id="load" style=" Dejavu Sans">
    <form style="width:1000px;"  action="{{ route('acadsupervisor.editevaluion') }}"  class="mb-5" method="post" >
        <!-- start menue -->
        @csrf
    ...
    <button  id="buttondown"  class="btn btn-primary" style="width: 100px;display:none;color: aliceblue;" >
        ...
        <a href="{{ route('acadsupervisor_pdf',[$lesson->id,$teacher->id,$classes->id,$item->id]) }}"  target="_blank" style="color: aliceblue;">
            تنزيل التقيم</a>
              </button>
              <button  id="buttondown1"  class="btn btn-primary" style="width: 200px;display:none;color: aliceblue;"  >
                <a href="{{ route('acadsupervisor_all_pdf',[$lesson->id,$teacher->id,$classes->id]) }}"  target="_blank" style="color: aliceblue;">
