      ...
      <div class="row align-items-stretch no-gutters contact-wrap" style="border-radius: 15px;">
        <div class="col-md-12 col-xs-12"  >
          ...
          <div class="form h-100"  style="border-radius: 15px;">
            <div class="search">
                <input class="search__input" id="search" placeholder="chercher.."/>
              ...
              <div class="select" style=" border-radius: 5px; float: left;width: 200px;" >
                <select class="download">
                  <option value="1" > Télécharger</option>

                      <option value="3">page de chargement</option>
                      <option value="4">tout télécharger</option>
          ...
          <input hidden value="{{ $term->id }}" name="term_id" id="trem_id1" type="text">
            ...
            @include('acadsupervisors.load_fr')
            </div>
            <input style="width: 200px; text-align: center;margin-top: -20px;"  hidden  id="lesson_name"   class="common-input mb-20 form-control" disabled  value="{{ $lesson_id->name }}"  type="text">
            ...
            <input style="width: 100px; text-align: center;margin-top: -20px;" hidden id="class_name"  value="{{ $class_id->name }}" disabled  class="common-input mb-20 form-control" type="text">&nbsp;&nbsp;&nbsp;

            <input style="width: 100px; text-align: center;margin-top: -20px;" id="class_id"  name="class_id" hidden  value="{{ $class_id->id }}" disabled  class="common-input mb-20 form-control" type="text">
