...
<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    <div class="container">
        <br>
        <br>
       <a class="navbar-brand" href="{{ route('dashboard.acadsupervisor.profile') }}" target="_blank" ><span>{{$coordinator->first_name }} &nbsp;
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item"><a href="{{ route('dashboard.acadsupervisor') }}" class="nav-link"> الصفحة الرئيسية 
                    </a></li>
             
                <li class="nav-item"><a href="{{ route('acadsupervisor.chat') }}" class="nav-link">   <i class="fa fa-comments" aria-hidden="true" style="font-size: 26px;
    height: 30px;
    width: 9px;    
    color: #0a4f8a;" ></i>  
                    </a></li>&nbsp;&nbsp;&nbsp;
