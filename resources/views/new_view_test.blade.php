...
@section('content')
                ...
                <div class="form_main">
                    <div class="row" style="direction: rtl;">
                        ...
                        <div class="col-md-4 text-center">
                            <img src="{{ asset('teachers/photo/shaar3.png') }}" alt="" class="exam_logo">
                        </div>
                            ...
                            @if ($question->section->type == '3')
                                ...
                                <div class="row pt-4" style="direction: rtl;text-align: right;">
                                    <div class="col-md-8">
                                        ...
                                        <img style="max-width:50%;max-height:25%"
                                        ...
                                        @if (isset($value[0]) && in_array($item, $value))
                                            <label class="radio-label" for="rb{{ $item }}">
                                                ...
                                                <span class="radio-text"
                                                    style="color: red !important">{{ $item }}</span>
                                            </label>
    ...
    <div class="col-md-4" style="text-align: end;">
        <input class="input deservedMark1"style="width: 60px;height: 50px;" name="mark[]" readonly=""
            type="text"
            @if ($a == 0) value="0" @else
                                value="{{ $question->mark }}" @endif>
        <input hidden name="mark0" type="text" value="{{ $question->mark }}">
        <button class="mark_sub"><span> {{ $question->mark }}</span></button>
    </div>
</div>
@else
@if ($exam_result->user_answers)
    ...
    @foreach (json_decode($exam_result->user_answers, true) as $key => $user_answer)
        ...
        @if ($key == $question->id)
            ...
            @if ($question->ques_type == '2')
                <div class="row pt-4" style="direction: rtl;text-align: right;">
                    <div class="col-md-8">
                        <p name="content" class="" style="direction:rtl; text-align: right;">
                            {{ $user_answer[0] }}
                        </p>
                    </div>
            @endif
            <div class="col-md-4"style="text-align: end;">
                <input class="input"style="width: 60px;height: 50px;" name="traditional_result[{{ $question->id }}]"
                    placeholder="" type="text" readonly
                    @if (
                        $exam_result->traditional_result != null &&
                            $exam_result->traditional_result != 'null' &&
                            isset($exam_result->traditional_result)) @foreach (json_decode($exam_result->traditional_result, true) as $key => $value)
