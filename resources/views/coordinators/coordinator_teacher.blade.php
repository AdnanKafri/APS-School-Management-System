...
<!-- end new-->
 <nav class="breadcrumbs">
    <a  class="breadcrumbs__item is-active">{{ $teacher->first_name }}  {{ $teacher->last_name }} </a>
                    ...
                    <div class="row align-items-center mb-2 d-flex">
                        <div class="col-8">
                            <h2 class="d-flex align-items-center mb-0">
								<a href="{{ route('coordinator_teacher_schedule',[$teacher->id,$classes->id,$lesson->id]) }}" target="_blank" class="d-flex align-items-center mb-0" style="color: white;"> جدول الدوام</a>
                            </h2>
                        </div>
            ...
            <div class="card l-bg-blue-dark">
                <div class="card-statistic-3 p-4">
                    ...
                    <div class="row align-items-center mb-2 d-flex">
                        <div class="col-8">
                            <h2 class="d-flex align-items-center mb-0">
								<a href="{{ route('dashboard.coordinator_teacher_lesson',[$classes->id,$teacher->id,$lesson->id]) }}" class="d-flex align-items-center mb-0" style="color: white;">  الدروس</a>
                            </h2>
                        </div>
            ...
            <div class="card l-bg-blue-dark">
                <div class="card-statistic-3 p-4">
                    ...
                    <div class="row align-items-center mb-2 d-flex">
                        <div class="col-8">
                            <h2 class="d-flex align-items-center mb-0">
								<a href="{{ route('showclass',[$lesson->id,$teacher->id,$classes->id]) }}" class="d-flex align-items-center mb-0" style="color: white;"> التقييم </a>
                            </h2>
                        </div>
                    ...
                    <div class="row align-items-center mb-2 d-flex">
                        <div class="col-8">
                            <h2 class="d-flex align-items-center mb-0">
								...
								<a href="{{ route('coordinator_tacher_room',[$classes->id,$lesson->id,$teacher->id]) }}" class="d-flex align-items-center mb-0" style="color: white;"> المذاكرات </a>
                            </h2>
                        </div>
                    ...
                    <div class="row align-items-center mb-2 d-flex">
                        <div class="col-8">
                            <h2 class="d-flex align-items-center mb-0">
								...
								<a href="{{ route('coordinator_tacher_room1',[$classes->id,$lesson->id,$teacher->id]) }}" class="d-flex align-items-center mb-0" style="color: white;"> الامتحانات </a>
                            </h2>
                        </div>
                    ...
                    <div class="row align-items-center mb-2 d-flex">
                        <div class="col-8">
                            <h2 class="d-flex align-items-center mb-0">
								...
								<a href="{{route('coordinator_teacher_plan',[$classes->id,$lesson->id,$teacher->id])}}" class="d-flex align-items-center mb-0" style="color: white;">  الخطة الفصلية </a>
                            </h2>
                        </div>
                    ...
                    <div class="row align-items-center mb-2 d-flex">
                        <div class="col-8">
                            <h2 class="d-flex align-items-center mb-0">
								...
								<a href="{{route('coordinator_teacher_showunit',[$classes->id,$lesson->id,$teacher->id])}}" class="d-flex align-items-center mb-0" style="color: white;"> تحليل الوحدة  </a>
                            </h2>
                        </div>
                    ...
                    <div class="row align-items-center mb-2 d-flex">
                        <div class="col-8">
                            <h2 class="d-flex align-items-center mb-0">
								...
								<a href="{{route('coordinator_tacher_room_mark',[$classes->id,$lesson->id,$teacher->id])}}" class="d-flex align-items-center mb-0" style="color: white;">  دفتر العلامات   </a>
                            </h2>
                        </div>
