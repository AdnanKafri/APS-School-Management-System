...
<section class="hero-wrap hero-wrap-2" style="background-image: url( {{  asset('teachers/ppp.jpg') }});">
 ...
 <nav class="breadcrumbs">
      <a  class="breadcrumbs__item is-active">   مشاهدة وحدات المادة   </a>
   <a  href="{{ route('unit_analysis',[$class_id->id,$lesson_id->id]) }}" class="breadcrumbs__item ">اضافة تحليل وحدة </a>
...
<div class="col-md-12 " style="margin: auto; direction: rtl; text-align:center">
    ...
    <div class="row">
        ...
        <form action="{{ route('updateunit') }}" method="post">
            @csrf
            <input hidden type="text" id="class_id" value="{{ $class_id->id }}" name="class_id">
     ...
     <table id="example" class="table1 table-bordered table-responsive"
                ...
                <thead>
                    <tr>
                        ...
                        <th scope="col" span="2"  style="border: none !important;">
                            <input type="text" name="unit_name" id="unit_name"  style="border: none;
                            width: 100%;
                            border-bottom: 1px solid;" value="{{ $item->unit_name }}"  >
                  ...
                  $i=$i+1
                   ...
                   <td >
                    <input type="text" hidden class="i" value="{{ $i }}">
                      <textarea  style="border: none;" class="comt" data-id="{{$i}}" name="comt{{$i}}[]"> {{ $item1[0] }} </textarea>

                  </td>
                  <td >
                      <textarea  style="border: none;" class="comt" data-id="{{$i}}"  name="comt{{$i}}[]"> {{ $item1[1] }} </textarea>
                  </td>
                  <td >
                      <textarea  style="border: none;" class="comt"  data-id="{{$i}}" name="comt{{$i}}[]"> {{ $item1[2] }} </textarea>
                  </td>
                  <td >
                      <textarea  style="border: none;" class="comt" data-id="{{$i}}" name="comt{{$i}}[]">  {{ $item1[3] }}</textarea>
                  </td>
                  <td>
                      <textarea  style="border: none;" class="comt" data-id="{{$i}}"name="comt{{$i}}[]">  {{ $item1[4] }}</textarea>
                  </td>
                  <td >
                      <textarea  style="border: none;" class="comt"  data-id="{{$i}}" name="comt{{$i}}[]"> {{ $item1[5] }} </textarea>
                  </td>
                  <td >
                      <textarea  style="border: none;" class="comt" data-id="{{$i}}"   name="comt{{$i}}[]"> {{ $item1[6] }} </textarea>
                  </td>
...
$(document).on('keyup', '#search', function () {
            ...
            var year=$('#year').val();
                    ...
                    var data={
                        ...
                        $('.table1 tbody').empty();
                          $('#unit_name').empty();
                    var url = "{{ URL::to('SMARMANger/dashboard/coordinator/searchunit') }}";
                  $.ajax({
                    url: url,
                    data : data,
                    type: "get",
