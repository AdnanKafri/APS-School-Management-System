        ...
        <div class="row no-gutters slider-text align-items-end justify-content-center">
            <div class="col-md-9 ftco-animate pb-5 text-center">
                <p class="breadcrumbs"><span class="mr-2">
                        ...
                        <h1 class="mb-0 bread">اضافة امتحان </h1>
            </div>
        </div>
    </div>
</section>
...
<section class="ftco-section bg-light">
    <div class="container">
        <a href="{{ route('coordinator_table_exam',[$class_id->id ,$lesson_id->id]) }}" class="btn btn-primary"  type="button"  style="margin-top: 30px;">
            الامتحانات   &nbsp;  </a>
                    ...
                    <section style="text-align:right; direction:rtl">
                        ...
                        <div class="row" style="justify-content: center;">
                            ...
                            <div class="data-card">
                                ...
                                <h5 style="color: #094e89;">اضف اسم الامتحان </h5>
                                <br>

                                <input name="name_quize" placeholder="ادخل اسم الامتحان "
                        ...
                        <div class="row" style="justify-content: center;">
                            ...
                            <div class="data-card">
                                <h5 style="color: #094e89;">اضافة  امتحان </h5>
                                <br>
                                <br>
