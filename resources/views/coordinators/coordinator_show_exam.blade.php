        ...
        <div class="row no-gutters slider-text align-items-end justify-content-center">
            <div class="col-md-9 ftco-animate pb-5 text-center">
                <p class="breadcrumbs"><span class="mr-2">
                        ...
                        <h1 class="mb-0 bread"> الامتحانات
            </div>
        </div>
    </div>
</section>
...
@endif
 <nav class="breadcrumbs">
    <a  class="breadcrumbs__item is-active"> {{ $room_id->name }}  </a>
      <a  href="{{ route('coordinator_table_exam',[$class_id->id,$lesson_id->id]) }}" class="breadcrumbs__item"> الامتحانات للشعب  </a>
...
<br>
<br>
<input hidden value="{{$room_id->id}}" id="room_id">
    ...
    <div class="modal-dialog">
        <div class="modal-content" style="direction:rtl">
            ...
            <div class="modal-footer">
                <form action="{{ route('quize_delete') }}" method="POST">
                    @csrf
                <input id="s11" hidden  name="id"type="text">
                <button type="button" class="btn btn-default" data-dismiss="modal">الغاء</button>
                <button type="submit" class="btn btn-primary confirm3">نعم , موافق</button>
                </form>
            </div>
        </div>
    </div>
            ...
            <div class="tabs mt-3">
                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="visa" role="tabpanel"
                        ...
                        <div class="mt-4 mx-4">
                            <form action="{{ route('quize_update') }}" method="post"    enctype="multipart/form-data">
                            ...
                            <div class="text-center">
                              ...
                              <label class="form__label" for="" >تحميل  ملف الامتحان </label>
                            ...
                            <main class="main_full" >
                              ...
                              <div class="button_outer">
                                <div class="btn_upload">
                                  <input type="file" id="upload_file" name="quize"  accept="file_extension/*">
                                  تحميل ملف
                                  </div>
...
<div class="tab1cards">
    ...
    <a  href="{{ route('coordinator_add_auto',[$class_id->id ,$lesson_id->id]) }}" target="_blank" type="button" class="btn btn-primary"
    style="padding-top: 13px;">
          بنك الاسئلة &nbsp; <i class="fa fa-plus"></i> </a>&nbsp;
...
@endif
 ...
 <td>  <a data-name_quize="{{ $item ->name_quize  }}"  data-type="{{ $item ->type }}"   data-groupe="{{ $item ->groupe }}"  data-quize="{{ $item ->quize }}" data-id="{{  $item ->id }}" data-endtime="{{  $item ->end_time }}"  data-start_time="{{  $item ->start_time }}" data-toggle="modal"  data-target="#staticBackdrop5"  class="btn edit" class="btn" style="background-color: white; color: rgb(117, 115, 115);"> اضافة ملف  </a></td>
 <td>{{ $item->period }}</td>
  <td>{{ $item->mark }}</td>
            ...
            <table class="" style="">
                ...
                <tbody>
                    ...
                    @endif
                     ...
                     <td><a href="{{ route('quest_exam',[$item->id,$class_id->id,$lesson_id]) }}" type="button" class="btn" style="background-color: white; color: rgb(117, 115, 115);"> مشاهدة </a></td></td>


                     <!--<td><a href="{{ route('exams',[$class_id ,$lesson_id ]) }}"  data-name_quize="{{ $item ->name_quize  }}" data-type="{{ $item ->type }}"   data-peroid="{{ $item ->period }}"  data-id="{{  $item ->id }}" data-endtime="{{  $item ->end_time }}"  data-start_time="{{  $item ->start_time }}" -->
                     <!--  type="button" class="btn edit" style="background-color: white; color: rgb(117, 115, 115);"> تعديل </a></td></td>-->
 <td>
 
  <a href="{{ route('exams_addquestion',[$item->id,$item->room->id,$class_id->id,$lesson_id]) }}" type="button"  target="_blank"  class="btn" style="background-color: white; color: rgb(117, 115, 115);"> اضافة سؤال </a></td>
                 <td>{{ $item->period }}</td>
                  <td>{{ $item->mark }}</td>
                    </tr>
                    @endif
