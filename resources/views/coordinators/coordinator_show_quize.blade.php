...
@endif
 <nav class="breadcrumbs">
    <a  class="breadcrumbs__item is-active"> {{ $room_id->name }}  </a>
      <a  href="{{ route('coordinator_table_quize',[$class_id->id,$lesson_id->id]) }}" class="breadcrumbs__item"> المذاكرات للشعب  </a>
                    ...
                    <div class="tab-pane fade show active" id="visa" role="tabpanel"
                        ...
                        <div class="mt-4 mx-4">
                            ...
                            <div class="text-center">
                              ...
                              <label class="form__label" for="" >تحميل  ملف المذاكرة </label>
            ...
            <table class="" style="">
                ...
                <tbody>
                    ...
                    @endif
                     ...
                     <td><a href="{{ route('quest_exam',[$item->id,$class_id,$lesson_id]) }}" type="button" class="btn" style="background-color: white; color: rgb(117, 115, 115);"> مشاهدة </a></td></td>
