              ...
              <div class="col-md-12">
                ...
                <div class="form h-100" style="border-radius: 15px;">
                  ...
                  <h3 style="color: #094e89;">تفاصيل السؤال </h3>
                        <form action="{{ route('question_update',$id) }}" method="post"
                            class="mb-5" >
                            @csrf
                                ...
                                <div id="add">
                                    ...
                                    <script>
                                        $(document).on('click', '#btn', function () {
                                            $('#add').append(
                                                '<div class="row" id="register"><div class="col-md-12 form-group mb-3"><label for="" class="col-form-label"> </label> <input type="text" class="form-control input" name="option[]" placeholder="ادخل الخيار التالي "></div></div>'
                                            );
