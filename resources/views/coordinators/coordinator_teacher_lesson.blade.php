    ...
    <div class="container">
     ...
     <!-- add lesson -->
          ...
          <button   style="float: left;"
            ...
            >
            <a href="{{ route('dashboard.teacher.prepare',[$classes->id,$lesson->id,$teacher->id]) }}" style="color:white">
        ...
        <div class="col-md-4 ftco-animate">
           <div class="project-wrap">
             ...
             <div class="text p-4">
                 ...
                 <!--<a  style="float: left;    padding-right: 7px;"  style="color:#094e89"  class="edit11"  data-toggle="modal" data-target="#staticBackdrop1"  data-id="{{ $item->id }}" data-name="{{ $item->name }}" >  <i class="fa fa-pencil"></i></a>-->
                 <!--   <a  style="float: left;    padding-right: 7px;" href="#" style="color:#f38639" > <i class="fa fa-trash-o"></i></a>-->
                 <!--      @if($item->key == 0)-->
                 <!--   <a  style="float: left; "   class="key" data-id="{{ $item->id }}"> <i class="fa fa-key"  style="color: green"></i></a>-->
                 <!--   @else-->
                 <!--   <a  style="float: left;"   class="key"  data-id="{{ $item->id }}" > <i class="fa fa-key"  style="color: red"></i></a>-->
            ...
            <a href="{{ route('dashboard.coordinator_show',[$lesson->id,$teacher->id,$item->room->id ,$item->id]) }}" style="color:#094e89" > محتوى الدرس </a> </li>
