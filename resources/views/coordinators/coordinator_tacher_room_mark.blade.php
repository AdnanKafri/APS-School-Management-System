    ...
    <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-center">
            <div class="col-md-9 ftco-animate pb-5 text-center">
                        ...
                        <h1 class="mb-0 bread">      دفتر العلامات  لشعب الاستاذ   </h1>
            </div>
        </div>
    </div>
</section>
    ...
    <table  >
        ...
        <tbody>
            ...
            <tr >
                ...
                <td>
                    <a href="{{ route('StudentsRoomLessontotal1',[$item->id,$teacher->id,$lesson_id->id]) }}" type="button" class="btn" style="background-color: white; color: rgb(117, 115, 115);"> مشاهدة </a></td>
