    ...
    <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-center">
            <div class="col-md-9 ftco-animate pb-5 text-center">
                        ...
                        <h1 class="mb-0 bread"> المذاكرات للشعب  </h1>
            </div>
        </div>
    </div>
</section>
<!-- start new-->
 <nav class="breadcrumbs">
    <a  class="breadcrumbs__item is-active"> المذاكرات للشعب</a>
    ...
    <table  >
        ...
        <tbody>
            ...
            <tr >
                ...
                <td>
                    <a href="{{ route('coordinator_show_quize',[$class_id->id ,$lesson_id->id,$item->id ]) }}" type="button" class="btn" style="background-color: white; color: rgb(117, 115, 115);"> مشاهدة </a></td>
