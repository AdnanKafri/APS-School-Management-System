...
<section class="hero-wrap hero-wrap-2" style="background-image: url( {{  asset('teachers/ppp.jpg') }});">
 ...
 <nav class="breadcrumbs">
    <a  class="breadcrumbs__item is-active">  الامتحانات </a>
     <a  href="{{ route('coordinator_tacher_room1',[$class_id->id,$lesson_id->id,$teacher->id]) }}" class="breadcrumbs__item ">{{ $room->name }}   </a>
                    ...
                    <div class="tab-pane fade show active" id="visa" role="tabpanel"
                        ...
                        <div class="mt-4 mx-4">
                            ...
                            <div class="text-center">
                                ...
                                <span style="float: right;">اسم الاختبار</span>
                                <br>
                            ...
                            <br>
                                ...
                                <br>
                                <input   style="text-align: right;" name="start_time"
                            ...
                            <div class="auto" style="display: none">
                                <span style="float: right;">علامة الاختبار</span>
                                <br>
                                <input style="text-align: right;" type="text"
                                ...
                                <br>
                                <input style="text-align: right;"  name="period"  type="text"
                            ...
                            <div class="normal" style="display: none">
                                ...
                                <span style="float: right;"> رابط خارجي </span>
                                <br>
                                <input style="text-align: right;" type="text"
                                    class="form-control name1"  id="quiz_link" name="quiz_link"
...
@endif
 ...
 <td>
    ...
    <a href="{{ route('coordinator_teacher_exam_mark',[$room->id ,$class_id->id,$teacher->id,$lesson_id,$item->id]) }}" type="button"   class="btn" style="background-color: white; color: rgb(117, 115, 115);"> مشاهدة </a></td>
            ...
            <table class="" style="">
                ...
                <tbody>
                    ...
                    @endif
                     ...
                     <td><a href="{{ route('coordinator_teacher_exam_mark',[$room->id,$class_id->id ,$teacher->id,$lesson_id,$item->id]) }}" type="button" class="btn" style="background-color: white; color: rgb(117, 115, 115);"> مشاهدة </a></td></td>
...
<script>
      $(".edit").on("click", function (e) {
        ...
        if(type=='5'){
            ...
            var endtime= $(this).data('endtime');
            var starttime = $(this).data('start_time');
            var quiz_link = $(this).data('quiz_link');
            var quize_file = $(this).data('quize');

            $('.name1').val(name_quize)

            $('#quiz_link').val(quiz_link)
            $('.strat').val(starttime)
            $('.end').val(endtime)
            ...
            if(quize_file){
                $('.A').append(` <label class="form__label" for="">ملف الامتحان </label>
                                <a  href= "{{url('http://localhost/smartsyrianschool/storage/') }}/${quize_file}"      id="quize_file"   target="_blank" style="margin:0 auto ">
