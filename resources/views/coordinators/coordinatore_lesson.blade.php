...
<section class="hero-wrap hero-wrap-2" style="background-image:url( {{  asset('teachers/ppp.jpg') }})">
 ...
 <nav class="breadcrumbs">
    <a  class="breadcrumbs__item is-active">{{ $lesson->name }} </a>
                    ...
                    <div class="row align-items-center mb-2 d-flex">
                        <div class="col-8">
                            <h2 class="d-flex align-items-center mb-0">
								<a href="{{ route('unit_analysis',[$classes->id,$lesson->id]) }}" class="d-flex align-items-center mb-0" style="color: white;">  تحليل الوحدة</a>
                            </h2>
                        </div>
            ...
            <div class="card l-bg-blue-dark">
                <div class="card-statistic-3 p-4">
                    ...
                    <div class="row align-items-center mb-2 d-flex">
                        <div class="col-8">
                            <h2 class="d-flex align-items-center mb-0">
								<a href="{{ route('coordinator_table_quize',[$classes->id,$lesson->id]) }}" class="d-flex align-items-center mb-0" style="color: white;">   مذاكرات</a>
                            </h2>
                        </div>
            ...
            <div class="card l-bg-blue-dark">
                <div class="card-statistic-3 p-4">
                    ...
                    <div class="row align-items-center mb-2 d-flex">
                        <div class="col-8">
                            <h2 class="d-flex align-items-center mb-0">
								<a href="{{ route('coordinator_table_exam',[$classes->id,$lesson->id]) }}" class="d-flex align-items-center mb-0" style="color: white;">   امتحانات</a>
                            </h2>
                        </div>
            ...
            <div class="card l-bg-blue-dark">
                <div class="card-statistic-3 p-4">
                    ...
                    <div class="row align-items-center mb-2 d-flex">
                        <div class="col-8">
                            <h2 class="d-flex align-items-center mb-0">
								<a href="{{ route('planification_trimestrielle',[$classes->id,$lesson->id]) }}" class="d-flex align-items-center mb-0" style="color: white;">   الخطة الفصلية </a>
                            </h2>
                        </div>
