...
<body  style="background-image: url( {{  asset('teachers/images/new2.jpg') }});
             background-size: cover; border-radius: 15px;     text-align: left;
    direction: ltr; ">

    <div class="content" style=" text-align: left; padding-bottom: 16px;">
...
<input class="i2" hidden data-id="{{ $i2 }}" value="{{ $i2 }}">
           <div>
            <div class="row" style="padding-right: 20px; padding-top:20px;margin-left: 0px;">
                <h5 style="    padding-left: 23px;">   Daily preparation of the material  </h5> :&nbsp;
               <span>{{ $lesson_id->name_en }}</span>

            </div>
            <br>
            <div class="row" style="padding-right: 20px;">
            <div class="col-md-4" style="text-align: left;">
                <h7 style="    padding-left: 23px;">  class  </h7> :&nbsp;
                <span>{{ $class_id->name_en }}</span>

            </div>
            <div class="col-md-8">
                <div  style="display: inline-flex;">
                    <h7 style="    padding-left: 23px;">  Section  </h7>: &nbsp;
            ...
            <div class="col-md-12">
                    ...
                    <h7 style="    padding-left: 23px;">  Period  </h7>&nbsp;:
            ...
            <div class="col-md-6">
                   <h7 style="    padding-left: 23px;"> Time </h7> &nbsp;:
            ...
            <div class="row" >
                ...
                <h7 style="    padding-left: 38px;">Date  </h7 >&nbsp;:
...
<div class="col-md-6">
                ...
                <h7 style="    padding-left: 23px;">unit </h7>:
...
<div class="col-md-6">
                <h7 style=" padding-left: 23px;">Lesson </h7> &nbsp;:
            ...
            <div class="row" style="padding-right: 20px;">
                <div class="col-md-11">
                <h7 style="  padding-left: 23px;"> Standard/ Overall Objective of the lesson   : </h7>:
                     <span
         ...
         &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                ...
                <div class="col-md-11">
                <h7 style="    padding-left: 23px;">  Motivational Introduction/ Creating a Catalyst/ Challenge :  </h7>:
           
       
         <span 
             style="width: 240px; text-align: center;background: #00ffff00;border: none; " class="common-input mb-20 form-control" type="text">
             {{ $prepare->stimulating_initialization }}</span>
                </div>
                ...
                <div  >
                    <div class="tab1cards">
                        ...
                        <div style="padding-left: 19px;"  >
                           <h7>       Performance Indicators</h7>
                                @php
                                    $i=0;
                                @endphp
                                @if($prepare->procedures_and_activities != null)
                                @if(json_decode($prepare->procedures_and_activities))
                        ...
                        <div >
                            ...
                            @php
                                ...
                                @endphp
                                 <input hidden class="i" value="{{ $i }}" type="text">
                                <div data-id="{{ $i }}"  value="{{ $item3[1] }}" style="border-bottom: 1px solid black;" >{{ $i }}  &#8758; {{ $item3[1] }}</div>
                                @endforeach
                                @endif
                                @endif
                        ...
                        <div style="width: 700px;" >
                            ...
                            @php
                                ...
                                @endphp
                                 <input hidden class="i" value="{{ $i }}" type="text">
                            <div data-id="{{ $i }}"  value="{{ $item3[2] }}" style="border-bottom: 1px solid black;" >{{ $i }}  &#8758; {{ $item3[2] }}</div>
                            @endforeach
                            @endif
                            @endif
                            <div class="appendme"> </div>
...
<br>
 ...
 @if($prepare->means!='null' && $prepare->created_at <= "2022-10-12 07:50:09")
                            ...
                            data-id="Cotton Candy" value="Cotton Candy"><label for="checkboxTwo"> White Board
                        </label></li>

                            @endif
                            @if($item2 =="Rarity")
                            <li><input type="checkbox" id="checkboxThree" name="means[]" class="x" data-id="Rarity"
                                value="Rarity"><label for="checkboxThree"> Work Sheets  </label></li>
                            ...
                            <li><input type="checkbox" id="checkboxFive" name="means[]" class="x" data-id="Surprise"
                                value="Surprise"><label for="checkboxFive">Cards </label></li>

                            @endif
                            @if($item2 =="Twilight Sparkle")
                            <li><input type="checkbox" id="checkboxSix" name="means[]" class="x"
                                data-id="Twilight Sparkle" value="Twilight Sparkle"><label for="checkboxSix">Maps
                            </label></li>
                            @endif
                            @if($item2 =="Fluttershy")
                            <li><input type="checkbox" id="checkboxSeven" name="means[]" class="x" data-id="Fluttershy"
                                value="Fluttershy"><label for="checkboxSeven">video Clip   </label></li>
                            @endif
                            @if($item2 =="Derpy Hooves")
                            <li><input type="checkbox" id="checkboxEight" name="means[]" class="x"
                                data-id="Derpy Hooves" value="Derpy Hooves"><label for="checkboxEight">Models & Games
                            </label></li>
                            @endif
                            ...
                            <li><input type="checkbox" id="checkboxThirteen" name="means[]" class="x"
                                ...
                                for="checkboxThirteen">Web Sites
                            </label></li>
                            ...
                            @if($item2 =="Medley")
                            <li><input type="checkbox" id="checkboxFourteen" name="means[]" class="x" data-id="Medley"
                                value="Medley"><label for="checkboxFourteen">Others </label></li>
                    ...
                    <ul class="ks-cboxtags">
                        <div class="row " style="justify-content: center;">
                            ...
                            <li><input type="checkbox" id="checkboxO" name="roads[]" class="x1" data-id="Rainbow Dash"
                                value="Rainbow Dash"><label for="checkboxO"> In-Class Learning </label></li>

                            @endif
                            @if($item2 =="Cotton Candy")
                            <li><input type="checkbox" id="checkboxT" name="roads[]" class="x1" data-id="Cotton Candy"
                                value="Cotton Candy"><label for="checkboxT">Research & Exploration  </label></li>
                                   @endif
                            @if($item2 =="Rarity")
                            <li><input type="checkbox" id="checkboxTh" name="roads[]" class="x1" data-id="Rarity"
                                value="Rarity"><label for="checkboxTh"> Brain Storming </label></li>
                            @endif
                            @if($item2 =="Moondancer")
                            <li><input type="checkbox" id="checkboxF" name="roads[]" class="x1" data-id="Moondancer"
                                value="Moondancer"><label for="checkboxF">Presentation</label></li>

                            @endif
                            @if($item2 =="Surprise")
                            <li><input type="checkbox" id="checkboxFi" name="roads[]" class="x1" data-id="Surprise"
                                value="Surprise"><label for="checkboxFi">Listening </label></li>
                            @endif
                            @if($item2 =="Twilight Sparkle")
                            ...
                            <li><input type="checkbox" id="checkboxSev" name="roads[]" class="x1" data-id="Fluttershy"
                                value="Fluttershy"><label for="checkboxSev">Scrabble </label></li>
                            @endif
                            @if($item2 =="Derpy Hooves")
                            <li><input type="checkbox" id="checkboxEig" name="roads[]" class="x1" data-id="Derpy Hooves"
                                value="Derpy Hooves"><label for="checkboxEig">Charts </label></li>
                                  @endif
                            @if($item2 =="Princess Celestia")
                            <li><input type="checkbox" id="checkboxNi" name="roads[]" class="x1"
                                data-id="Princess Celestia" value="Princess Celestia"><label for="checkboxNi">
                                    Individual work
                            </label></li>
                            @endif
                            @if($item2 =="Gusty")
                            <li><input type="checkbox" id="checkboxTen1" name="roads[]" class="x1" data-id="Gusty"
                                value="Gusty"><label for="checkboxTen1">Learning by Peers   </label></li>
                           ...
                           <li class="ks-selected"><input type="checkbox" name="roads[]" class="x1" data-id="Discord"
                            ...
                            <li><input type="checkbox" id="checkboxTw" name="roads[]" class="x1" data-id="Clover"
                                value="Clover"><label for="checkboxTw">Self-Learning  </label></li>
                            @endif
                            @if($item2 =="Baby Moondancer")
                            <li><input type="checkbox" id="checkboxThir" name="roads[]" class="x1"
                                data-id="Baby Moondancer" value="Baby Moondancer"><label for="checkboxThir">
                                    Group Work
                            </label></li>
                            ...
                            <li><input type="checkbox" id="checkboxFourt" name="roads[]" class="x1" data-id="Medley"
                                value="Medley"><label for="checkboxFourt">  Dialogue & Discussion </label></li>

                            @endif
                            @if($item2 =="Medley1")

                            <li><input type="checkbox" id="checkbox2" name="roads[]" class="x1" data-id="Medley1"
                                value="Medley1"><label for="checkbox2"> Learning by Games </label></li>
                            ...
                            <li><input type="checkbox" id="checkbox4" name="roads[]" class="x1" data-id="Medley3"
                                value="Medley3"><label for="checkbox4">Problem Solving </label></li>

                            @endif
                            @if($item2 =="Medley4")
                            <li><input type="checkbox" id="checkbox5" name="roads[]" class="x1" data-id="Medley4"
                                value="Medley4"><label for="checkbox5">Note </label></li>
                            @endif
                            @if($item2 =="Others")
                            ...
                            @endforeach
                              ...
                              <li><input type="checkbox" id="checkbox6" name="roads[]" class="x1" data-id="Medley4"
                                value="Medley4"><label for="checkbox6">{{$item32->name}} </label></li>
