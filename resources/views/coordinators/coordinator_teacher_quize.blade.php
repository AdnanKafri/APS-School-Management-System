...
<tr>
    ...
    <td> @if ($now < $item->start_time && $now < $item->end_time)
    بالانتظار
...
@endif
 ...
 <td>
    @if ($item->quiz_link)
    <a href="{{ $item->quiz_link1 }}" type="button"  target="_blank" class="btn" style="background-color: white; color: rgb(117, 115, 115);"> مشاهدة </a></td>
  @else
  <a href="{{ asset('storage/'.$item->quize) }}" type="button"  target="_blank"  class="btn" style="background-color: white; color: rgb(117, 115, 115);"> مشاهدة </a></td>
    @endif
  <td>
<a   href="{{ route('teacher_quize_mark',[$room_id ,$teacher->id,$lesson_id,$item->id]) }}" type="button"    class="btn" style="background-color: white; color: rgb(117, 115, 115);"> عرض </a></td>
 </td>
            ...
            <table class="" style="">
                ...
                <tbody>
                    ...
                    @endif
                     ...
                     <td><a  href="{{ route('teacher_quize_mark',[$room_id ,$teacher->id,$lesson_id,$item->id]) }}" type="button" class="btn" style="background-color: white; color: rgb(117, 115, 115);"> مشاهدة </a></td></td>
