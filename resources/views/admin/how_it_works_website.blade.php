...
@section('page_title', 'كيف نعمل')
@section('page_subtitle', 'إدارة خطوات وآلية العمل المعروضة للزائر')
@section('breadcrumbs')
    <nav class="breadcrumbs">
        <a class="breadcrumbs__item is-active"> كيف نعمل </a>
...
@section('content')
    ...
    <div class="modal fade editNewsModal"style="text-align: end;">
        <div class="modal-dialog">
            <div class="modal-content">
                <form id="form_update" action="{{ route('how_it_works_website.update') }}" method="POST"
                    ...
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">تعديل خطوات العمل </h4>
                    </div>
    ...
    <div class="modal fade createNewsModal" style="text-align: end;">
        <div class="modal-dialog">
            <div class="modal-content">
                <form id="form_update" action="{{ route('how_it_works_website.store') }}" method="POST"
                    enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="modal-header">
                        ...
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                        <h4 class="modal-title">إنشاء خطوة عمل جديدة </h4>
                    </div>
                    <div class="modal-body" style="direction:ltr">
                        <div class="form-group">
                            <label>العنوان بالعربية</label>
    ...
    <script>
        ...
        $(document).on('click', '.delete_event', function(e) {
            ...
            $.ajax({
                ...
                type: 'post',
                url: "{{ route('how_it_works_website.delete') }}",
                enctype: 'multipart/form-data',
                data: {
                    '_token': "{{ csrf_token() }}",
                    'id': id,
