...
<nav class="breadcrumbs">
     <a  class="breadcrumbs__item ">قسم  برنامج الدوام  </a>
    <a href="{{  route('workschedule_room',$room->class_id)}}"  class="breadcrumbs__item ">قسم الشعب </a>
...
<div class="col-md-10 " style="margin: auto; direction: rtl; text-align:center">
    ...
    <div class="row"  >
        ...
        <!--<div class="mb-3">-->
        <!--      @can('Deletion of a class in the work schedule section')-->
        <!--    <a class="btn  btn-info btn-block d" href="{{ route('session_class',$room->class_id) }}"  >تعديل الحصة </a>-->
        <!--     @endcan-->
        <!--</div>-->
      ...
      <div>
        ...
        <table class="table-striped" id="simple_table"
                            ...
                            <td>
                                @foreach ($schedule as $lesson_time)
                                    ...
                                    @if($lesson_time->day_id == $day->id && $lecture_time->id == $lesson_time->lecture_time_id)
                                        ...
                                        <a class="btn @if($lecture_time->type == 1) btn-info @else btn-success @endif btn-sm add_time"
                                           data-toggle="modal"
