...
@section('breadcrumbs')
    <nav class="breadcrumbs">
        <a class="breadcrumbs__item is-active"> تحديد مهام المشرف المدرسي</a>
...
@section('content')
    <div class="container" style="margin: 50px">
        <div class="row">
            ...
            <div class="col-md-12">
                <h3 class="text-center">تحديد مهام المشرف المدرسي</h3>
            </div>
            <div class="col-md-12">
                <form action="{{ route('coordinator.store_task') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div style="">
                        <div class="form-group" style="text-align:right">
                            <label>الصف</label>
                            <select name="class_id[]" required id="classes" class="form-control classes dep" style="min-height: 36px;direction: rtl" required>
        ...
        <div class="modal-dialog modal-confirm" style="">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>هل حقاً تريد تحديد هذه المهام للمشرف المدرسي</p>
                </div>
