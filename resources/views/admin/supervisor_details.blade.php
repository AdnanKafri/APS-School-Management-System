...
<nav class="breadcrumbs">
    <a  class="breadcrumbs__item is-active">معلومات مشرف تربوي</a>
    <a href="{{ route('supervisors') }}" class="breadcrumbs__item ">قسم المشرفيين التربويين</a>
...
<div class="row">
    ...
    <div class="card">
        <div class="card-header">
          ...
          <div class="card-body">
            <form method="post" action="{{ route('supervisor_update',$supervisor->id) }}" enctype="multipart/form-data">
                @csrf
                @method('put')
