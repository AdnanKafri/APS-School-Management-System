...
@section('page_title', 'الرؤية والرسالة')
@section('page_subtitle', 'إدارة نصوص الرؤية والرسالة الخاصة بالموقع')
@section('breadcrumbs')
                    ...
                    <div class="modal-body" style="direction:ltr">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="title_ar" name="title_ar" class="form-control" value=""
                                maxlength="120" style="direction: rtl" placeholder="">
                        </div>
            ...
            <div class="modal-content">
                <form id="vision_create_form" action="{{ route('vision_mission_website.store') }}" method="POST"
                    ...
                    <div class="modal-header">
                        ...
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                        <h4 class="modal-title">إنشاء رؤية جديدة</h4>
                    </div>
                    <div class="modal-body" style="direction:ltr">
                        <div class="form-group">
                            <label>العنوان بالعربية</label>
                            <input type="text" name='title_ar' class="form-control" value="" maxlength="120"
                                placeholder="" required>
                        </div>

                        <div class="form-group">
                            <label>العنوان بالانكليزية</label>
                            <input type="text" name="title_en" class="form-control" value="" maxlength="120"
                                placeholder="" required>
                        </div>
    ...
    <script>
        ...
        $(document).on('click', '.delete_event', function(e) {
            ...
            $.ajax({
                ...
                type: 'post',
                url: "{{ route('vision_mission_website.delete') }}",
                enctype: 'multipart/form-data',
                data: {
                    '_token': "{{ csrf_token() }}",
                    'id': id,
