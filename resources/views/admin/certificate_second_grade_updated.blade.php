     ...
     <table id="1" class="w-100 "  style="border-color: white;text-align:center;margin:auto"   >
                ...
                <thead>
                    ...
                    @endphp
                        ...
                        <td   colspan="2" style="position: relative;width:36%;font-family:'Amiri', serif;">
                            ...
                            <h3 class="my-title" style="font-weight: 600;font-size:18px;position: absolute;top:50px;right:90px">  الحلقة الأولى الصف  /5-6/    </h3>
                        </td>
                            ...
                            <div class="row" style="">
                                ...
                                <div class="col-6 text-right" style="margin-right: 10px;width:37.5%">
                                  <div class="row mb-2">
                                   ...
                                   <div class="row">
                                      <div class="col-3 paragraph-os "> اللغة الأجنبية: <span>  الإنجليزية</span> </div>
         ...
         <tr style="border-color: white;"  >
            ...
            <td style="border-color: white;"  >
                <table class="fixed5" style="margin-top:-12px">
                  <thead>
                      <tr>
       ...
       @endforeach
            ...
            <form>
              <tr >
                ...
                <td class="max_mark_total2" style="border-top: 2px solid #000">{{  arabic_w2e(1200) }}</td>
                <td colspan="2" class="" style="border-top: 2px solid #000"> </td>
    ...
    * */
    ...
    $(document).ready(function() {
         ...
         $.each($('.special-subject'), function (key, value) {
            let text = $( this).text() ;
            // let text = $(this).text() ;
            if ( text.includes("زراع") || text.includes("مهني") || text.includes("طلائع") ){
