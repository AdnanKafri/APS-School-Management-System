                ...
                <thead>
                    ...
                    @endphp
                        ...
                        <td   colspan="3" style="position: relative;width:40%">
                            <h5 class="my-title" style="font-weight: 600;position: absolute;top:5px;right:38px"> مرحلة التعليم الأساسي  </h5>
                            <h6 class="my-title" style="font-weight: 600;font-size:12px;position: absolute;top:35px;right:38px">  الحلقة الثانية للصفين السابع والثامن   </h6>
                        </td>
                    ...
                    <tr>
                        ...
                        <td  colspan="11">
                            <div class="row" style="margin-bottom:-30px">
                                 <div class="col-3 text-right" Style="width:29%">
                                ...
                                <div class="col-1 header-space" style="width:1.33% !important">
                                </div>
         ...
         <tr style="border-color: white;"  >
            ...
            <td style="border-color: white;"  >
                <table style="table-layout: fixed;">
                  <thead>
                      <tr>
                        <th  rowspan="4" style="text-align: center;width:11.1%;min-width:115pxfont-weight:700;font-size:16px" >
                            <div style="min-width:100px">
                            المواد الدراسية
                            </div>
                        </th>
                        <th  rowspan="4"    style="text-align: center;width:2.95%;font-weight:500">
                             <span style="writing-mode: vertical-rl;white-space: pre;transform: rotate(-180deg);font-size:14px">الدرجة العظمى</span>
                             </th>
                        <th colspan="4" rowspan="1"  style="text-align: center;width:17.2%;min-width:17%;font-weight:400" >الفصل الدراسي الأول </th>
                        <th colspan="4" rowspan="1" style="text-align: center;border-left: 3px solid #000;width:17.2%;min-width:17%;font-weight:400">الفصل الدراسي الثاني </th>
                        <th  rowspan="6" class="space-separator" style="border-top:2px solid #fff !important;width:4%;background:#fff"></th>
                        <th colspan="1" rowspan="4" style="width:5.7%; border-right: 3px solid #000;">
                            <span style="writing-mode: vertical-rl;white-space: pre;transform: rotate(-180deg);font-size:14px">  مجموع درجات <br> الفصلين  </span>

                        </th>
                        <th colspan="2"  rowspan="2" style="width:16.75% ;text-align: center;font-weight:800;font-size:14px">
                        ...
                        <th rowspan="3" style="width: 6.6%;">
                            <div style="white-space: nowrap;writing-mode: vertical-rl;transform: rotate(-180deg);font-size:14px;margin: auto">
                                الدوام
                                المدرسي
                            </div>
                        </th>
                        <th rowspan="3" style="width: 3.62%;">
                            <div style="white-space: nowrap;writing-mode: vertical-rl;transform: rotate(-180deg);font-size:14px;margin: auto">
                                الدوام
                                الفعلي
                            </div>
                        ...
                        <th colspan="2" rowspan="1" style="width: 8.5%;">
                            الغياب
                        </th>
                        <th rowspan="3" style="text-align: center;width: 5.9%;">
                            <div style="white-space: nowrap;writing-mode: vertical-rl;transform: rotate(-180deg);font-size:14px;margin: auto">
                                النسبة المئوية
                                للدوام
                            </div>
                      ...
                      <tr>
                        ...
                        <th  colspan="2" rowspan="2"  style="text-align: center;font-weight:800;font-size:15px;min-width:11.8%;width:11.8%">
                            <div style="">
                                 مجموع الدرجات
                       ...
                       <th  colspan="2" rowspan="2"  style="text-align: center;font-weight:800;font-size:15px;border-left:3px solid #000;min-width:11.8%;width:11.8%">
                        <div style="">
                             مجموع الدرجات
                    ...
                    <th rowspan="2" ><div style="writing-mode: vertical-rl;transform: rotate(-180deg);font-size:14px;margin: auto">مبرر</div></th>
                    <th rowspan="2"><div style="white-space: pre;writing-mode: vertical-rl;transform: rotate(-180deg);font-size:14px;margin: auto">غير مبرر</div> </div> </th>

                      </tr>
                      <tr>
                        <th rowspan="2" style="text-align: center;width:0.73%;">  رقماً </th>
                        <th  rowspan="2"  style="text-align: center;width:8.32%; "> كتابة </th>
                      </tr>
                  ...
                  @endphp
                      ...
                      <tr>
                        ...
                        <th style="text-align: center;width:2.93%;"> رقماً </th>
                        <th style="text-align: center;width:8.32%;">  <div style="margin:0 !important">كتابة</div> </th>
                        <th style="text-align:center"> ٦٠%</th>
                        <th style="text-align: center;"> ٤٠%</th>
                        <th style="text-align: center;width:2.93%;"> رقماً </th>
                        <th  style="text-align: center; border-left: 3px solid #000;width:8.32%; ">  <div style="margin:0 !important">كتابة</div> </th>
                                ...
                                <tr>
                                 ...
                                 @endif
                                  ...
                                  <td class="x" data-id="{{$current_term == 2 ? ceil($theFinalResult)  : '' }}" data-min_mark="{{  $lesson->min_mark }}"> </td>
                                    ...
                                    @if($key77 + 1 == 3)
                                        <td colspan="6">
                                            <div style="width:324px">التوجيهات التربوية</div>
                                        </td>
                                    @endif
                                    @if($key77 + 1 == 4)
                                    ...
                                    @if($key77 + 1 == 10)
                                        <td colspan="6" rowspan="2" class="text-right">
                                         <div class="row">
                                            <div class="col-7 " style="margin-right:7%;font-size:12px;">
          ...
          <form>
            <tr >
              ...
              <td colspan="6" rowspan="2" class="text-right">
                 ...
                 <div class="row">
                    <div class="col-6 " style="margin-right:7%">
                        نجاح إلى الصف
                    </div>
                    <div class="col-4">
               ...
               @endphp
                   ...
                   <tr>
                    ...
                    {{-- @if($base_subject->lessons_mark2->certificate_order == 13)
                        <td colspan="6" rowspan="1" class="report_details text-right"> نجاح إلى الصف </td>
                    @endif --}}
                    @if($base_subject->lessons_mark2->certificate_order == 15)
                        <td colspan="6" rowspan="2" class="report_details text-right">
                            <div class="row">
                                <div class="col-6 " style="margin-right:7%">
                                    رسوب في الصف
                                </div>
