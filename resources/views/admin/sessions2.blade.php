...
<nav class="breadcrumbs">
    <a  class="breadcrumbs__item is-active"> قسم الحصص للصف</a>
    <a href="{{ route('sessions') }}"  class="breadcrumbs__item ">قسم الحصص</a>
...
{{-- <div class="col" > --}}
            ...
            <div class="col-12 col-lg-3" >
                @can('create_workschedule')
                        <a  class=" btn btn-success" data-toggle="modal" data-target="#store_session" style="color: white;margin: 5px;background: #6ABAA3;border-color: #6ABAA3;"
                         ...
                         @endcan
                         {{-- @if( count($classes) > 0 )
                        <a  class=" btn btn-danger" data-toggle="modal" data-target=".deleteall_session" style="color: white;margin: 5px;background: rgb(247, 88, 88);border-color: #6ABAA3;"
                         data-id=""><i class="material-icons" data-toggle="tooltip">حذف جميع الحصص</i></a>
                         @endif --}}
            </div>
        </div>
    ...
    <div class="table-responsive">
                ...
                <td class="budget" style="font-weight:bold;font-size:15px">
                  ...
                  <td class="budget"style="font-weight:bold;font-size:15px">
                    ...
                    @can('edit_workschedule')
                      ...
                      <a  class=" btn btn-danger delete_session " data-toggle="modal" data-target="#delete_session" style="color: #fff; background:rgb(247, 88, 88) !important;"
                      data-data="{{ $item }}"><i class="material-icons" data-toggle="tooltip">حذف  </i></a>
                     @endcan
                    </td>
                  </tr>
               @endforeach
         ...
         <div class="modal fade deleteall_session">
