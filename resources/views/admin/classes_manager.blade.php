...
<nav class="breadcrumbs">
    ...
    <a  class="breadcrumbs__item is-active"> قسم متابعة الحصص مباشرة </a>
                ...
                <td class="budget" style="font-weight:bold;font-size:15px">
                  ...
                  <td class="budget">
                    ...
                    <td class="">
                      ...
                      <a href="{{route('classroom_manager',$item->id)}}" class="btn btn-success" style="margin-left: 10px">الشعب </a>
                    </td>
