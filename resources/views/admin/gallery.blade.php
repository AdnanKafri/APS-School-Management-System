...
@section('page_subtitle', 'إدارة صور المعرض وأحجامها')
@section('breadcrumbs')
...
@section('content')
    ...
    @endif-->
        ...
        <div class="table-responsive">
            {{-- <a href=".createNewsModal" class=" btn btn-success" data-toggle="modal" data-id=""><i class="material-icons"
                    data-toggle="tooltip">اضافة صورة جديدة</i></a> --}}
                    ...
                    @foreach ($gallery as $item)
                        <tr id="news_{{ $item->id }}">
                            ...
                            <td style="vertical-align: initial;">
                                ...
                                <a class="edit_news btn btn-success btn-sm" data-image="{{ $item->image }}"
    ...
    <div class="modal fade createNewsModal" style="text-align: end;">
        <div class="modal-dialog">
            <div class="modal-content">
                <form id="form_update" action="{{ route('gallery.store') }}" method="POST"
