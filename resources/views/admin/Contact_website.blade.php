...
@section('page_title', 'معلومات التواصل')
@section('page_subtitle', 'إدارة رسائل واتصال الزوار')
@section('breadcrumbs')
    <nav class="breadcrumbs">
        <a class="breadcrumbs__item is-active"> رسائل العملاء </a>
...
@section('content')
    ...
    @endif-->
        ...
        <div class="card-header border-0">
            <h3 class="mb-0">جدول رسائل العملاء</h3>
        </div>
            ...
            <table class="table align-items-center table-bordered" id="table_xx" style="color: black; text-align:center">
                <thead class="thead-light">
                    ...
                    color: black;"> الاسم </th>
                        <th style="text-align: center;
            color: black;"> رقم الهاتف </th>
                        <th style="text-align: center;
                    color: black;"> الأيميل </th>
                        <th style="text-align: center;
            color: black;"> الموضوع </th>
                        <th style="text-align: center;
    ...
    <script>
        ...
        $(document).on('click', '.delete_event', function(e) {
            ...
            $.ajax({
                ...
                type: 'post',
                url: "{{ route('contact_website.delete') }}",
