                    ...
                    <tr class="upper-table">
                        ...
                        <td colspan="6">
                          <div class="row" style="width:50%">
                              ...
                              <div class="col-4">
                                <h7  class="text-center" style="margin-right: 0;font-weight:600"  >{{$school_data->name}}     </h7>
                              </div>
                              <div class="col-3">
                            ...
                            @endphp
                                ...
                                <tr>
                                    ...
                                    <td>
                                      ...
                                      @foreach(json_decode($student_marks->worke_degree) as $key1 => $item1 )
                                          @if($key1 == $lesson->id )
                                                {{    $item1->term2_result == 'null' ? '' : $item1->term2_result }}
                                                @php
                                                    $x = $item1->term2_result == 'null' ? 0 : $item1->term2_result ;
                                                    $term2_result +=   $x ;
                                                @endphp
                                  ...
                                  <td class="total_result" style=" border-right: 3px solid #000;">
                                    {{-- {{ $term1_result + $term2_result }} --}}
                                   </td>
                                  <td class="final_result">
                                     {{-- {{ ceil(($term1_result + $term2_result) /2) }} --}}
                                    </td>
                                  <td class="x"
                                  {{-- data-id="{{ ceil(($term1_result + $term2_result) /2) }}" --}}
                                  > </td>
           ...
           @if (++$i === $lesson_count)
               ...
               @endphp
                   ...
                   <tr>
                      ...
                      <td style=" border-right: 3px solid #000;" class="total_result2">
                        {{-- {{ $term1_result + $term2_result }} --}}
                      </td>
                      <td class="final_result2">
                          {{-- {{ ceil(($term1_result + $term2_result) /2) }} --}}
                        </td>
                     <td class="x"
                     {{-- data-id="{{ ceil(($term1_result + $term2_result) /2) }}" --}}
       ...
       @endforeach
            ...
            <form>
              <tr >
                ...
                <td   rowspan="2" class="final_result22"></td>
         ...
         <tr>
          ...
          <td colspan="2">{{$student_rigistration_term == 1 ? $actual_attendance1 : ''}}</td>
          <td colspan="2">{{ $student_rigistration_term == 1 ? $student_attendance1 : ''}}</td>
          <td colspan="1">{{ $student_rigistration_term == 1 ? $justified_absence1 : ''}}</td>
          <td colspan="1"> {{ $student_rigistration_term == 1 ? $unjustified_absence1 : ''}}</td>
         ...
         <tr>
          <td> الفصل الثاني </td>
          <td colspan="2">{{ isset($report_card_details->actual_attendance) ? arabic_w2e( json_decode($report_card_details->actual_attendance)->{'term2'}) : '٠'}}</td>
          <td colspan="2">{{ isset($report_card->student_attendance) ? arabic_w2e( json_decode($report_card->student_attendance)->{'term2'}) : '٠'}}</td>
          <td colspan="1">{{  isset($report_card) ?  arabic_w2e( json_decode($report_card->justified_absence)->{'term2'}) : '٠'}}</td>
          <td colspan="1"> {{  isset($report_card) ?  arabic_w2e( json_decode($report_card->unjustified_absence)->{'term2'}) : '٠'}}</td>
