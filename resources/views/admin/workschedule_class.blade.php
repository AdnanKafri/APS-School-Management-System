...
@section('page_subtitle', 'اختيار الصف لعرض برنامج الدوام الأسبوعي')
...
<nav class="breadcrumbs teacher-schedule-breadcrumbs" aria-label="Breadcrumb">
    ...
    <span class="breadcrumbs__item is-active">برنامج الدوام</span>
</nav>
@endsection
                    ...
                    <tbody>
                        @foreach ($classes as $item)
                            <tr>
                                ...
                                <td>{{ $year->name }}</td>
                                <td>
                                    <a href="{{ route('workschedule_room',$item->id) }}" class="btn btn-primary selector-action">الشعب</a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
