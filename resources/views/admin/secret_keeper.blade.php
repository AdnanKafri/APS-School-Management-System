...
<nav class="breadcrumbs">
    <a class="breadcrumbs__item ">قسم  امين السر</a>
...
<div class="card" style="margin: 30px">
    <div class="card-body" style="text-align: right;">
        ...
        <br>
        <a   target="_blank" href="{{ route('getstudents_request_edit') }}" class="btn  btn-success"
        >  طلبات التعديل  </a>  
          @can('student_phone')
...
//         contentType: 'application/json',
//         success: function (data) {
//             if ($('#room_id_filter option').length === 0) {  // Check if room dropdown has options
...
// });
    ...
    var table_test = $('#table_xx').DataTable({
        ...
        "ajax": {
            "type": "GET",
            "url": "{{ route('getstudents_secret_keeper') }}",
            data: function (d) {
            ...
            },
            {
                ...
                render: function (data, type, full) {
                    return `
                         ...
                         <a href="{{ url('SMT/admin/students/student_details1') }}/${full.id}"  style="color: #0083FF"><i class="fa fa-eye fa-2x" style="color: #008CC4;font-size: medium"></i></a>
