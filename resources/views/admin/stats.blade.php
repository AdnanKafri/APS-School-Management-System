...
<nav class="breadcrumbs">
     <a  class="breadcrumbs__item is-active">الاحصائيات </a>
    ...
    <div class="card" style="direction:rtl; text-align:right;margin: 20px;">
        ...
        <!--@endif-->
            ...
            <div class="card-header border-0">
              <h3 class="mb-0">جدول  الاحصائيات</h3>
            </div>

    <div class="table-responsive">

    <a href=".createClassModal" class=" btn btn-success" data-toggle="modal"
    data-id=""><i class="material-icons" data-toggle="tooltip">إنشاء احصائية جديدة</i></a>
            ...
            <th scope="col" class="sort" data-sort="budget"> الاسم بالانكليزي   </th>
                    ...
                    <th scope="col" class="sort" data-sort="budget">  الاحصائية  </th>
                      <th scope="col" class="sort" data-sort="budget">  حذف  </th>
            ...
            <div class="modal fade createClassModal">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <form id="" action="{{ route('stats_store') }}" method="POST" enctype="multipart/form-data">
                            @csrf

                            <div class="modal-header">
                                <h4 class="modal-title">اضافة احصائية</h4>
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group" style="text-align:right">
                                 ...
                                 <div class="form-group" style="text-align:right">
                                    <label>  الاحصائية  </label>
                                    <textarea type="text" name="ratio" class="form-control"
                                        value=""
                                        required></textarea>
                                </div>
...
<!--            </div>-->
            ...
            <div class="modal fade deleteEmployeeModal">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <form id="form_delete" action="{{route('delete_stats')}}" method="POST">
                                        @csrf
