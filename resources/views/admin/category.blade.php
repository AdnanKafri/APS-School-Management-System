...
<nav class="breadcrumbs">
    ...
    <a  class="breadcrumbs__item is-active">  تصنيفات الخبر  </a>
...
{{-- <div class="col" > --}}
    <div class="card" style="direction:rtl; text-align:right;margin: 20px;">
        ...
        <!--@endif-->
            ...
            <div class="card-header border-0">
              <h3 class="mb-0">جدول  التصنيفات للاخبار</h3>
            </div>

    <div class="table-responsive">

    <a href=".createClassModal" class=" btn btn-success" data-toggle="modal"
    data-id=""><i class="material-icons" data-toggle="tooltip">إنشاء تصنيف جديدة</i></a>
  ...
  <th scope="col" class="sort" data-sort="budget"> الحذف   </th>
            ...
            <div class="modal fade createClassModal">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <form id="" action="{{ route('category_store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
...
<!--            </div>-->
            ...
            <div class="modal fade deleteEmployeeModal">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <form id="form_delete" action="{{route('delete_category')}}" method="POST">
                                        @csrf
