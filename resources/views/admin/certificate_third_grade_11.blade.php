...
<div class="row w-100">
    ...
    <table class="upper-table w-100"  style="border-color: white">
            ...
            @endphp
                ...
                <td   colspan="2" style="border: 0">
                  <div class="row">
                    ...
                    <div class="col-9">
                      <h4  class="text-center" style="font-weight: 600">  الصف الثاني الثانوي العام - الفرع العلمي </h4>
                    </div>
                    <div class="col-3"></div>
                  </div>
                </td>
        ...
        <tbody>
            <tr class="upper-table">
                <td colspan="2" style="border: 0">
                    <h5  class="text-right" style="margin-right: 0"  >مديرية التربية  في محافظة دمشق   </h5>
                </td>
                <td colspan="2" style="border: 0">
                  <div class="row">
                    <div class="col-7">
                      <h5  class="text-center" style="margin-right: 0"  >    {{$school_data->name}}      </h5>
                    </div>
                    <div class="col-3"></div>
                </td>
                                ...
                                <form>
                                    <tr>
                                       ...
                                       @endif
                                        ...
                                        <td class="{{$student_rigistration_term == 1 ? 'x' : ''}} left-border" data-id="{{ $term1_result }}" data-min_mark="{{  $lesson->min_mark }}"> </td>
                                       ...
                                       @endif
                                        ...
                                        @if($base_subject->lessons_mark2->certificate_order == 14)
                                            <td colspan="1" rowspan="8" class="text-center  all-border" style="position: relative">
                                               <div style="width:100%">
                                                <br>
                                                <br>
                                                <br>
