...
<div class="row g-0 w-100"  style="margin-top: 25px">
                ...
                @endphp
                    @foreach ($lessons as $key => $lesson)
                     @if($lesson->certificate_order !=0)
                                    ...
                                    <tr>
                                       ...
                                       @endif
                                        ...
                                        @if($base_subject->lessons_mark2->certificate_order == 8)
                                            <td colspan="1" rowspan="{{$report_card_design == 7 ? '5' : '4'}}" class="text-center">
                                                @if($current_term == 2 && isset($report_card) && isset($report_card->teacher_notes)  )
                                                    {{json_decode($report_card->teacher_notes)->{'term2'} }}
                                                @endif
                                            </td>
                                        @endif
                                        @if((($base_subject->lessons_mark2->certificate_order == 13) && ($report_card_design == 7)) || (($base_subject->lessons_mark2->certificate_order == 12) && ($report_card_design == 8)) )
                                            <td colspan="1" rowspan="1" class="text-center " style="position: relative">
                                                 <h6 class="paragraph-os2">النتيجة النهائية</h6>
                                            </td>

                                        @endif
                                        @if((($base_subject->lessons_mark2->certificate_order == 14) && ($report_card_design == 7)) || (($base_subject->lessons_mark2->certificate_order == 13) && ($report_card_design == 8)) )
                                            <td colspan="1" rowspan="2" class="text-center " style="position: relative">
                                                 <div style="width:100%">


                                                    <h6 class="paragraph-os2 text-right">نجاح إلى:
                                                       <span class="mr-1">
                        ...
                        <tr class="top-border">
                            <td>المجموع العام </td>
                            <td class="max_mark_total1 max_mark2">{{ arabic_w2e($report_card_design == 5 ? 4000 : 3800) }}</td>
                                        ...
                                        <form>
                                            <tr>
                                               ...
                                               @endif
                                                ...
                                                @if((($base_subject->lessons_mark2->certificate_order == 15) && ($report_card_design == 7)) || (($base_subject->lessons_mark2->certificate_order == 14) && ($report_card_design == 8)) )
                                                <td rowspan="2">
                                                    <h6 class="paragraph-os2 text-right">رسوب في:
                                                          <span class="mr-1">
    ...
    <tr class="" style="height:70px">
        ...
        <td class="max_mark_total2">{{ arabic_w2e($report_card_design == 5 ? 4200 : 4000) }}</td>
