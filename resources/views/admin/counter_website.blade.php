...
@section('page_title', 'عداد الموقع')
@section('page_subtitle', 'إدارة أرقام وإحصاءات الصفحة الرئيسية')
@section('breadcrumbs')
    <nav class="breadcrumbs">
        <a class="breadcrumbs__item is-active"> عداد الموقع </a>
...
@section('content')
                        ...
                        <tr id="news_{{ $item->id }}">
                            ...
                            <td style="vertical-align: initial;">
                                ...
                                <a class="edit_news btn btn-success btn-sm" data-title_ar="{{ $item->title_ar }}"
                                    data-title_en="{{ $item->title_en }}" data-count="{{ $item->count }}"
    ...
    <div class="modal fade editNewsModal"style="text-align: end;">
        <div class="modal-dialog">
            <div class="modal-content">
                <form id="form_update" action="{{ route('counter_website.update') }}" method="POST"
                    ...
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">تعديل العداد العمل </h4>
                    </div>
                    <div class="modal-body" style="direction:ltr">
                        ...
                        <div class="form-group">
                            <label>العداد </label>
                            <input type="number" id="count" name="count" class="form-control" value=""
                                maxlength="100" style="direction: rtl" placeholder="">
                        </div>
    ...
    <div class="modal fade createNewsModal" style="text-align: end;">
        <div class="modal-dialog">
            <div class="modal-content">
                <form id="form_update" action="{{ route('counter_website.store') }}" method="POST"
                    enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="modal-header">
                        ...
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                        <h4 class="modal-title">إنشاء عداد جديد</h4>
                    </div>
                    <div class="modal-body" style="direction:ltr">
                        <div class="form-group">
                            <label>العنوان بالعربية</label>
                        ...
                        <div class="form-group">
                            <label>العداد </label>
                            <input type="number" name="count" class="form-control" value="" maxlength="100"
                                style="direction: rtl" placeholder="" required>
                        </div>
    ...
    <script>
        ...
        $(document).on('click', '.delete_event', function(e) {
            ...
            $.ajax({
                ...
                type: 'post',
                url: "{{ route('counter_website.delete') }}",
                enctype: 'multipart/form-data',
                data: {
                    '_token': "{{ csrf_token() }}",
                    'id': id,
