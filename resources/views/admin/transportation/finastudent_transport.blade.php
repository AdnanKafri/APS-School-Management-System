...
@section('breadcrumbs')
    <nav class="breadcrumbs">
        <a class="breadcrumbs__item is-active">قسم  الاقساط المالية مواصلات</a>
...
<div class="card-header border-0 d-flex align-items-center justify-content-between">
    <h3 class="mb-0">الطلاب المشتركين </h3>
    <input type="text" class="form-control w-50" id="search_input" placeholder="ابحث عن طالب">
</div>
            ...
            <table class="table align-items-center table-flush">
                <thead class="thead-light">
                    <tr>
                        ...
                        <th scope="col" class="sort" data-sort="budget"> التكلفة الكاملة </th>
                        <th scope="col" class="sort" data-sort="budget"> المدفوعات  </th>
      ...
      <tbody class="list" id="student-table-body">
