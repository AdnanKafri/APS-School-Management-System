...
<nav class="breadcrumbs">
    <a  class="breadcrumbs__item is-active">قسم المناهج</a>
...
@section('content')
    ...
    <div class="card" style="direction:rtl;text-align:right;margin: 20px">
            ...
            <div class="card-header border-0">
              <h1 class="mb-0" style="text-align: center">جدول الصفوف</h1>
            </div>
              ...
              <table class="table align-items-center table-flush">
                ...
                @foreach ($classes as $item)
                    ...
                    <tr  id="lesson_{{$item->id}}">
                            ...
                            <td>
                                <a href="{{ route('lessons',$item->id) }}" class="btn btn-success" >
                                    المواد
                                </a>
                            </td>
