...
<nav class="breadcrumbs">
    <a class="breadcrumbs__item is-active "> معلومات الطالب  </a>
    <a href="{{ route('archives_students') }}" class="breadcrumbs__item ">  ارشفة الطلاب   </a>
        ...
        <div class="card" style="margin: 30px">
            <div class="card-header">
                <div class="row align-items-center">
                    <div class="col-7">
                        <h2 class="mb-0" style="color: #001586"> معلومات طالب </h2>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <input type="email" readonly id="input-email" name="email" required
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label class="form-control-label" for="input-first-name">الإسم الأول
                                        بالعربية</label>
                                    <input type="text"  readonly id="input-first-name" name="first_name" required
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input  readonly type="text" id="input-last-name" name="last_name" required
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label class="form-control-label" for="input-first-name">الإسم الأول
                                        بالانكليزية</label>
                                    <input  readonly type="text" id="input-first-name_en" name="first_name_en" required
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input readonly type="text" id="input-last-name_en" name="last_name_en" required
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input readonly type="text" id="input-first-name" name="father_name" required
                             ...
                             <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input readonly type="text" id="input-grandfather-name" name="grandfather_name" required
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input  readonly type="text" id="input-father-phone" name="father_phone" required
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input  readonly type="text" id="input-last-name" name="mother_name" class="form-control"
                                ...
                                <div class="form-group">
                                    ...
                                    <input readonly type="text" id="input-last-name" name="last_mother_name" class="form-control"
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input  readonly type="text" id="input-mother-phone" name="mother_phone" class="form-control"
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input readonly  type="date" id="input-last-name" name="date_birth" class="form-control"
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <select disabled name="religion" id="" class="form-control dep"
                        ...
                        @endforeach
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="form-group" id="class_room">
                                    ...
                                    <select disabled name="room_id" id="" class="form-control"
                                        style="min-height: 36px;direction: rtl" required>
                            ...
                            <div class="form-group">
                              ...
                              <input type="text" readonly id="input-public_record_number" name="public_record_number" class="form-control public_record_number" value="{{$student->public_record_number }}">
                            </div>
                          </div>
                          <div class="col-lg-12">
                            <div class="form-group">
                          <label>دولة الدفع  </label>
                          <select  disabled name="country_currency" id="classes" class="form-control dep"
                            style="min-height: 36px;direction: rtl" required>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input disabled  id="input-address" class="form-control" name="address"
                      ...
                      @if($student->address  == " AF") Afghanistan @elseif($student->address == "AX")
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input readonly id="input-address" class="form-control" name="city" placeholder="عنوان السكن"
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input  readonly type="text" id="input-city" name="nationality" class="form-control"
                                        placeholder="الجنسية"
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <select disabled name="gender" id="" class="form-control dep"
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input readonly type="text" id="input-country" name="place_birth" class="form-control"
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input readonly type="number" id="input-postal-code" name="box_birth" class="form-control"
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input readonly type="text" id="input-postal-code" name="army_room" class="form-control"
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input  readonly type="text" id="input-postal-code" name="passport_number"
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input readonly type="text" id="input-postal-code" name="the_ID_number" class="form-control"
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input readonly type="text" id="input-phone" name="phone" class="form-control"
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input readonly type="text" id="input-phone" name="other_phone" class="form-control"
