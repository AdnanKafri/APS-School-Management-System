...
<nav class="breadcrumbs">
    <a  class="breadcrumbs__item is-active">  القسم </a>
...
<div class="modal fade editNewsModal">
    <div class="modal-dialog">
        <div class="modal-content">
            <form method="POST" action="{{route('student_details_department_update')}}"  enctype="multipart/form-data">
                @csrf
...
<div class="modal fade" id="create_teacher" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" style="display: none; padding-right: 17px;">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form action="{{route('student_details_department_store')}}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="modal-header">
...
<div class="card" style="margin: 30px">
    <div class="card-body">
        <div class="card-title">
         ...
         @can('student_details_department_store')
        ...
        <div class="">
            <table class="table align-items-center " id="table_xx">
                ...
                <tbody class="list" id="mydiv">
                 @foreach ($student_details_department as $item)
                 <tr>
                 <td>{{$item->name}}</td>
                 <td>
                      @can('student_details_department_update')
                    ...
                    href=".editNewsModal" data-toggle="modal">تعديل</i>
                     ...
                     @endcan
                     @can('student_details_department_delete')
                    ...
                    {{-- <a href="#" class="btn btn-danger delete"
                     ...
                     @can('student_details_department_fields')
                    <a href="{{ route('student_details_department_fields', ['id' => $item->id]) }}" class="btn btn-danger delete">
                          تفاصيل القسم 
                    </a>
                     @endcan
...
<div class="modal fade deletelessonModal">
    <div class="modal-dialog">
        <div class="modal-content">
            <form id="form_delete" action="{{route('student_details_department_delete')}}" method="POST"  autocomplete="off">
