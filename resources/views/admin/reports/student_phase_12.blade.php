...
<div class="card" style="margin: 30px">
    <div class="card-body" style="text-align: right;">
        ...
        <a class="btn btn-primary"  href="{{ asset('storage/'.$student->details->phase_class12) }}"
        ...
        <br>
          ...
          <div class="row" style="justify-content: center;">
            @if ($student->details->phase_class12!=null)
            <iframe src = "{{ asset('storage/'.$student->details->phase_class12) }}"
