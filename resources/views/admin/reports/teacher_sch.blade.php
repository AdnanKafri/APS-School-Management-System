...
@section('page_title', 'حضور المعلمين')
@section('page_subtitle', 'عرض وتحليل حضور المعلمين حسب الفترة الزمنية')
...
<style>
    ...
    .report-filter__item--btn { grid-column:span 3; }
    ...
    @media (max-width: 991px) {
        .report-filter__item, .report-filter__item--btn { grid-column:span 6; }
    }
    @media (max-width: 575px) {
        .report-filter__item, .report-filter__item--btn { grid-column:span 12; }
    }
</style>
@endsection
...
<nav class="report-breadcrumbs" aria-label="Breadcrumb">
    ...
    <span class="report-breadcrumbs__sep">/</span>
    <span class="report-breadcrumbs__current">حضور المعلمين</span>
</nav>
@endsection
