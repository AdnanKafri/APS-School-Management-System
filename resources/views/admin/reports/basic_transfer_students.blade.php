    ...
    var table_test = $('#table_xx').DataTable({
...

        {
            ...
            },
            {
                ...
                <a href="{{ url('SMT/admin/students/transfer') }}/${full.id}" target="_blank">
                <i class=" fa fa-archive" style="color: #0083FF;font-size: medium"></i>
                </a>

                <a href="{{ url('SMT/admin/students/add_info') }}/${full.id}" target="_blank">
                <i class=" fa fa fa-eye" style="color: #0083FF;font-size: medium"></i>
                </a>
...
$.ajax({
    ...
    $(document).on('click', '.edit_teacher', function (e) {
        ...
        $('#id').val(data.id);
        $('#number_file').val(data.number_file);
        $('#status_cooperation').val(data.status_cooperation);
        $('#status_activity').val(data.status_activity);
        $('#status_books').val(data.status_books);
        $('#transfer_country').val(data.transfer_country);
        $('#transfer_school').val(data.transfer_school);
        $('#head_teacher').val(data.head_teacher);
        $('#date_seend').val(data.date_seend);

        $('#book1').val(data.book1);
        $('#book_state1').val(data.book_state1);
        $('#book2').val(data.book2);
        $('#book_state2').val(data.book_state2);
        $('#book3').val(data.book3);
        $('#book_state3').val(data.book_state3);

        $('#book4').val(data.book4);
        $('#book_state4').val(data.book_state4);

        $('#book5').val(data.book5);
        $('#book_state5').val(data.book_state5);

        $('#book6').val(data.book6);
        $('#book_state6').val(data.book_state6);
