                ...
                <thead>
                    ...
                    @endphp
                        ...
                        <td   colspan="2" style="position: relative;width:36%;font-family:'Amiri', serif;">
                            ...
                            <h3 class="my-title" style="font-weight: 600;font-size:18px;position: absolute;top:50px;right:35px">  الحلقة الثانية للصفين السابع والثامن   </h3>
                        </td>
                            ...
                            <div class="row" style="margin-bottom:-30px">
                                ...
                                <div class="col-5 text-right" style="margin-right: 10px;width:37.5%">
                                  <div class="row mb-3">
                                   ...
                                   <div class="row">
                                      <span class="col-7 paragraph-os ml-4"> اللغة الأجنبية: <span>  الإنجليزية</span> </span>
                                      <span class="col-4 paragraph-os"> الرقم في السجل العام: <span> {{  arabic_w2e($student->public_record_number) }} </span></span>
                                  </div>
         ...
         <tr style="border-color: white;"  >
          ...
          <form>
            <tr style="height:50px">
              ...
              <td class="max_mark_total1 max_mark2" style="border-top: 2px solid #000">{{ arabic_w2e(4100) }}</td>
       ...
       @endforeach
            ...
            <form>
              <tr style="height:50px">
                ...
                <td class="max_mark_total2" style="border-top: 2px solid #000">{{ arabic_w2e(4300) }}</td>
                <td colspan="2" style="border-top: 2px solid #000"> </td>
