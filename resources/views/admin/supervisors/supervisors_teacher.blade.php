...
$('#group_message').attr('href',"{{ URL::to('SUNRISEMANger/dashboard/supervisor/write_group_message') }}/"+lesson_id);
...
console.log(data);
                ...
                $.each(data, function (key, value) {
                    ...
                    type+=`
                    <a href="{{URL::to('SUNRISEMANger/dashboard/supervisor/write_message/${value.id}')}}"  class="btn bg-teal waves-effect" data-toggle="modal" data-id="${value.id}"
