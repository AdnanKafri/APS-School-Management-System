...
<div class="tabs">
  <label class="tab" id="one-tab" for="one">  المكافآت </label>
        ...
        <table class="table table-hover " id="table">
          ...
          <tbody>
            ...
            <tr>
                ...
                <td data-label="  اسم المكافأة"> {{ $rewad->rewad_and_sanction->name }}  </td>
  ...
  <script>
    ...
    $(".class_select").on("change", function(e) {
        ...
        $(".room_select,.class_select").on("change", function(e) {
            ...
            var formattedDate = value1.toLocaleString(); // Format the date as per your requirements
            $('#table tbody').append(` 
                <tr>
                    ...
                    <td data-label="  اسم المكافأة">${ value.rewad_and_sanction.name } </td>
