  ...
  <div class="modal-dialog animated zoomInLeft modal-dialog-centered" role="document">
      <div class="modal-content" style="padding-top: 50px !important;">
          <div class="container-fluid">
              ...
              <h4  style="color: #05579e;text-align: center; ">اضافة  ملف</h4>
  
                <form action="{{ route('add_super_file') }}" method="post" id="confirm4"  enctype="multipart/form-data"  style="text-align: right;direction: rtl;">
                    @csrf
              <div class="container" style="padding-top: 20px;">
                 <div class="row">
                  <div class="col-md-12" style="display: grid;">
                    <label for="default" class=""> نوع المف</label>
                    <!-- This is a normal file input -->
                    <select required  name="type" id="name"  class="border p-2"  style="width:300px" >
                      <option value="1"> ملف عادي </option>
                      <option value="2" >  خطة فصلية  </option>
                    </select>
                    
                </div><!--end col-->
                <div class="col-md-12" style="display: grid;">
                  <label for="default" class="">  اسم الملف  </label>
                  <!-- This is a normal file input -->
                  <input name="name" 
                  class="border p-2" required type="text" style="width:300px">
              </div>
                <div class="col-md-12" style="display: grid;">
                  <label for="default" class="">  ادخل الملف </label>
                  <!-- This is a normal file input -->
                  <input name="file" 
                  class="border p-2" required type="file" style="width:300px">
              </div><!--end col-->
...
<div class="main-panel" style="background: #f8f9fb;">
    ...
    padding-top: 11px;">
      ...
      <li class="li"><a href="{{ route('admin.edu_supervisor.subjects',['room_id' => $room->id])}}">{{ $room->name }}</a></li>
                  ...
                  <div class="article-wrapper">
                    ...
                    <div class="article-body">
                       ...
                       <div class="row" style="justify-content: space-around;">
                        <button class="button">
                          <a href="{{ route('admin.edu_supervisor.lecture_content',[$lesson->id,$room->id,$item->id]) }}" style="color: #fff;" > مشاهدة المحتوى</a>
                        </button>
                        <button class="button add_file"  data-id="{{$item->id}}" >
                          <a href=""  data-toggle="modal" data-target="#demoModal4"   style="color: #fff;"> اضافة ملف </a>
                        </button>
                       </div>
                    </div>
                  </div>
