...
<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    <div class="container">
        <br>
        <br>
        <a href="{{ route('dashboard.supervisor.profile',[$teacher->id]) }}"
        class="navbar-brand"><span>{{$teacher->first_name }} 
                {{$teacher->last_name }}
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
            <ul class="navbar-nav ml-auto">
                {{-- <li class="nav-item"><a href="{{ route('dashboard.teacher_schedule') }}" class="nav-link">برنامج الدوام للاستاذ</a></li> --}}

                <!--li class="nav-item active"><a href="index.html" class="nav-link">Home</a></li-->
                <li class="nav-item"><a href="{{ route('dashboard.supervisor') }}#class" class="nav-link">الصفوف</a></li>
                <li class="nav-item"><a href="{{ route('supervisor.chat') }}" class="nav-link">التواصل</a></li>
                {{-- <li class="nav-item"><a href="{{ route('dashboard.teacher') }}#event" class="nav-link">الأحداث </a></li>
                <li class="nav-item"><a href="{{ route('dashboard.teacher') }}#message" class="nav-link"> ارسال رسائل --}}
                    </a></li>&nbsp;&nbsp;&nbsp;
            ...
            border: none;">
                    ...
                    <li class="nav-item"><a href="#" class="nav-link">
                        <img  style="height: 90px; width:120px; position: absolute;
                        top: 3px;right: 5px;"  src="{{  asset('teachers/photo/shaar3.png') }}"  > </a></li>
