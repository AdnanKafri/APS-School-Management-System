...
var lect=$(this).val();
var home =$('.homeid').val();
var url = "{{ URL::to('SUNRISEMANger/dashboard/teacher/examstudent') }}/" + lect+"/"+home ;
$.ajax({
url: url,
type: "get",
...
<td> <a href="{{url('SUNRISEMANger/dashboard/exam/correct_exam') }}/${home}/${value.id}" class="btn"  style="background-color: white; color: rgb(117, 115, 115);" >تصحيح الامتحان  </a>
   </td>
<td>
</td>
