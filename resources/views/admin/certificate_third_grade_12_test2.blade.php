                    ...
                    <tr class="upper-table">
                        ...
                        <td colspan="6">
                          <div class="row" style="width:50%">
                              <div class="col-5">
                                <h7  class="text-right" style="margin-right: 0;font-weight:600"  >مديرية التربية  في محافظة دمشق  </h7>
                              </div>
                              <div class="col-4">
                                <h7  class="text-center" style="margin-right: 0;font-weight:600"  >مدرسة الادهم     </h7>
                              </div>
                              <div class="col-3">
         ...
         <tr style="border-color: white;"  >
                            ...
                            @endphp
                                ...
                                <tr>
                                    ...
                                    @else
                                      ...
                                      @endforeach
                                      @endif
                                    <td class="{{$current_term == 2 ? 'work_degree2' : '' }}" data-min_mark="{{ $lesson->min_mark}}" data-work_degree={{ $current_term == 2 ? $term2_work_degree : ''}}>
                                        @if($current_term == 2)
                                    ...
                                    @endphp
                                  <td class="total_result1" data-total_result="{{ $current_term == 2 ? $term1_result + $term2_work_degree : '' }}" style=" border-right: 3px solid #000;">
          ...
          <form>
            <tr >
              ...
              <td class="{{ $current_term == 2 ? 'work_degree2_total work_degree22' : ''}}" style="border-top:2px solid #000"> </td>
              <td class="{{ $current_term == 2 ? 'x' : ''}}"  style=" border-left: 3px solid #000;border-top: 2px solid #000"> </td>
              <td class="space-separator"  style="
              border-left: 2px solid #000;
              border-right: 2px solid #000;
              width:5%;background:#fff"></td>
              <td  class=" {{ $current_term == 2 ? ' total_result1_total ' : '' }}" style=" border-right: 3px solid #000;" ></td>
               ...
               @endphp
                  ...
                  <tr>
                                    ...
                                    @else
                                      ...
                                      @endforeach
                                      @endif
                                    <td class="{{$current_term == 2 ? 'work_degree22' : ''}} " data-min_mark="{{ $lesson->min_mark}}" data-work_degree={{ $current_term == 2 ? $term2_work_degree : ''}}>
                                        @if($current_term == 2)
                                           {{  arabic_w2e( $term2_work_degree) }}
                                        @endif
                                    </td>
                                  ...
                                  <td class="total_result11" style=" border-right: 3px solid #000;">
                                     {{  $current_term == 2 ?  arabic_w2e($term1_result + $term2_work_degree + $term2_result) : ''}}
                                   </td>
                                  <td class="final_result11" data-final_result ="{{ ceil(($term1_result + $term2_work_degree + $term2_result) /2) }}"
                                    @if(  ceil(($term1_result + $term2_work_degree + $term2_result) /2)  < $lesson->min_mark)
                                    style="color:red !important;"
                                    @endif
                                  >
                                      {{ $current_term == 2 ?   arabic_w2e( ceil(($term1_result + $term2_work_degree + $term2_result) /2) ) : '' }}
                                    </td>
                                  <td class="x" data-min_mark = "{{$lesson->min_mark }}"
                                   data-id="{{ $current_term == 2 ?  ceil(($term1_result + $term2_work_degree + $term2_result) /2) : '' }}"
                                  > </td>
       ...
       @endforeach
            ...
            <form>
              <tr >
                ...
                <td class="{{$current_term == 2 ? 'work_degree22_total999' : '' }}" style="border-bottom:2px solid #000"></td>
         ...
         `);
            ...
            String.prototype.EntoAr= function() {
              ...
              $.each($('.work_degree2'), function (key, value) {
                ...
                $('.work_degree2_total').attr('data-work_degree', work_degree);
                $('.work_degree2_total').next('td.x').data('id',`${work_degree}`);
                $('.work_degree2_total').html( (work_degree).toLocaleString('ar-EG'));
              ...
              $.each($('.work_degree22'), function (key, value) {
                ...
                $('.work_degree22_total').next('td.x').data('id',`${work_degree}`);
                $('.work_degree22_total').html( (work_degree).toLocaleString('ar-EG'));

              result = 0;
              $.each($('.total_result1'), function (key, value) {
              ...
              result = 0;
            //   $.each($('.total_result11'), function (key, value) {
            //       result1 = $( this).data('total_result') ;
            //       result1 = result1.length == 0 ? 0 : result1;
            //       result1 = parseInt(result1) ;
            //       result +=     result1 ;
            //     })
            //     $('.total_result11_total').attr('data-work_degree', result);
