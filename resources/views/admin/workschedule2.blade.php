...
<div class="modal fade" id="add_schedule">
    <div class="modal-dialog modal-lg">
        <div class="modal-content" style="direction: rtl; text-align:right">
            ...
            <form  action="{{ route('dashboard.room.save.schedule') }}" method="post" class="w-100">
                @csrf
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <select class="form-control wide lesson_id" style="width: 100%;" name="lesson_id" id="lesson_id">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <select class="form-control  teacher_id" style="width: 100%;" name="teacher_id" id="teacher_id">
