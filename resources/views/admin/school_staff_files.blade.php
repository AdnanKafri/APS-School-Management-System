...
<nav class="breadcrumbs">
    <a href="#" class="breadcrumbs__item is-active">ملفات الحضور</a>
    <a href="{{route('school_staf')}}"  class="breadcrumbs__item ">موظفو المدرسة</a>
...
<div class="modal fade" id="create_teacher" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" style="display: none; padding-right: 17px;">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form action="{{ route('staff_file_store', $school_staf->id) }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
                    <h2 class="modal-title" id="exampleModalLabel">اضافة ملف الحضور</h2>
                </div>
                <div class="modal-body">
                    <input type="hidden" name="staf_id" value="{{ $school_staf->id }}">
                    <div class="form-group">
                        <label>عنوان الملف</label>
...
<div class="card" style="margin: 30px">
    <div class="card-body">
        <div class="card-title">
            <h1 style="text-align: center;color: #001586">ملفات حضور {{$school_staf->name}}</h1>
        </div>
...
<div class="modal fade deletelessonModal">
    <div class="modal-dialog">
        <div class="modal-content">
            <form id="form_delete"  action="{{route('delete_school_staff_file')}}" method="POST"  autocomplete="off">
