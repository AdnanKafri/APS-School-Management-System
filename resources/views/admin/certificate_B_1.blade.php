                ...
                <thead>
                    ...
                    @endphp
                        ...
                        <td   colspan="2" style="position: relative;width:36%;font-family:'Amiri', serif;">
                            ...
                            @if($class->report_card ==11)
                             <h3 class="my-title" style="font-weight: 600;font-size:18px;position: absolute;top:50px;right:40px">  الحلقة الأولى الصف فئة ب - المستوى الأول    </h3>

                            @else
                             <h3 class="my-title" style="font-weight: 600;font-size:18px;position: absolute;top:50px;right:40px">  الحلقة الأولى الصف/ فئة ب - المستوى الثاني    </h3>
                            ...
                            <div class="row" style="margin-bottom:-30px">
                                ...
                                <div class="col-6 text-right" style="margin-right: 10px;width:37.5%">
                                  <div class="row mb-3">
                                   ...
                                   <div class="row">
                                      <div class="col-4 paragraph-os ml-4"> اللغة الأجنبية: <span>  ك</span> </div>
         ...
         <tr style="border-color: white;"  >
            ...
            <td style="border-color: white;"  >
                                ...
                                @if ($lesson->is_addable == 1 )
                                    ...
                                    <tr @if($lesson->max_mark ==0 )
                                       style="    background: #d1d1d1;"
                                           @endif>
                                        <td style="text-align: center;font-weight:600;background: white;">{{ $lesson_name  }} </td>
                                        ...
                                        <td style="border-bottom:{{$base_subject->lessons_mark2->certificate_order == 14 ? "2px" : "1px"}} solid #fff;border-top:2px solid #fff;background: white;"></td>
                                    @if($base_subject->lessons_mark2->certificate_order == 1)
                                        <td rowspan="4" style="font-size:12px;font-weight:700;width:6%;background: white;">
                                          <span style="writing-mode: vertical-rl;white-space: pre;background: white;">الدوام المدرسي </span>
                                        </td>
                                        <td rowspan="4" style="font-size:12px;font-weight:700;width:5.55%;background: white;">
                                          <span style="writing-mode: vertical-rl;white-space: pre;background: white;">الدوام الفعلي </span>
                                        </td>
                                        <td rowspan="4" style="font-size:12px;font-weight:700;width:4.25%;background: white;">
                                          <span style="writing-mode: vertical-rl;white-space: pre;background: white;">دوام التلميذ  </span>
                                        </td>
                                        <td colspan="2" style="font-size:12px;font-weight:700;background: white;">الغياب    </td>
                                        <td  rowspan="7" style="font-size:12px;font-weight:700;background: white;">
                                            <p style="height: 70px;">
                                    ...
                                    @if($base_subject->lessons_mark2->certificate_order == 9)
                                        <td colspan="6" rowspan="1" style="font-size:12px;font-weight:700;background:black;color:#fff !important;">
                                           نتيجة التلميذ
                                        </td>
                                    @endif
                                    @if($base_subject->lessons_mark2->certificate_order == 10)
                                        <td colspan="6" rowspan="1" class="text-right" style="background: white;">
                                             <div class="row">
                                    ...
                                    @endif
                                     @if($base_subject->lessons_mark2->certificate_order == 11)
                                        <td colspan="6" rowspan="1" class="report_details text-right" style="background: white;">
                                            <div class="row">
                                                <div class="col-6 " style="margin-right:0%; font-weight:700">
                                                    رسوب في الصف:
                                                </div>
                                    ...
                                    @endif
                                     @if($base_subject->lessons_mark2->certificate_order == 12)
                                        <td colspan="6" rowspan="1" class="report_details text-right" style="font-size:12px;font-weight:700;background: white;">
                                            <div class="row">
                                                <div class="col-6">
                                                    نقل إلى الصف:
                                                </div>
                                    ...
                                    @endif
                                     ...
                                     <td colspan="6" rowspan="3" style="background: white;">
                ...
                @endforeach
                    ...
                    <tr>
                        <td style="text-align: center;font-size:14px;font-weight:600" >ملاحظات مدير  المدرسة </td>
