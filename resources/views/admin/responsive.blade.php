...
<a style="color: rgb(236, 127, 232); text-decoration: none;" target="_blank">Smart Syrian School</a></span></td></tr></tbody>    
...
</td></tr><tr><td height="20"></td></tr></tbody>    
</table></td><td width="20"></td></tr></tbody>    
</table></div>
...
<a href="{{$footer->facbook}}" target=_blank  style="display: inline-block;background-color: rgb(53, 91, 161);border-radius: 4px;border-style: none; border-width: 0px; border-color: rgba(0, 0, 0, 0);" target="_blank"><img    
...
<a href="{{$footer->instagram}}" target=_blank  style="display: inline-block;background-color: rgb(82, 127, 166);border-radius: 4px;border-style: none; border-width: 0px; border-color: rgb(0, 0, 238);" target="_blank"><img    
