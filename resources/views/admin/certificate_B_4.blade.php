                ...
                <thead>
                    ...
                    @endphp
                        ...
                        <td   colspan="2" style="position: relative;width:36%;font-family:'Amiri', serif;">
                            ...
                            <h3 class="my-title" style="font-weight: 600;font-size:18px;position: absolute;top:50px;right:35px">  الحلقة الثانية   الصف فئة ب - المستوى الرابع   </h3>
                        </td>
                    ...
                    <tr>
                        ...
                        <td  colspan="11">
                            <div class="row" style="margin-bottom:-30px">
                                ...
                                <div class="col-5 text-right" style="margin-right: 10px;width:37.5%">
                                  <div class="row mb-3">
                                      <span class="col-8 paragraph-os ml-4"> الصف: <span> {{ $class->name}}</span> </span>
                                      <span class="col-3 paragraph-os"> الشعبة: <span>{{ $room_name }}</span></span>
                                  </div>
                                   <div class="row">
                                      <span class="col-8 paragraph-os ml-4"> اللغة الأجنبية: <span>  </span> </span>
                                      <span class="col-3 paragraph-os"> الرقم في السجل العام: <span> {{  arabic_w2e($student->public_record_number) }} </span></span>
                                  </div>
         ...
         <tr style="border-color: white;"  >
            ...
            <td style="border-color: white;"  >
                <table style="table-layout: fixed;">
                  <thead>
                      <tr>
                        <th  rowspan="4" style="text-align: center;width:7.46%;font-weight:700;font-size:16px" >
                            <div style="min-width:100px">
                            المواد الدراسية
                            </div>
                        </th>
                        <th  rowspan="4"    style="text-align: center;width:2.98%;font-weight:500">
                             <span style="writing-mode: vertical-rl;white-space: pre;transform: rotate(-180deg);font-size:14px">الدرجة العظمى</span>
                             </th>
                        <th colspan="4" rowspan="1"  style="text-align: center;width:18.5%;min-width:17%;font-weight:600" >الفصل الدراسي الأول </th>
                        <th colspan="4" rowspan="1" style="text-align: center;border-left: 3px solid #000;width:18.49%;min-width:17%;font-weight:600">الفصل الدراسي الثاني </th>
                        <th  rowspan="6" class="space-separator" style="border-top:2px solid #fff !important;width:9.75%;background:#fff"></th>
                        <th colspan="1" rowspan="4" style="width:6.36%; border-right: 3px solid #000;">
                            <span style="writing-mode: vertical-rl;white-space: pre;transform: rotate(-180deg);font-size:13px">  مجموع درجات الفصلين  </span>

                        </th>
                        <th colspan="2"  rowspan="2" style="width:13.23% ;text-align: center;font-weight:800;font-size:12px">
                            <div  style="">
                                 الدرجة النهائية
                               <br> ((محصلة الفصلين))
                           </div >
                        ...
                        <th rowspan="3" style="width: 4.87%;">
                            <div style="white-space: nowrap;writing-mode: vertical-rl;transform: rotate(-180deg);font-family: system-ui;font-weight: 700;margin: auto">
                                الدوام
                                المدرسي
                            </div>
                        </th>
                        <th rowspan="3" style="width: 3.98%;">
                            <div style="white-space: nowrap;writing-mode: vertical-rl;transform: rotate(-180deg);font-size:11px;font-family: system-ui;font-weight: 700;margin: auto">
                                الدوام
                                الفعلي
                            </div>
                        </th>
                        ...
                        <th colspan="2" rowspan="1" style="width: 7.86%;font-family: system-ui;font-weight: 700;">
                            الغياب
                        </th>
                        <th rowspan="3" style="text-align: center;width: 0.98%;">
                            <div style="white-space: nowrap;writing-mode: vertical-rl;transform: rotate(-180deg);font-size:10px;margin: auto;font-family: system-ui">
                                النسبة المئوية
                            <br>    للدوام
                            </div>
                        </th>
                      ...
                      <tr>
                        <th  colspan="1" rowspan="2" style="text-align: center;font-weight:600">
                             <span style="font-size:10px"> درجة  <br> الأعمال </span>
                        </th>
                        <th colspan="1" rowspan="2"  style="text-align: center;font-weight:600">
                            <span style="font-size:10px">  درجة <br> الامتحان </span>
                        </th>
                        <th  colspan="2" rowspan="2"  style="text-align: center;font-weight:600;font-size:10px;min-width:11.8%;width:11.8%">
                            <div style="">
                                 مجموع الدرجات للفصل الدراسي
                                 <br>
                                 الأول
                            </div >
                        </th>
                       ...
                       <th  colspan="2" rowspan="2"  style="text-align: center;font-weight:600;font-size:10px;border-left:3px solid #000;min-width:11.8%;width:11.8%">
                         <div style="">
                                 مجموع الدرجات للفصل الدراسي
                                 <br>
                             الثاني
                    ...
                    <th rowspan="2"  style="width:3.88%"><div style="writing-mode: vertical-rl;transform: rotate(-180deg);font-size:12px;margin: auto">مبرر</div></th>
                    <th rowspan="2"  style="width:3.88%"><div style="white-space: pre;writing-mode: vertical-rl;transform: rotate(-180deg);font-size:12px;margin: auto">غير مبرر</div> </div> </th>

                      </tr>
                      <tr>
                        <th rowspan="2" style="text-align: center;width:2.68%;font-size:11px">  رقماً </th>
                        <th  rowspan="2"  style="text-align: center;width:12.746%;font-size:11px "> كتابة </th>
                      </tr>
                  ...
                  @endphp
                      ...
                      {{-- <tr>
                        ...
                        <td style="font-size:12px;font-weight:700">{{  $student_rigistration_term == 1 ? arabic_w2e( ceil($attendance_percent_term1) ).'%' : ''}}</td>
                      </tr> --}}
                      {{-- <tr>
                        <td style="font-size:12px;font-weight:700">الفصل الثاني</td>
                        <td style="font-size:12px;font-weight:700">
                            {{ $current_term == 2  ?  arabic_w2e($actual_attendance2) : '' }}
                        </td>
                        <td style="font-size:12px;font-weight:700">
                            {{ $current_term == 2  ?  arabic_w2e($student_attendance2) : '' }}
                        </td>
                        <td style="font-size:12px;font-weight:700">
                            {{ $current_term == 2  ?  arabic_w2e($justified_absence2) : '' }}
                        </td>
                        <td style="font-size:12px;font-weight:700">
                            {{ $current_term == 2  ?  arabic_w2e($unjustified_absence2) : '' }}
                        </td>
                        <td style="font-size:12px;font-weight:700">
                            {{ $current_term == 2  ?   arabic_w2e( ceil($attendance_percent_term2)).'%' : '' }}
                        </td>
                      </tr> --}}

                      <tr>
                        <th style="text-align:center"  style="width:2.985%"> ٦٠%</th>
                        <th style="text-align: center;width:3.48%"> ٤٠%</th>
                        <th style="text-align: center;width:2.38%;font-size:11px"> رقماً </th>
                        <th style="text-align: center;width:10.04%;font-size:11px">  <div style="margin:0 !important">كتابة</div> </th>
                        <th style="text-align:center"  style="width:2.985%"> ٦٠%</th>
                        <th style="text-align: center;"  style="width:3.48%"> ٤٠%</th>
                        <th style="text-align: center;width:2.587%;font-size:11px"> رقماً </th>
                        <th  style="text-align: center; border-left: 3px solid #000;width:9.45%;font-size:11px ">  <div style="margin:0 !important">كتابة</div> </th>
                            ...
                            @endphp
                                ...
                                <tr>
                                 ...
                                 @endif
                                  ...
                                  <th class="space-separator" style="width:4%;background:#fff"></th>
                                   @php
                                  ...
                                  @endphp
                                  <td class="total_result" data-total_result="{{$current_term == 2 ? $theToltalResult  : '' }}" style=" border-right: 3px solid #000;" > {{   arabic_w2e( $current_term == 2 ? $term1_result + $term2_result  : ''  ) }}  </td>
                                  ...
                                  <td class="x" data-id="{{$current_term == 2 ? ceil($theFinalResult)  : '' }}" data-min_mark="{{  $lesson->min_mark }}"> </td>
                                    {{-- <td> {{ $term1_result + $term2_result }}</td> --}}


                                    {{-- build the notes in report card --}}
                                    @if($lesson->certificate_order == 1)
                                        <td style="font-size:12px;font-weight:700" class="report_details">الفصل الثاني</td>
                                        <td style="font-size:12px;font-weight:700" class="report_details" >
                                            {{ $current_term == 2  ?  arabic_w2e($actual_attendance2) : '' }}
                                        </td>
                                        <td style="font-size:12px;font-weight:700" class="report_details">
                                            {{ $current_term == 2  ?  arabic_w2e($student_attendance2) : '' }}
                                    ...
                                    @endif
                                    @if($lesson->certificate_order == 2)
                                        <td style="font-size:12px;font-weight:700" class="report_details">المجموع </td>
                                        <td style="font-size:12px;font-weight:700" class="report_details">{{ arabic_w2e( $total_actual_attendance ) }}</td>
                                        <td style="font-size:12px;font-weight:700" class="report_details" > {{ arabic_w2e( $total_student_attendance ) }}</td>
                                        <td style="font-size:12px;font-weight:700"class="report_details">{{ arabic_w2e( $total_justified_absence) }}</td>
                                        <td style="font-size:12px;font-weight:700" class="report_details">{{ arabic_w2e( $total_unjustified_absence) }}</td>
                                        <td style="font-size:12px;font-weight:700"class="report_details">{{   arabic_w2e( ceil($attendance_percent)).'%' }}</td>
                                    @endif
                                    @if($lesson->certificate_order == 3)
                                        <td colspan="6" style="font-size:12px;font-weight:700">
                                            <div style="">التوجيهات التربوية</div>
                                        </td>
                                    @endif
                                    @if($lesson->certificate_order == 4)
                                        <td colspan="6" rowspan="7" style="font-size:12px;font-weight:700">
                                             @php
                                    ...
                                    @endif
                                    @if($lesson->certificate_order == 11)
                                        <td colspan="6" rowspan="2" class="text-right" >
                                         <div class="row">
                                            <div class="col-7 " style="font-size:12px;font-weight:700">
                                                اسم الموجه الإداري وتوقيعه:
                                            </div>
                                            <div class="col-4" style="font-size:12px;">
                                                {{ isset($report_card_details) ? $report_card_details->instructor_name : ''}}
                                            </div>
                                         </div>
                                        </td>
                                    @endif
          ...
          <form>
            <tr style="height:50px">
              ...
              <td class="max_mark_total1 max_mark2" style="border-top: 2px solid #000">{{ arabic_w2e(3900) }}</td>
              ...
              <td colspan="6" rowspan="1" style="font-size:12px;font-weight:700">
                   نتيجة التلميذ
              </td>
           ...
           @if (++$i === $lesson_count)
               ...
               @endphp
                   ...
                   <tr>
                       ...
                       <td class="special-subject " style="font-size:11px">    {{ $lesson_name }} </td>
                    ...
                    @endif
                     ...
                     <td  class="x" data-id="{{$current_term == 2 ? $term2_result : '' }}" data-min_mark="{{  $lesson->min_mark }}" style=" border-left: 3px solid #000;"> </td>
                     <td class="space-separator" style="width:4%;background:#fff"></td>
                      @php
                        $theToltalResult = $term1_result + $term2_result ;
                        $dividingRatio =  $student_rigistration_term == 1 ? 2 : 1 ;
                        $theFinalResult = $theToltalResult / $dividingRatio ;
                     ...
                     @if($lesson->certificate_order == 13)
                        <td colspan="6" rowspan="2" class="report_details text-right" style="font-size:12px;font-weight:700">     <div class="row">
       ...
       @endforeach
            ...
            <form>
              <tr style="height:50px">
                ...
                <td class="max_mark_total2" style="border-top: 2px solid #000">{{ arabic_w2e(4100) }}</td>
                <td colspan="2" style="border-top: 2px solid #000"> </td>
               ...
               <td class="x" data-id="" style=" border-left: 3px solid #000;border-top: 2px solid #000"></td>
               <td class="space-separator" style="width:4%;"></td>
               ...
               <tr>
                ...
                <td colspan="9" rowspan="2" style=" border-right: 3px solid #000;">
                 <div class="row"  style="height:50px;position: relative;">
                    ...
                    <div class="row " style="align-self: flex-end;width:100%;right:-50px" >
                             @php
                                $formatted_date1 = ' ';
                                $formatted_date2 = ' ';
                                if ($current_term == 1 ){
                            ...
                            <div class="col-5" style="margin-left: 3px"> التاريخ:
                             {{ $formatted_date1 }}
                            </div>
             ...
             <form>
               <tr>
                ...
                <td class="space-separator"  style="border-bottom:2px solid #fff !important;width:4%;background:#fff"></td>
         ...
         $.each($('.special-subject'), function (key, value) {
            ...
            if ( text.includes("زراع") || text.includes("مهني") ){
                $(this).siblings().not(".report_details").text('') ;
                 ...
                 $(this).siblings().not(".report_details").not(".space-separator").css( "background-color", "#d1d1d1" );
            }
            if ( text.includes("ديني")  ){
                $(this).siblings().not(".report_details").text('') ;
                $(this).siblings().not(".report_details").not(".space-separator").css( "background-color", "#d1d1d1" );
