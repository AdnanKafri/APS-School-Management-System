...
<div class="card" style="direction:rtl; text-align:right;margin: 20px;">
 ...
 الصورة </th>
                    <th style="text-align: center;
    color: black;">
 ساعات العمل بالعربي </th>
                    <th style="text-align: center;
    color: black;">
 ساعات العمل بالانكليزي </th>
                    <th style="text-align: center;
    color: black;">
 العنوان بالعربي </th>
                    <th style="text-align: center;
 ...
 تعديل </th>
            ...
            <tbody class="list">
                ...
                <tr>
                    ...
                    <td >
                      <textarea readonly cols="20" rows="5" style="border: none;">{!! $item->business_hours_ar !!} </textarea>


                    </td>
                    <td >
                      <textarea readonly cols="20" rows="5" style="border: none;"> {{$item->business_hours_en}}</textarea>
                    ...
                    <td >
                        @foreach(json_decode($item->phone) as $item1)
                        @if($item1 != null)
                        <textarea readonly cols="20" rows="5" style="border: none;"> {{$item1}}</textarea>
                    ...
                    <td >
                      <textarea readonly cols="20" rows="5" style="border: none;"> {{$item->google}}</textarea>
                    ...
                    <td class="delete" ><a style="background-color: white; color: rgb(117, 115, 115);"
                            class="btn delete11" href=".createClassModal" class=" btn btn-success" data-toggle="modal"
                            data-id="" data-toggle="modal">تعديل </a>
                        <div class="modal fade createClassModal">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <form id="" action="{{ route('footer_store') }}" method="POST"
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="form-group" style="text-align:right">
                                                ...
                                                <textarea    type="text" name="content_ar" class="form-control" value=""
                                            ...
                                            <div class="form-group" style="text-align:right">
                                                ...
                                                <textarea   type="text" name="content_en" class="form-control" value=""
                                                    required>{{$item->content_en}}</textarea>
                                                     <script>
                                            ...
                                            <div class="form-group" style="text-align:right">
                                                <label> ساعات العمل بالعربي </label>
                                                <textarea type="text" name="business_hours_ar"  class="form-control"
                                                    value="" required>{{$item->business_hours_ar}}</textarea>
                                                    
                                                    <script>
                                                    CKEDITOR.replace( 'business_hours_ar' );
                                                         </script>
                                            </div>
                                            <div class="form-group" style="text-align:right">
                                                <label> ساعات العمل بالانكليزي </label>
                                                <textarea type="text" name="business_hours_en" class="form-control"
                                                    value="" required>{{$item->business_hours_en}}</textarea>
                                                      <script>
                                                    CKEDITOR.replace( 'business_hours_en' );
                                                         </script>
                                            </div>
                                            ...
                                            <div class="form-group" style="text-align:right">
                                                ...
                                                <textarea type="text" name="address_ar" class="form-control" value=""
                                                    required>{{$item->address_ar}}</textarea>
                                            </div>

                                            <div class="form-group" style="text-align:right">
                                                <label> العنوان بالانكليزي </label>
                                                <textarea type="text" name="address_en" class="form-control" value=""
                                                    required>{{$item->address_en}}</textarea>
                                            </div>
                                            <div class="form-group rr" style="text-align:right">
                                                <label> الهاتف </label>
                                            ...
                                            <div class="form-group" style="text-align:right">
                                                ...
                                                <textarea type="text" name="WhatsApp" class="form-control" value=""
                                                    required>{{$item->WhatsApp}}</textarea>
                                            </div>

                                            <div class="form-group" style="text-align:right">
                                                <label> الايميل </label>
                                                <textarea type="text" name="email" class="form-control" value=""
                                                    required>{{$item->email}}</textarea>
                                            </div>
                                            <div class="form-group" style="text-align:right">
                                                <label> facebook </label>
                                                <textarea type="text" name="facebook" class="form-control" value=""
                                                    required>{{$item->facebook}}</textarea>
                                            </div>
                                            <div class="form-group" style="text-align:right">
                                                <label> twitter </label>
                                                <textarea type="text" name="twitter" class="form-control" value=""
                                                    required>{{$item->twitter}}</textarea>
                                            </div>
                                            <div class="form-group" style="text-align:right">
                                                <label> google </label>
                                                <textarea type="text" name="google" class="form-control" value=""
                                                    required>{{$item->google}}</textarea>
                                            </div>
                                            <div class="form-group" style="text-align:right">
                                                <label> instgram </label>
                                                <textarea type="text" name="instgram" class="form-control" value=""
                                                    required>{{$item->instgram}}</textarea>
                                            </div>
