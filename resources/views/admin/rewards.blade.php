...
<nav class="breadcrumbs">
    <a  class="breadcrumbs__item is-active">    قسم المكافآت  </a>
    <a href="{{ route('Rewards_and_sanctions') }}" class="breadcrumbs__item ">     قسم  المكافآت والعقوبات   </a>
        ...
        <div class="modal-content">
            <form action="{{route('rewards_and_sanction_store')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="modal-header">
                    ...
                    <h2 class="modal-title" id="exampleModalLabel">اضافة المكافأة </h2>
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text" name="name" class="form-control a" style="direction:rtl"
                            value=""
                            placeholder=" اسم المكافأة" required>
                    </div>
                    <br>
                    <div class="form-group">
                        <label> الصورة</label>
...
<div class="card" style="margin: 30px">
    <div class="card-body">
        <div class="card-title">
            <h1 style="text-align: center;color: #001586">جدول    المكافآت </h1>
        </div>
        @can('add_Rewards')
        <button type="button" class="btn mb-1 btn-success" data-toggle="modal" data-target="#create_teacher" style="font-size: 25px;font-weight: 600;float: right;background: #6ABAA3;border-color: #6ABAA3">إنشاء  مكافئة </button>
        @endcan
        <div class="">
            <table class="table align-items-center " id="table_xx">
                <thead style="color: black">
                <tr>
                    <th scope="col" class="sort" data-sort="budget"> اسم المكافأة </th>
            ...
            <form id="form_delete" action="{{route('rewards_and_sanction_delete')}}" method="POST"  autocomplete="off">
                ...
                <div class="modal-body">
                    ...
                    <div class="py-3 text-center">
                        ...
                        <h4 class="heading mt-4">حذف  المكافأة</h4>
