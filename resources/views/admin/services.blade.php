...
@section('page_subtitle', 'إدارة الخدمات المعروضة في الموقع')
@section('breadcrumbs')
    <nav class="breadcrumbs">
        <a class="breadcrumbs__item is-active">خدماتنا </a>
...
@section('content')
    ...
    <div class="modal fade editNewsModal"style="text-align: end;">
        <div class="modal-dialog">
            <div class="modal-content">
                <form id="form_update" action="{{ route('service_website.update') }}" method="POST"
    ...
    <div class="modal fade createNewsModal" style="text-align: end;">
        <div class="modal-dialog">
            <div class="modal-content">
                <form id="form_update" action="{{ route('service_website.store') }}" method="POST"
                    enctype="multipart/form-data">
                    @csrf
    ...
    <script>
        ...
        $(document).on('click', '.delete_event', function(e) {
            ...
            $.ajax({
                ...
                type: 'post',
                url: "{{ route('service_website.delete') }}",
                enctype: 'multipart/form-data',
                data: {
                    '_token': "{{ csrf_token() }}",
                    'id': id,
