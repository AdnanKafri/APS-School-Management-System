        ...
        <div class="table-responsive">
            @can('create_class')
                <a href=".createClassModal" class=" btn btn-success" data-toggle="modal" data-id=""><i
                        class="material-icons" data-toggle="tooltip">إنشاء فرع جديد</i></a>
            @endcan
                ...
                <tbody class="list">
                    @foreach ($mainDepartments as $item)
                        <tr>
                            ...
                            <td class="text-right">
                                <a href="{{ route('subDepartments', $item->id) }}" class="btn btn-success"
                                    style="margin-left: 10px">الاقسام الفرعية</a>
    ...
    <div class="modal fade createClassModal">
        <div class="modal-dialog">
            <div class="modal-content">
                <form id="" action="{{ route('mainDepartment_store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
