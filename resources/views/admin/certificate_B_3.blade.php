...
">
	...
	<div  style="width:1300px;margin:auto" class="animate__animated animate__lightSpeedInRight  animate__delay-1s">
     ...
     <table id="1" class="w-100 "  style="border-color: white;text-align:center;margin:auto"   >
            ...
            <table class="upper-table w-100"  style="border-color: white">
                <thead>
                    ...
                    @endphp
                        ...
                        <td   colspan="2" style="position: relative;width:36%;font-family:'Amiri', serif;">
                            <h2 class="my-title" style="font-weight: 600;position: absolute;top:5px;right:55px"> مرحلة التعليم الأساسي  </h2>
                            <h3 class="my-title" style="font-weight: 600;font-size:18px;position: absolute;top:50px;right:90px">  الحلقة الأولى الصف / فئة ب - المستوى الثالث   </h3>
                        </td>
                ...
                <tbody style="font-family:'Amiri', serif;">
                    <tr>
                        ...
                        <td  colspan="11">
                            <div class="row" style="">
                                 <div class="col-3 text-right " Style="width:32.333333%">
                                      <p class="paragraph-os mb-2">
                                ...
                                <div class="col-3 " style="text-align: right;width:27.555%">
                                ...
                                <div class="col-6 text-right" style="margin-right: 10px;width:37.5%">
                                  <div class="row mb-2">
                                      <div class="col-3 paragraph-os "> الصف: <span> {{ $class->name}}</span> </div>
                                      <div class="col-4 paragraph-os"> الشعبة: <span>{{ $room_name }}</span></div>
                                  </div>
                                   <div class="row">
                                      <div class="col-3 paragraph-os "> اللغة الأجنبية: <span>  ك</span> </div>
         ...
         <tr style="border-color: white;"  >
            ...
            <td style="border-color: white;"  >
                <table class="fixed5" style="">
                  <thead>
                      <tr>
                        <th  rowspan="3" class="subject" style="text-align: center;width:9.3%;font-weight:800;font-size:11px" >  المواد الدراسية </th>
                        <th  rowspan="3"    style="text-align: center;width:3.38%;font-weight:800">
                             <span style=";font-size:11px">الدرجة <br>العظمى</span>
                             </th>
                        <th colspan="4" rowspan="1"  style="text-align: center;font-weight:800" >الفصل الدراسي الأول </th>
                        <th colspan="4" rowspan="1" style="text-align: center;border-left: 3px solid #000;font-weight:800">الفصل الدراسي الثاني </th>
                        <th  rowspan="3" class="space-separator" style="border-top:2px solid #fff !important; width:10.6%;background:#fff"><p style="width: 45px"></p></th>
                        <th colspan="1" rowspan="3" style=" border-right: 3px solid #000;font-weight:800">
                              مجموع درجات <br> الفصلين

                        </th>
                        <th colspan="2"  rowspan="2" style="text-align: center;font-weight:800;font-size:10px;">
                        ...
                        <th rowspan="2" style="width: 4.81%;font-size:10px;padding:0;font-weight:800">
                            <!--4px-->
                        ...
                        <th rowspan="2" style="width: 3.7%;font-weight:800">
                            <!--2px-->
                        ...
                        <th rowspan="2" style="width: 3.8%;padding:0;font-weight:800">
                            <div  style="font-size: 9.5px;margin:auto">
                                دوام
                                التلميذ
                            </div>
                        </th>
                        <th colspan="2" rowspan="1" style="font-weight:800">
                            <!--5px-->
                              <div  style="margin:auto">
                            الغياب
                            </div>
                        </th>
                        <th rowspan="2" style="text-align: center;width: 3.4%;font-size: 10px;font-weight:800">
                      ...
                      <tr>
                        <th  colspan="1" rowspan="1" style="text-align: center;font-weight:800;font-size:11px;width:3.317%">
                            درجة <br> الأعمال
                        </th>
                        <th colspan="1" rowspan="1"  style="text-align: center;font-weight:800;font-size: 11px;width:3.317%">
                                 درجة <br> الامتحان
                         </th>
                        <th  colspan="2" rowspan="1"  style="text-align: center;font-weight:800;font-size:11px">
                                 مجموع الدرجات للفصل الدراسي  <br>الأول
                        ...
                        <th  colspan="2" rowspan="1"  style="text-align: center;font-weight:800;font-size:11px;border-left: 3px solid;">
                                 مجموع الدرجات للفصل الدراسي  <br>الثاني

                        </th>

                    <th style="font-size: 10px;width:3.317%">مبرر</th>
                    <th style="font-size: 10px;width:3.317%">غير مبرر </th>
                  ...
                  @endphp
                    <tr>
                        <th style="text-align:center;width:3.317%"> ٦٠%</th>
                        <th style="text-align: center;width:3.317%"> ٤٠%</th>
                        <th style="text-align: center;width:2.67%"> رقما </th>
                        <th style="text-align: center;width:9.22%"> كتابة </th>
                        <th style="text-align:center;"> ٦٠%</th>
                        <th style="text-align: center;"> ٤٠%</th>
                        <th style="text-align: center;width:3.4%"> رقما </th>
                        <th  style="text-align: center; border-left: 3px solid #000;width:7.9%"> كتابة </th>

                        <th style="text-align: center;width:3.317%"> رقما </th>
                        <th  style="text-align: center;width:9.2% "> كتابة </th>
                    ...
                    @if($lesson->certificate_order !=0)
                        ...
                        @if (++$i === $lesson_count)
                            ...
                            @endphp
                                ...
                                <tr @if($lesson->max_mark ==0 )
                                style="    background: #d1d1d1;"
                                  @endif
                                         >

                                    <td class="special-subject" style="background: white; ">    {{ $lesson_name }} </td>
                                    ...
                                    <td class="result2" data-term2_result="{{$current_term == 2 ? $term2_result : ''  }}"
                                        @if( $term2_result  < $lesson->min_mark)
                                            style="color:red !important;"
                                        @endif
                                        > {{ arabic_w2e( $current_term == 2 ? $term2_result : '' ) }}
                                    </td>
                                ...
                                <td class="x" data-id="{{$current_term == 2 ?    ceil($theFinalResult)  : ''}}"
                                 ...
                                 > </td>
                                        ...
                                        <td style="white-space: pre; background: white; "  class="report_details">الفصل الثاني</td>
                                        <td style="background: white; "  class="report_details">
                                    ...
                                    @if($lesson->certificate_order == 11)
                                        <td colspan="6" rowspan="2" class="report_details" style="background:#fff;">
                                        ...
                                        <td rowspan="3">
                                           <div class="row no-gutters" style="width:120px; margin-left: 0 !important;margin-right: 0 !important;">
                                              <div class="col-4 d-flex justify-content-between p-0;">
                                                <div class="col-10" style="margin: auto;margin-right:-5px">
                                                  <div style="font-size:10px;font-weight:500">{{  $base_subject->name  }} </div>
                                                </div>
                                                <div class = "vertical col-2" ></div>
                                              </div>

                                              <div class="col-8" style="margin: auto;margin-left: -5px;" >
                                                  <h6 style="font-size:9.5px;margin:2px">المهارات الشفوية </h6>
                                                  <hr class="my-2 herozintal" >
                                                  <h6 style="font-size:9.5px;margin:2px"> المهارات الكتابية</h6>
                                              </div>
                                            </div>
                                        </td>
                                        @php
                                    ...
                                    @foreach ($addable_lessons as $addableKey => $lesson2)
                                        ...
                                        <form>
                                           ...
                                           <td class="result2" data-term2_result="{{$current_term == 2 ? $term2_result : ''  }}"
                                            ...
                                            @endif
                                            @if($lesson2->certificate_order  == 3)
                                                 <td colspan="6" rowspan="1" style="font-weight:800">
          ...
          <form>
            <tr >
              ...
              <td class="max_mark_total1 max_mark2" style="border-top: 2px solid #000">{{  arabic_w2e(1000) }}</td>
              <td colspan="2" class="" style="border-top: 2px solid #000"></td>
               ...
               @endphp
                   ...
                   <tr  @if($lesson->max_mark ==0 )
                       ...
                       <td colspan="2" class="">
                            ...
                            @foreach(json_decode($student_marks->worke_degree) as $key1 => $item1 )
                                @if($key1 == $lesson->id )
                              @if(is_numeric($item1->term1_result))
                                @php
                                    $term1_result +=  $item1->term1_result ;
                                @endphp
                                 @endif
                    ...
                    @if($lesson->certificate_order == 13)
                        <td colspan="6" rowspan="1" class="report_details text-right" Style="font-weight:600;background:#fff"> نجاح إلى الصف:
                            @if($report_card->final_result == 2 && $current_term != 1)
                                    {{ $class->next_class_success->name }}
                            @endif
                        </td>
                    @endif
                    @if($lesson->certificate_order == 14)
                        <td colspan="6" rowspan="1" class="report_details text-right" Style="font-weight:600"> رسوب في الصف:
                             <span class="mr-1">
                    ...
                    @endif
                    @if($lesson->certificate_order == 15)
                        <td colspan="6" rowspan="1" class="report_details text-right" Style="font-weight:600;background:#fff">
                            <div class="row">
                                <div class="col-6">
                                    نقل إلى الصف:
                                </div>
       ...
       @endforeach
            ...
            <form>
              <tr >
                ...
                <td class="max_mark_total2" style="border-top: 2px solid #000">{{  arabic_w2e(1100) }}</td>
                <td colspan="2" class="" style="border-top: 2px solid #000"> </td>
               ...
               <td class="x" data-id=""></td>
               <td colspan="6" rowspan="1" class="report_details text-right" Style="font-weight:600">
                <div class="row">
                    <div class="col-6">
                        نقل إلى الصف:
                    </div>
               ...
               <tr>
                ...
                <td class="space-separator" style="background:#fff"></td>
                <td colspan="9" rowspan="2" style=" border-right: 3px solid #000;font-weight:600">
    ...
    * */
    ...
    $(document).ready(function() {
         ...
         $.each($('.special-subject'), function (key, value) {
            let text = $( this).text() ;
            // let text = $(this).text() ;
            if ( text.includes("زراع") || text.includes("مهني") || text.includes("طلائع") || text.includes("دي" ) ){
