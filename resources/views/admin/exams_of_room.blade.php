          ...
          <div class="row" style="margin-right:0px" >
              ...
              <table class="table align-items-center table-flush" id="table_xx">
                <thead class="">
                 ...
                 <th scope="col" class="sort" data-sort="budget">نوع الامتحان </th>
               ...
               <tr>
                ...
                <td class="budget">
                    ...
                    {{-- <a href=".editroomModal" class="edit"  data-class1="{{ $exam->classes->id }}"
                    data-name="{{ $exam->name }}"  data-id="{{ $exam->id }}"  data-toggle="modal" >
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <form method="POST" action="{{ route('exam.store') }}"  enctype="multipart/form-data">
                                @csrf
                                <div class="modal-header">
                                    <h4 class="modal-title">إنشاء امتحان</h4>
                                    <button type="button" class="close" data-dismiss="modal"
                                        aria-hidden="true">&times;</button>
                                </div>
                                <div class="modal-body">
                                    ...
                                    <div class="form-group" style="text-align:right">
                                        ...
                                        <select name="is_file" id="" class="form-control lesson_id"
                                            style="min-height: 36px;direction: rtl" required>
                                            <option value="">حدد  نوع الامتحان</option>
                                            <option value="0">امتحان مؤتمت</option>
                                            <option value="1">امتحان تقليدي /* ملف */ </option>
                                    ...
                                    <div class="form-group" style="text-align:right">
                                        ...
                                        <input   class="form-control "   type="number" name="period"  value="" min="0"   style="text-align: right;" required />
                                    </div>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <form method="POST" action="{{ route('exam.update') }}"  enctype="multipart/form-data">
                                @csrf
                                <div class="modal-header">
                                    <h4 class="modal-title">تعديل امتحان</h4>
                                    <button type="button" class="close" data-dismiss="modal"
                                        aria-hidden="true">&times;</button>
                                </div>
                                <div class="modal-body">
                                    <input type="hidden"  name="room_id" class="form-control " value="{{ $room_id }}">
                                    <input type="hidden" name="exam_id" class="form-control exam_id" >
                                    ...
                                    <div class="form-group" style="text-align:right">
                                     ...
                                     <div class="form-group" style="text-align:right">
                                        ...
                                        <select name="is_file" id="" class="form-control is_file"
                                            style="min-height: 36px;direction: rtl" required>
                                            <option value="" hidden>حدد  نوع الامتحان</option>
                                            <option value="0">امتحان مؤتمت</option>
                                            <option value="1">امتحان تقليدي/* ملف */ </option>
                                    ...
                                    <div class="form-group" style="text-align:right">
                                        <label for="">وقت البداية </label>
                                        <input   class="form-control start_date"   type="datetime-local" name="start_date"  value=""   style="text-align: right;" />
                                    </div>

                                    <div class="form-group" style="text-align:right">
                                        <label  for="">وقت النهاية </label>
                                        <input   class="form-control end_date"   type="datetime-local" name="end_date"  value=""   style="text-align: right;" />
                                    </div>
                                    <div class="form-group" style="text-align:right">
                                        <label  for="">العلامة   </label>
                                        <input   class="form-control mark"   type="number" name="mark"  value="" min="0"   style="text-align: right;" />
                                    </div>
                                    <div class="form-group" style="text-align:right">
                                        <label  for="">المدة الزمنية  </label>
                                        <input   class="form-control period"   type="number" name="period"  value="" min="0"   style="text-align: right;" />
                                    </div>
                                    <div class="form-group" style="text-align:right;direction:rtl" >
                                        <label  for=""> المطلوب </label>
                                        <textarea class="form-control required_lectures" name="required_lectures" id="" cols="30" rows="6"></textarea>
                                    </div>
                                    <div class="form-group" style="text-align:right" hidden>
                                        <label>   المسؤول عن وضع الأسئلة</label>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <form method="POST" action="{{ route('exam_quize.delete') }}"  enctype="multipart/form-data">
                                ...
                                <div class="modal-header" >
                                    <h4 class="modal-title" style="color: #f00">حذف الامتحان</h4>
                                ...
                                <div class="modal-body">
                                    <input type="hidden" name="room_id" class="form-control " value={{ $room_id }}>
                                    <input type="hidden" name="content_id" class="form-control exam_id" >

                                    <div class="form-group" style="text-align:right">
                                        <label>نوع الامتحان (شفهي..)</label>
                                        <input type="text" class="form-control content_name"
                                            value="" style="direction: rtl"
                                            placeholder="مثال:  امتحان تحريري " readonly>
                                    </div>
...
$('#table_xx').DataTable();
    ...
    $('#lesson_id_filter').change(function () {
        ...
        var url = "{{ URL::to('SMT/admin/exam_filter_search') }}/";
...
$(document).on('click', '.deleteContent', function () {
    ...
    $('.deleteContentModal .exam_id').val(quize_id);
