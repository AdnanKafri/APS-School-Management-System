...
<nav class="breadcrumbs">
    <a  class="breadcrumbs__item  is-active">ارشفة  الطلاب  </a>
...
<div class="card" style="margin: 30px">
    <div class="card-body">
        ...
        <form action="{{ route('export_student_archive') }}" method="post">
                   @csrf
        <div class="row" >
            ...
            text-align: center;">
                  ...
                  <div id="disabled">
                      <button class="btn btn-success" type="submit" id="export" style="margin-top: 40px;" >  تصدير الطلاب   </button>
                  </div>
            ...
            <table class="table align-items-center " id="table_xx" >
                <thead style="color: black">
                  <tr>
                    ...
                    <th scope="col" class="sort" data-sort="status">  مقدار الدفع    </th>


                    <th scope="col" class="sort" data-sort="status"> معلومات  اضافية      </th>
...
$.ajax({
   ...
   $('#disabled').empty();
    $('#disabled').append(`<button class="btn btn-success" type="submit" id="export" style="margin-top: 40px;" >  تصدير الطلاب   </button>`);
