...
<div class="main-panel" style="background: #f8f9fb;">
    ...
    @if($exam->type == "1")
    <li class="li">
        <a href="{{ route('dashboard.coordinator.exams_quizes',[$room->id ,$coordinator->id,$lesson->id,$exam_id]) }}">عودة</a>
    </li>
    @else
    <li class="li">
        <a href="{{ route('coordinator.StudentsRoomLesson_quize',[$room->id ,$coordinator->id,$lesson->id,$exam_id]) }}">عودة</a>
    </li>
    @endif
        ...
        <div class="container" style="padding-bottom: 150px;">
            <div class="form_main">
                ...
                <div class="col-md-4 text-center">
                    ...
                    <input disabled class="input" name="text" type="text" value="{{$class1->name}}">
                ...
                <div class="row justify-content-end">
                  ...
                  <form action="{{ route('dashboard.update_result1') }}" method="post" style="width:inherit">
                    @csrf
                    ...
                    <div class="col-md-4" style="text-align: end;">
                        ...
                        type="number" min="0.0" max="{{ $question->exam_question[0]->mark }}"
            ...
            <div class="col-md-4" style="text-align: end;">
                <input  class="input"   name="traditional_result[{{ $question->id }}]" placeholder="" step="0.001" type="number"
                min="0.0" max="{{ $question->exam_question[0]->mark }}" style="width: 60px;height: 50px;"> &nbsp;
                <input hidden name="mark0" type="text" value="{{ $question->exam_question[0]->mark }}">
                        <button class="mark_sub"><span> {{ $question->exam_question[0]->mark }}</span></button>
            </div>
             </div>
