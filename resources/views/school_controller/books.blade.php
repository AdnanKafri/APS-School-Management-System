...
.button_do {
  ...
  --bg-color-sub: #dedede!important;
  --bg-color: #eee!important;
  --main-color: #2b4770!important;
...
.button_do, .button__icon, .button__text {
  transition: all 0.3s!important;
}

.button_do .button__text {
  transform: translateX(22px) !important;
  color: var(--font-color) !important;
  font-weight: 600 !important;
}

.button_do .button__icon {
  position: absolute!important;
  transform: translateX(105px)!important;
  height: 100%!important;
  width: 56px!important;
  background-color: var(--bg-color-sub)!important;
  display: flex!important;
  align-items: center !important;
...
.button_do:hover .button__text {
  color: transparent !important;
}

.button_do:hover .button__icon {
...
@section('content')
	...
	padding-top: 11px;">
	  ...
	  <li class="li"><a href="{{ route('dashboard.classes_book') }}">الصفحة الرئيسية</a></li>
