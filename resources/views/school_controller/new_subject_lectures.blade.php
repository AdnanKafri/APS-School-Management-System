                  ...
                  <div class="article-wrapper">
                    ...
                    <div class="article-body">
                       ...
                       <div class="row" style="justify-content: space-around;">
                        <button class="button">
                          <a href="{{ route('coordinator_lecture_content',[$lesson->id,$room->id,$item->id]) }}" style="color: #fff;" > مشاهدة المحتوى</a>
                        </button>
                        {{-- <button class="button">
                            <a href="{{ route('dashboard.add_content',[$class->id,$coordinator->id,$room->id ,$item->id]) }}" style="color: #fff;"> اضافة محتوى </a>
                          </button> --}}
