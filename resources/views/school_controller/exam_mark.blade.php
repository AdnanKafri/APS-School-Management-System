        ...
        <div class="content-wrapper pb-0">
            ...
            <div class="container" style="direction: rtl;position: relative;">
                                                        ...
                                                        @foreach ($exam as $item)
                                                            <tr>
                                                                ...
                                                                <td data-label="عرض العلامات"><a
                                                                        href="{{ route('coordinator_exam_students', [$room_id, $coordinator->id, $lesson_id, $item->id]) }}"
                                                        ...
                                                        <table class="table table-striped">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>{{ $item->period }} </td>
                                                                    <td>{{ $item->mark }}</td>
                                                                    <td><a href="{{ route('coordinator_exam_students',[$room_id ,$coordinator->id,$lesson_id,$item->id]) }}"
                ...
                <div class="modal fade" id="basicModal" tabindex="-1" role="dialog" aria-labelledby="basicModal"
                    ...
                    <div class="modal-dialog">
                        <form action="{{ route('coordinator.dashboard.exam.update123') }}" method="post"
            ...
            height: 38px;">حفظ</button>
                ...
                <div class="modal fade" id="basicModal2" tabindex="-1" role="dialog" aria-labelledby="basicModal"
                    aria-hidden="true">
                    <div class="modal-dialog">
                        <form action="{{ route('coordinator.add_quize_student') }}" method="post" enctype="multipart/form-data">
