                         ...
                         <div class="row" >
                          ...
                          <div class="col-md-4" style="margin-bottom: 10px;">
                            <div class="cookieCard">
                              ...
                              <a href="{{ route('coordinator_exam',[$room_id,$coordinator->id,$item->id]) }}" class="acceptButton" style="color: #fff;">العلامات</a>
                            </div>
                          </div>
                          ...
                          <div class="col-md-4" style="margin-bottom: 10px;">
                            <div class="cookieCard">
                              ...
                              <!--<a href="" class="acceptButton" style="color: #fff;">العلامات</a> -->
                               <a href="{{ route('coordinator_quize_mark',[$room_id,$coordinator->id,$item->id]) }}" class="acceptButton" style="color: #fff;">العلامات</a>
                            </div>
                          </div>
