                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="container">
                                    {{-- <div class="row">
                                        <div class="col-sm">
                                            <input class="homeid" hidden value="{{$quize_result}}">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <input style="height: 50px; width:60px"  hidden name="exam_result_id"  value="{{ $item->id }}" type="text">
                                                           ...
                                                           <input   style="height: 50px; width:60px" name="mark" value="{{ $item->result!=null ?$item->result : '' }}" onfocus="this.placeholder = ''" onblur="this.placeholder = ''" class="common-input mb-20 form-control "  type="text">
                                                    ...
                                                    <a href="{{ route('dashboard.coordinator.correct_exam1',[$exam1->id,$item->student->id]) }}" class="btnexams" >تصحيح المذاكرة  </a>&nbsp;&nbsp;&nbsp;
                                                </td>
