...
@section('content')
    <div class="main-panel" style="background: #f8f9fb;">
        ...
        padding-top: 11px;">
           ...
           <li class="li"><a href="{{route('dashboard.coordinator.exams_quizes')}}">المذاكرات والامتحانات</a></li>
           {{-- <li class="li"><a
            ...
            <div class="container" style="direction: rtl;">
                <div class="row">
                    ...
                    <input style="height: 50px; width:60px"  hidden name="exam_result_id"  value="{{ $item->id }}" type="text">
                       ...
                       <input  style="height: 50px; width:94px;" name="mark" min="0.0" max="{{$quize->mark}}" value="{{ $item->result!=null ?$item->result : '' }}" onfocus="this.placeholder = ''" onblur="this.placeholder = ''" class="number_mark common-input mb-20 form-control input2"  type="number">
