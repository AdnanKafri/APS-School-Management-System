...
<div class="main-panel" style="background: #f8f9fb;">
        <ul class="breadcrumbs" style="padding-bottom: 7px;
            ...
            <li class="li"><a
                    href="{{ route('coordinator_subjects_lectures',['lesson_id' =>$lecture->lesson->id ,'room_id'=>$room_id]) }}">{{ $lecture->lesson->name }}
                </a></li>
                ...
                <div class="row">
                    <div class="col-md-2">
                        <a class="home" href="#" data-toggle="modal" data-target="#demoModal1"
                            style="color:#fff">اضافة ملف</a>
                    </div>
                     <div class="col-md-2">
                        <a class="home" href="{{ route('dashboard.coordinator.questions',[$class_id,$room_id,$lecture->id,$lecture->lesson->id ]) }}"
                            style="color:#fff">اضافة اسئلة</a>
                    </div>
                    ...
                    <div class="modal-dialog animated zoomInDown modal-dialog-centered" role="document">
                        <div class="modal-content" style="padding-top: 50px !important;text-align: end;">

                            <div class="container-fluid">
                                <form action="{{ route('store_items_coor') }}" method="post" enctype="multipart/form-data">
                                    @csrf

                                    <input type="hidden" name="lesson_id" value="{{ $lecture->lesson->id }}">
                                ...
                                <div class="container">
                                   <div class="row">
                                    <h3 style="margin: auto;">اضافة ملف </h3>
                                     <!--start card-->
                                  ...
                                  <div class="row" style="justify-content: center;padding-top: 20px;padding-bottom:20px">
                                     <div class="col-md-2">
                                                    ...
                                                    <div class="col-md-4 newrow">
                                                        <div class="card12">
                                                            ...
                                                            <a href="{{ $item4->addition_link }}" target="_blank" style="margin-top: -4px"> <img
                                                                    src="{{ asset('teachers_2/icons/icons8-link-70.png') }}"
                                                    ...
                                                    <div class="col-md-4 newrow">
                                                        <div class="card12">
                                                            ...
                                                            @if ($item4->extension == 'docx')
                                                                <img src="{{ asset('teachers_2/icons/word.png') }}">
                                                            @elseif ($item4->extension == 'pdf')
                                                                <img src="{{ asset('teachers_2/icons/pdf2.png') }}">
                                                            @elseif ($item4->extension == 'pptx')
                                                                <img src="{{ asset('teachers_2/icons/powerpoint.png') }}">
                                                            @else
                                                            ...
                                                            <div class="row ">
                                                                ...
                                                                <a href="{{ asset('storage/' . $item4->addition) }}"
                                                                    ...
                                                                    <img title=" تنزيل الملف "
                                                                        src=" {{ asset('teachers_2/icons/download.png') }}"
                                                                        style="width:43px"> </a>
                                                        ...
                                                        <div class="card12">
                                                            ...
                                                            <a href="#">
                                                                <img style="width:180px"
                                                                    src="{{ asset('teachers_2/photo/quiz44.jpg') }}">
                                                            </a>
                                                    ...
                                                    @if ($item->quize1)
                                                        <div class="col-md-4 newrow">
                                                            <div class="card12">
                                                                ...
                                                                <br>
                                                                <img src="{{ asset('teachers_2/photo/quiz44.jpg') }}">
                                                                <br>
                                                                ...
                                                                <div class="row ">
                                                                    ...
                                                                    {{-- <a href="./table-exams/index.html"> <img src="{{  asset('teachers_2/icons/icons8-edit-link-30.png./icons8-plus (1).gif')}}"
                                                ...
                                                <div class="col-md-4 newrow">
                                                    <div class="card12">
                                                       ...
                                                       <!-- <a href="{{ $item->video_link }}" target="_blank"> <img
                                                                src="{{ asset('teachers/icons8-link-70.png') }}"
                                                                style="height: 150px;width:150px"> </a>-->
                                                    ...
                                                    <div class="col-md-4 newrow">
                                                        <div class="card12">
                                                            ...
                                                            <div class="Group" style="padding-top: 20px;">
                                                                {{-- علامات الوظيفة --}}
                                                                <a href="{{ route('coordinator.StudentsRoomLesson',[$room_id ,$coordinator->id,$lesson->id,$item->id]) }}"
                                                                    class="" title="علامات">
                                                    ...
                                                    <div class="col-md-4 newrow">
                                                        <div class="card12">
                                                            ...
                                                            @if ($item->extension == "docx")
                                                             <img src="{{  asset('teachers_2/photo/word.png')}}">
                                                             @elseif ($item->extension =="pdf")
                                                            <img src="{{  asset('teachers_2/photo/pdf1.png')}}">
                                                           @elseif ($item->extension == "pptx")
                                                            <img src="{{  asset('teachers_2/photo/powerpoint.png')}}">
