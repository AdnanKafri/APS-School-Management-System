        ...
        <div class="container mt-5" style="direction: rtl;">
         <div class="row" style="justify-content: right">
           {{-- <div class="col-md-2" style="margin-right: 23px;">
                <a  href="{{ route('dashboard.StudentsRoomLessontotal_pdf',[$room_id,$teacher->id,$lesson_id]) }}"   class="button"  target="_blank">pdf تنزيل </a>
            </div>--}}
            {{-- <div class="col-md-2">
                <a  href="{{ route('dashboard.StudentsRoomLessontotal_excel',[$room_id,$teacher->id,$lesson_id]) }}"
                     class="button"  target="_blank"  style="padding-top: 10px;color: white;"> تنزيل اكسل  </a>
            </div> --}}
         </div>
             ...
             <td> {{arabic_w2e( $item->id) }}  </td>
                <td> {{ $item->first_name }} {{ $item->last_name }} </td>
                  ...
                  <td>
                      ...
                      @else
                      <input class="number" style="height: 50px; width:60px;border: 1px solid #e9d8db;"
                          value="{{ json_decode($item2->mark,true)[$lesson_id]['activities']}}" disabled
                          name="activities" onfocus="this.placeholder = ''" onblur="this.placeholder = ''"
                          class="common-input mb-20 form-control" type="number" min="0"
                          data-max="{{$lesson->max_mark*0.2}}" max="{{$lesson->max_mark*0.2}}">
                      @endif
        ...
        @foreach (  $students->student as $item  )
         ...
         text-decoration: underline;">
              ...
              {{-- <td class="x" @if($item2->result)
                  ...
                  @endif></td> --}}
                  <td>
                        <textarea class="form-control" name="notes" style="width: 200px;" disabled >
                      @if($item2->notes)
