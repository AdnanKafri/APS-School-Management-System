...
<div class="main-panel" style="background: #f8f9fb;">
   ...
   <li class="li"><a href="{{ route('dashboard.coordinator.marks.subjects',['room_id' => $room_id, 'coordinator_id' => $coordinator->id]) }}">المذاكرات والامتحانات</a></li>
      <li class="li"><a href="#">علامات الطلاب</a></li>
              ...
              <div class="card">
                <div class="card-body">
                 ...
                 <div class="container" style="position: relative;top: -8px;">
                   {{-- <div class="row">
                    <div class="col-sm">
                        <input class="homeid" hidden value="{{$exam_result}}">
                  ...
                  <div class="table-responsive">
                    <table class="table-fill table1" >
                        ...
                        <tbody>
                            <input style="height: 50px; width:60px" class="room_id"  hidden name="room_id"
                            ...
                            <tr>
                                ...
                                <td>
                                <a href="{{ route('dashboard.coordinator.correct_exam1',[$exam->id,$item->student->id]) }}" class="btnexams"   >ملف الامتحان  </a>&nbsp;&nbsp;&nbsp;
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
...
var url = "{{ URL::to('SMARMANger/dashboard/coordinator/examstudent2') }}/" + lect+"/"+home+"/"+room_id ;
$.ajax({
url: url,
data : data,
type: "get",
...
<td> <a href="{{url('SMARMANger/dashboard/exam/correct_exam1') }}/${home}/${value.id}" class="btn"  style="background-color: white; color: rgb(117, 115, 115);" >تصحيح الامتحان  </a>
   </td>
${medal}
...
<td>${d}</td>
<td> <a href="{{url('SMARMANger/dashboard/exam/correct_exam1') }}/${home}/${value2.id}" class="btn"  style="background-color: white; color: rgb(117, 115, 115);" >تصحيح الامتحان  </a>
    </td>
  ${medal}
    </tr> `)
     })
