...
@section('content')
    <div class="main-panel" style="background: #f8f9fb;">
        ...
        <li class="li"><a href="{{ route('dashboard.coordinator') }}">المواد</a></li>

        <li class="li"><a
                href="{ route('dashboard.coordinator_subject',['room_id' => $room->id])}}">{{ $room->name }}</a>
        </li>
        <li class="li"><a
                href="{{ route('coordinator_subjects_lectures',['lesson_id' =>$lesson->id ,'room_id'=>$room_id]) }}">{{ $lesson->name }}
            </a></li>
            {{-- <li class="li"><a
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <p style="color: #9ea7af;
                                        text-align: right;">وقت النهاية : {{ $exam1->end_time }}
                                        <p style="color: #9ea7af;
                                ...
                                <h4 style="text-align: center;padding-bottom: 20px;color: #152C4F;font-size: 28px;">علامات
                                    ...
                                    <div class="col-md-4" style="position: relative;z-index: 9;">
                                        {{-- <a href="{{route('dashboard.teacher.download_zip',['room_id' => $room_id, 'exam_id' => $exam1->id])}}" class="cssbuttons-io-button">
                                            <span>تنزيل جميع الوظائف</span>
                              ...
                              <!--  <div class="container">
                                ...
                                <div class="table-responsive">
                                    <table class="table1">
                                        <input style="height: 50px; width:94px;" hidden name="class_id" id="class_id"
                                            value="{{ $room_id }}" type="text">
                                        <input style="height: 50px; width:94px;" hidden name="room_id" id="room_id"
                                            value="{{ $room_id }}" type="text">
                                        <input style="height: 50px; width:94px;" hidden name="exam_id" id="exam_id"
                                            value="{{ $exam_id }}" type="text">
                                        <input style="height: 50px; width:94px;" hidden name="lesson_id" id="lesson_id"
                                            value="{{ $lesson_id }}" type="text">
                                        <thead>
                                            <tr>
                                                <th>الرقم التسلسلي</th>
                                                <th>اسم الطالب </th>
                                               <th>تاريخ ترفيع الوظيفة</th>
                                                {{-- <th>العلامة</th> --}}
                                                <th>تحميل الوظيفة </th>
                                                {{-- <th>حفظ العلامة  </th> --}}
                                                ...
                                                @foreach ($item->student as $item2)
                                                    <tr>
                                                        <form action="#"
                                                            ...
                                                            @csrf
                                                            <td data-label="الرقم التسلسلي"class="py-1">
                                                                {{ $item2->id }}</td>
                                                            <td data-label="اسم الطالب" class="py-1">
                                                              ...
                                                              <td>
                                                                ...
                                                                @if($item2->student_lesson_teacher_room_term_exam->last())
                                                                    <p>{{$item2->student_lesson_teacher_room_term_exam->last()->updated_at}}</p>
                                                                    @endif
                                                                     @endif
                                                                </td>
                                                            ...
                                                            {{-- <td style="padding-bottom:20px"  data-label="العلامة" class="py-1">
                                                                    ...
                                                                    @foreach ($item2->exam_result as $item3)
                                                                        ...
                                                                        @if ($item3->exam_id == $exam_id)
                                                                            ...
                                                                            <input hidden style="height: 50px; width:94px;"
                                                                                ...
                                                                                class="number_mark common-input mb-20 form-control input1"
                                                                                type="text">
                                                                        @endif
                                                                    @endforeach
                                                                ...
                                                                @else
                                                                    <input style="height: 50px; width:94px;" name="mark"
                                                                        ...
                                                                        required="" type="number"min="0.0" max="{{ $exam1->success_mark }}">
                                                                @endif
                                                            ...
                                                            <td data-label="تحميل وظيفة" class="py-1"
                                                            ...
                                                            {{-- <td data-label="عمليات التعديل" class="py-1">
...
$(document).on('click', '.btn11', function() {
                ...
                var url = "{{ URL::to('SMARMANger/dashboard/teacher/student_save_mark_homework') }}";
                $.ajax({
                    url: url,
                    data: data,
                    type: "get",
    ...
    return moment(timestamp).format('YYYY-MM-DD HH:mm:ss');
            ...
            $(document).on('change', '.choice', function() {
                ...
                var lect = $(this).val();
                var home = $('.homeid').val();
                var url = "{{ URL::to('SMARMANger/dashboard/coordinator/homeworkestudent') }}/" + lect + "/" +
                    home;
                $.ajax({
                    url: url,
                    type: "get",
                    ...
                    success: function(data) {
                        ...
                        if (lect == 1) {
                            ...
                            $.each(data, function(key, value) {
                                ...
                                var b = [];
                                $.each(value.student_lesson_teacher_room_term_exam,
                                    function(key1, value2) {
                                        ...
                                        if (value2.exam_id == home) {
                                            ...
                                            b.push(`
                                                ...
                                                <a href="{{ url('/storage/app/') }}/${value2.file}" target="_blank" class="download-button">
                                                                                <div class="docs"><svg
                                                                                        class="css-i6dzq1"
                                                                                        stroke-linejoin="round"
                                                                                        stroke-linecap="round"
                                        ...
                                        if (value.student_lesson_teacher_room_term_exam) {
                                ...
                                $('.table1 tbody').append(`
                                    ...
                                    // <td data-label="عمليات التعديل" class="py-1">
                                    // <button class="Btn btn11" type="submit" data-val="${ value.id }">
                                    // <svg class="svg" viewBox="0 0 512 512">
                                    //                                     <path
                                    //                                         d="M410.3 231l11.3-11.3-33.9-33.9-62.1-62.1L291.7 89.8l-11.3 11.3-22.6 22.6L58.6 322.9c-10.4 10.4-18 23.3-22.2 37.4L1 480.7c-2.5 8.4-.2 17.5 6.1 23.7s15.3 8.5 23.7 6.1l120.3-35.4c14.1-4.2 27-11.8 37.4-22.2L387.7 253.7 410.3 231zM160 399.4l-9.1 22.7c-4 3.1-8.5 5.4-13.3 6.9L59.4 452l23-78.1c1.4-4.9 3.8-9.4 6.9-13.3l22.7-9.1v32c0 8.8 7.2 16 16 16h32zM362.7 18.7L348.3 33.2 325.7 55.8 314.3 67.1l33.9 33.9 62.1 62.1 33.9 33.9 11.3-11.3 22.6-22.6 14.5-14.5c25-25 25-65.5 0-90.5L453.3 18.7c-25-25-65.5-25-90.5 0zm-47.4 168l-144 144c-6.2 6.2-16.4 6.2-22.6 0s-6.2-16.4 0-22.6l144-144c6.2-6.2 16.4-6.2 22.6 0s6.2 16.4 0 22.6z">
                                    //                                     </path>
                            ...
                            d = `<input style="height: 50px; width:94px;"  hidden name="exam_result_id"  value=""  type="text">
                                ...
                                $('.table1 tbody').append(`<tr  id="st">
                                    ...
                                    <td></td>
                                    <td data-label="العلامة" class="py-1">${d}</td>
                                    <td data-label="تحميل وظيفة" class="py-1"></td>
                                    // <td data-label="عمليات التعديل" class="py-1">
                                    // <button class="Btn btn11" type="submit" data-val="${ value.id }">
                                    // <svg class="svg" viewBox="0 0 512 512">
                                    //                                     <path
